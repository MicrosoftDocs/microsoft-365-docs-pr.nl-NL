...
**Vereist wereldwijde beheerdersactie** | Soms |  Zelden |    Zelden 
...
Het managed desktop operations-team gaat als volgt te werk:
...
Het apparaat wordt opgestart in de 'out of box-ervaring' en alle vooraf geïnstalleerde toepassingen en instellingen worden opnieuw toegepast. De gebruiker van het apparaat moet opnieuw initiële installatie-informatie verstrekken. 
...
BitLocker is een belangrijk onderdeel van de beveiliging van gegevens in dit proces. Met BitLocker-versleuteling op Microsoft Managed Desktop-apparaten blijven gegevens op het station veilig, zelfs nadat het apparaat is gereset in de fabriek. Alle gegevens die zich op het station hebben staan, zijn niet beschikbaar voor de volgende gebruiker van het apparaat. Zie [BitLocker-overzicht](https://docs.microsoft.com/windows/security/information-protection/bitlocker/bitlocker-overview)voor meer informatie.
