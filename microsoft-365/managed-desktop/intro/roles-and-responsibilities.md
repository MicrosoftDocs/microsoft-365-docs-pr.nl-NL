...
Rol of verantwoordelijkheid | Omschrijving
--- | ---
...
Ondersteuning voor gebruikers | We bieden een mechanisme voor verhoogde toegang tot apparaten en voor problemen om zo nodig te escaleren. Zie Gebruikersondersteuning voor [meer informatie.](../service-description/user-support.md)
...
Ondersteuning voor gebruikers | Alle gebruikersondersteuning en technische hulp bieden vanaf het eerste contact tot en met de oplossing voor de gebruiker, door u of via een aangewezen ondersteuningspartner. U moet gebruikersondersteuning rechtstreeks bieden of samenwerken met een partner om ondersteuning te bieden voor deze gebieden: <br><br>- On-site infrastructuur: alle netwerk- en internetverbinding, VPN-infrastructuur en clientconfiguratie, lokale apparatuur voor vergaderruimten, printers, proxyserver en -configuratie en firewalls.<br><br>- Cloudbronnen voor het hele bedrijf: e-mail, SharePoint, samenwerkingsservices en andere cloudinfrastructuur die betrekking heeft op de bedrijfsbrede technologievoetafdruk.<br><br>- Bedrijfslijn en andere bedrijfsspecifieke toepassingen.
