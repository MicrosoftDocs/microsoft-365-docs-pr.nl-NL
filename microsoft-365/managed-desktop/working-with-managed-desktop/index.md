...
In dit gedeelte vindt u informatie over uw dagelijkse leven met de service, zoals hoe uw IT-beheerders ondersteuning kunnen krijgen indien nodig, hoe uw eindgebruikers ondersteuning krijgen, het beheren van uw apps eenmaal geïmplementeerd en hoe u de aanpasbare instellingen op apparaten bewerken.

- [Beheerdersondersteuning voor Microsoft Managed Desktop](admin-support.md)
- [Hulp krijgen voor eindgebruikers](end-user-support.md)
