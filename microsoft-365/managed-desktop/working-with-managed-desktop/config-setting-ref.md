...
3. Selecteer **Instellingen** **bureaubladachtergrondafbeelding** in Instellingen werkruimte. 
...
Startpagina's van de browser worden geopend op afzonderlijke tabbladen wanneer uw gebruikers Microsoft Edge. Als u het uw gebruikers gemakkelijk wilt maken om een reeks sites te openen die ze vaak gebruiken, voegt u een startpagina van de browser toe voor elke site. 
...
1. Meld u aan [bij Microsoft Endpoint Manager](https://endpoint.microsoft.com/) en ga naar **het** menu Apparaten
2. Zoek naar de Microsoft Managed Desktop sectie en selecteer **Instellingen.**
3. Selecteer **Instellingen** **startpagina's van browser** in Instellingen werkruimte. 
...
Als u specifieke websites en apps hebt die compatibiliteitsproblemen hebben met Microsoft Edge, kunt u de sitelijst ondernemingsmodus gebruiken, zodat de websites automatisch worden geopend met Internet Explorer 11. Als u weet dat uw intranetsites niet correct werken met Microsoft Edge, kunt u ook instellen dat alle intranetsites automatisch worden geopend met Internet Explorer 11. Als u de ondernemingsmodus gebruikt, kunt u Microsoft Edge als standaardbrowser blijven gebruiken, terwijl u er ook voor zorgt dat uw apps blijven werken in Internet Explorer 11. Zie Sitelijsten in de ondernemingsmodus en ondernemingsmodus voor meer informatie over sitelijsten in de [ondernemingsmodus.](/internet-explorer/ie11-deploy-guide/what-is-enterprise-mode) 
...
1. Meld u aan [bij Microsoft Endpoint Manager](https://endpoint.microsoft.com/) en ga naar **het** menu Apparaten
2. Zoek naar de Microsoft Managed Desktop sectie en selecteer **Instellingen.**
3. Selecteer **in Instellingen** werkruimte de locatie van de **sitelijst in de ondernemingsmodus.** 
...
1. Meld u aan [bij Microsoft Endpoint Manager](https://endpoint.microsoft.com/) en ga naar **het** menu Apparaten
2. Zoek naar de Microsoft Managed Desktop sectie en selecteer **Instellingen.**
3. Selecteer **in Instellingen** werkruimte **Vertrouwde sites** en selecteer vervolgens Vertrouwde site **toevoegen.** 
...
1. Meld u aan [bij Microsoft Endpoint Manager](https://endpoint.microsoft.com/) en ga naar **het** menu Apparaten
2. Zoek naar de Microsoft Managed Desktop sectie en selecteer **Instellingen.**
3. Selecteer **Instellingen** vertrouwde **sites in Instellingen** werkruimte. 
...
1. Meld u aan [bij Microsoft Endpoint Manager](https://endpoint.microsoft.com/) en ga naar **het** menu Apparaten
2. Zoek naar de Microsoft Managed Desktop sectie en selecteer **Instellingen.**
3. Selecteer **in Instellingen** werkruimte **proxy**. 
