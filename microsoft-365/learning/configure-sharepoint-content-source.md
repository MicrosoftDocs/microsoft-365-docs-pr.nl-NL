---
title: Configuratie SharePoint als een leerinhoudsbron voor Microsoft Viva Learning (Preview)
ms.author: chucked
...
ms.locfileid: "53289941"
---
# <a name="configure-sharepoint-as-a-learning-content-source-for-microsoft-viva-learning-preview"></a><span data-ttu-id="dc87d-103">Configuratie SharePoint als een leerinhoudsbron voor Microsoft Viva Learning (Preview)</span><span class="sxs-lookup"><span data-stu-id="dc87d-103">Configure SharePoint as a learning content source for Microsoft Viva Learning (Preview)</span></span>

> [!NOTE]
> <span data-ttu-id="dc87d-104">Deze functie is nog niet beschikbaar in productvoorbeeld.</span><span class="sxs-lookup"><span data-stu-id="dc87d-104">This feature is not yet available in product preview.</span></span>
