...
- In de stappen in dit onderwerp wordt ervan uit gegaan dat u een PST-import taak hebt gemaakt in de Office 365 Service importeren met behulp van netwerk uploaden of verzenden. Zie een van de volgende onderwerpen voor stapsgewijse instructies:
  ...
  - [Netwerk uploaden gebruiken om PST-bestanden te importeren in Office 365](use-network-upload-to-import-pst-files.md)
...
2. Klik **op Informatiebeheer** \>  \> **Importeer PST-bestanden importeren.**
    
    De importtaken voor uw organisatie worden weergegeven op de **pagina PST-bestanden** importeren. De **waarde** Analyse voltooid in de kolom **Status** geeft de importtaken aan die door de Microsoft 365 zijn geanalyseerd en die u kunt importeren. 
...
3. Klik **op Gereed om te importeren Office 365** voor de importklus die u wilt voltooien. 
...
4. Klik **op Importeren om Office 365.**
    ...
    De **pagina Uw gegevens filteren** wordt weergegeven. Het bevat gegevensinzichten over de gegevens in de PST-bestanden voor de importklus, inclusief informatie over de leeftijd van de gegevens. 
...
5. Ga op een van de volgende opties te werk op basis van het feit of u de gegevens die in Microsoft 365 worden geïmporteerd, wilt knippen onder Wilt u uw gegevens **filteren?**?
    ...
    U kunt deze filters configureren:
      ...
      - **Type:** in deze sectie worden alle berichttypen weergegeven die zijn gevonden in de PST-bestanden voor de importklus. U kunt een vakje naast een berichttype dat u wilt uitsluiten, uit- of uit- Houd er rekening mee dat u het type Ander bericht niet kunt uitsluiten. Zie de [sectie Meer informatie](#more-information) voor een lijst met postvakitems die zijn opgenomen in de categorie Overige. 
    ...
    De gegevensinzichten op de pagina Gegevens importeren **Office 365** pagina worden bijgewerkt op basis van uw filterinstellingen, inclusief de totale hoeveelheid gegevens die worden geïmporteerd op basis van de filterinstellingen. Houd er rekening mee dat er ook een overzicht van de filterinstellingen wordt weergegeven. U kunt klikken **op Bewerken** naast een filter om de instelling zo nodig te wijzigen. 
    ...
    e. Klik **op Gegevens importeren** om het importeren te starten. Houd er rekening mee dat de totale hoeveelheid gegevens die wordt geïmporteerd, wordt weergegeven. 
    ...
    b. Klik op **de pagina Gegevens Office 365** importeren op Gegevens importeren **om** de import te starten. Houd er rekening mee dat de totale hoeveelheid gegevens die wordt geïmporteerd, wordt weergegeven. 
    
6. Klik op **de pagina PST-bestanden importeren** op  ![ ](../media/165fb3ad-38a8-4dd9-9e76-296aefd96334.png) Vernieuwen. De status van de importklus wordt weergegeven in de **kolom Status.** 
...
- De volgende tabel bevat de berichtentypen  die zijn opgenomen in  de categorie Overige in het **filter** Type op de pagina Meer opties (zie Stap 5b in de vorige procedure). Momenteel kunt u items in de categorie 'Overige' niet uitsluiten wanneer u PST's importeert in Office 365. 
    ...
    |IPM. Note.Rules.Oof.Template.Microsoft  <br/> |Berichten die niet automatisch worden beantwoord  <br/> |
