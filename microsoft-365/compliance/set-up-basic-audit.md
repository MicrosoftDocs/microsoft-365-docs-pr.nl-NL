...
In dit artikel worden de volgende stappen beschreven die nodig zijn om Basisaudit in te stellen.
...
Zie Basisaudit [in Microsoft 365.](auditing-solutions-overview.md#basic-audit)
...
Voor licenties voor basisaudit is het juiste organisatieabonnement vereist dat toegang biedt tot het zoekprogramma voor auditlogboek en licenties per gebruiker die nodig zijn voor het aanmelden en behouden van auditrecords.

Wanneer een gecontroleerde activiteit wordt uitgevoerd door een gebruiker of beheerder, wordt een auditrecord gegenereerd en opgeslagen in het auditlogboek voor uw organisatie. In Basisaudit worden auditrecords 90 dagen bewaard en doorzocht in het auditlogboek.

Zie Auditing solutions in Microsoft 365 voor een lijst met abonnements- en [licentievereisten voor Basisaudit.](auditing-solutions-overview.md#licensing-requirements)
