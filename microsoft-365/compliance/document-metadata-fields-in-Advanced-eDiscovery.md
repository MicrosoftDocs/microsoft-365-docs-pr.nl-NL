...
|Namen van bijlagen|Bijlagenamen|Attachment_Names|Lijst met namen van bijlagen.|
...
|Documentherziening||Doc_revision|Revisie van de metagegevens van het document.|
...
|Ontvangstbevestiging per e-mail||Email_delivery_receipt|E-mailadres dat wordt opgegeven in internetkoppen voor ontvangstbevestiging.|
...
|EmailReadReceipt*||Email_read_receipt|E-mailadres dat wordt opgegeven in internetkoppen voor leesbevestiging.|
...
|Inhoudstype geëxtraheerd||Extracted_content_type|Geëxtraheerd inhoudstype, in de vorm van mimetype; bijvoorbeeld **image/jpeg**|
|GeëxtraheerdTextLength*||Extracted_text_length|Het aantal tekens in de uitgepakte tekst.|
|Gezinsrelevantiescore Case issue 1*||Family_relevance_score_case_issue_1|Gezinsrelevantiescore Case issue 1 from Relevance.|
...
|Bestandsrelevantiescore Case issue 1*||File_relevance_score_case_issue_1|Bestandsrelevantiescore Case issue 1 from Relevance.|
...
|Gemarkeerd als voorgelabeld zaakprobleem 1*||Marked_as_pre_tagged_Case_issue_1|Gemarkeerd als vooraf gemarkeerde case-probleem 1 van Relevantie.|
|Gemarkeerd als seed Case issue 1*||Marked_as_seed_Case_issue_1|Gemarkeerd als seed Case issue 1 van Relevantie.|
...
|Genormaliseerde relevantiescore Case issue 1||Normalized_relevance_score_case_issue_1|Genormaliseerde relevantiescore Case probleem 1 van Relevantie.|
...
|Bovenliggend pad|ParentPath|Parent_path|Samengesteld pad van het directe bovenliggende item.|
...
|Lees percent Case issue 1||Read_percent_Case_issue_1|Lees percent Case issue 1 from Relevance.|
...
|Relevantielastgroep Case issue 1||Relevance_load_group_case_issue_1|Relevantielastgroep Case issue 1 van Relevantie.|
|Beschrijving van relevantiestatus Case issue 1||Relevance_status_description_Case_issue_1|Beschrijving van relevantiestatus Case issue 1 from Relevance.|
|Relevantielabel Case issue 1||Relevance_tag_case_issue_1|Relevantielabel Case probleem 1 van Relevantie.|
|Opmerking over relevantie||Relevance_comment|Opmerkingsveld van Relevantie.|
...
|Tagged by Case issue 1||Tagged_by_Case_issue_1|Gebruiker die dit document heeft getagd voor zaak 1 in Relevantie.|
