...
|Fouten bij het negeren van verwerkingen|ErrorIgnored|Error_Ignored|Fout is genegeerd en niet opgelost.|
...
|Gezins-id|FamilyId|Family_ID|Groepen alle items voor e-mail. Dit omvat het bericht, alle bijlagen en geëxtraheerde items.|
...
|Groeps-id|Groeps-id|Group_ID|Groepeert alle items voor e-mail en documenten. Voor e-mail bevat dit het bericht, alle bijlagen en geëxtraheerde items. Voor documenten omvat dit het document en eventuele ingesloten items.|
...
|In de buurt van dubbele set||ND_set|Items die lijken op het draaitabeldocument, delen dezelfde ND_set.|
...
|Id instellen||Set_ID|Documenten met vergelijkbare inhoud (ND_set) of e-mail binnen dezelfde e-mailthread (Email_set) delen dezelfde Set_ID.|
