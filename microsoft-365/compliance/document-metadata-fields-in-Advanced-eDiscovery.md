...
|Gespreksonderwerp|Gespreksonderwerp||Gespreksonderwerp van het item.|
|Gespreks-id|ConversationId|Email_conversation_ID|Gespreks-id van het bericht.|
...
|Ontvangstbevestiging per e-mail aangevraagd||Email_delivery_receipt_requested|E-mailadres dat wordt opgegeven in internetkoppen voor ontvangstbevestiging.|
...
|EmailReadReceiptRequested||Email_read_receipt_requested|E-mailadres dat wordt opgegeven in internetkoppen voor leesbevestiging.|
...
|Bovenliggende id|ParentId|Container_ID|Id van het bovenliggende item.|
