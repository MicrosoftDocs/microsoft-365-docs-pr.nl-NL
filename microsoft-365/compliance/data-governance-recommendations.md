...
Deze aanbeveling wordt weergegeven wanneer e-mailberichten die zijn geïdentificeerd als het berichttype 'voicemail' in de postvakken van gebruikers worden gedetecteerd. Meer informatie over [berichteigenschappen in Exchange](/exchange/policy-and-compliance/ediscovery/message-properties-and-search-operators#searchable-properties-in-exchange).
