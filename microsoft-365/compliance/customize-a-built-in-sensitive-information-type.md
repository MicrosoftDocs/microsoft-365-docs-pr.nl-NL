...
2. Schuif omlaag naar de tag `<Rules>`, wat het begin van de sectie met de DLP-regels is. Omdat dit XML-bestand de informatie voor de hele regelverzameling bevat, bevat het boven aan het bestand andere informatie waar u langs moet schuiven om naar de regels te gaan.
