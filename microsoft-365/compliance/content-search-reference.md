...
Raadpleeg [Trefwoordquery's en zoekvoorwaarden voor Inhoud zoeken](keyword-queries-and-search-conditions.md) voor meer informatie over het maken van een zoekquery, het gebruik van booleaanse zoekoperatoren en -voorwaarden en het zoeken naar gevoelige informatietypen en inhoud die met gebruikers van buiten uw organisatie worden gedeeld.
