...
description: Meer informatie over het instellen en gebruiken van een verbindingslijn in het Microsoft 365 compliancecentrum voor het importeren en archiveren van gegevens van Cisco Jabber op PostgreSQL om Microsoft 365.
...
Gebruik een Veritas-connector in het Microsoft 365 compliancecentrum om gegevens van het Cisco Jabber-platform te importeren en te archiveren in gebruikerspostvakken in uw Microsoft 365 organisatie. Veritas biedt een Cisco Jabber op [PostgreSQL-connector](https://www.veritas.com/insights/merge1/jabber) die is geconfigureerd om items uit de gegevensbron van derden vast te leggen (op regelmatige basis) en deze items te importeren in Microsoft 365. De connector converteert de inhoud, zoals berichten, chats en gedeelde inhoud van Cisco Jabber op PostgreSQL naar een e-mailberichtindeling en importeert deze items vervolgens in het postvak van de gebruiker in Microsoft 365.
...
3. De Cisco Jabber op PostgreSQL-connector die u maakt in het Microsoft 365-compliancecentrum, maakt elke dag verbinding met de Veritas Merge1-site en draagt de Jabber-inhoud over naar een veilige Azure Storage-locatie in de Microsoft-cloud.
