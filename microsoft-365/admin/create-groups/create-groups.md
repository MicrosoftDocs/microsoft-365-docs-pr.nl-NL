...
> [!TIP]
> Microsoft 365-verbonden Yammer-groepen moeten worden gemaakt in Yammer, maar kunnen net als andere Microsoft 365-groepen worden beheerd in het Microsoft 365-beheercentrum. Zie [Yammer- en Microsoft 365-groepen voor](https://docs.microsoft.com/yammer/manage-yammer-groups/yammer-and-office-365-groups)meer informatie. 

## <a name="create-a-microsoft-365-group"></a>Een Microsoft 365-groep maken

1. Vouw in het beheercentrum **Groepen**uit en klik op **Groepen**.

2. Selecteer **Een groep toevoegen**.
  
3. Selecteer op de pagina **Een groepstype kiezen** de optie **Office 365**en selecteer **Volgende**.

4. Typ op de pagina **Basisbeginselen** een naam voor de groep en, optioneel, een beschrijving. Selecteer **Volgende**.
...
Gebruikers kunnen [zichzelf toevoegen of goedkeuring aanvragen,](https://support.microsoft.com/office/2e59e19c-b872-44c8-ae84-0acc4b79c45d)of u ze nu toevoegen.

1. Vernieuw de pagina in het beheercentrum zodat de nieuwe groep wordt weergegeven en selecteer vervolgens de naam van de groep waaraan u leden wilt toevoegen.
    
2. Selecteer op het tabblad **Leden** de optie **Alles weergeven en leden beheren**.
...
Gebruikers kunnen [zichzelf toevoegen of goedkeuring aanvragen,](https://support.microsoft.com/office/2e59e19c-b872-44c8-ae84-0acc4b79c45d)of u ze nu toevoegen.
1. Vernieuw de pagina in het beheercentrum zodat **Groups** de nieuwe groep wordt weergegeven, selecteer \> <a href="https://go.microsoft.com/fwlink/p/?linkid=2052855" target="_blank">Groepen groepen</a>en selecteer vervolgens de groep waaraan u leden wilt toevoegen.
    
2. **Selecteer**naast **Leden**bewerken .
3. Selecteer **Leden toevoegen**.
...
## <a name="who-can-delete-email-from-the-group-inbox"></a>Wie kan e-mail verwijderen uit het postvak IN groep?
...
Een lid kan een e-mailgesprek verwijderen uit het postvak IN Groep als hij of zij het heeft gestart en alleen Outlook in de web gebruiken (klik met de rechtermuisknop op de e-mail en kies **Verwijderen).** Dit kunnen ze niet doen vanuit de Outlook-app (Outlook 2016).
...
Nadat u een nieuwe groep hebt gemaakt en leden hebt toegevoegd, u uw groep verder configureren, zoals het bewerken van de groepsnaam of -beschrijving, het wijzigen van eigenaars of leden en het opgeven of externe afzenders de groep kunnen e-mailen en of ze kopieën van groepsgesprekken naar leden moeten verzenden. Zie [Een Microsoft 365-groep beheren](manage-groups.md) voor informatie.
