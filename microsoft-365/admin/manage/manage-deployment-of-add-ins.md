...
## <a name="deploy-an-office-add-in-using-the-admin-center"></a>Een invoeg Office implementeren met behulp van het beheercentrum
...
1. Ga in het beheercentrum naar de **pagina Instellingen** \> **invoegvoegvoegingen.** Als u de invoegpagina niet ziet,  gaat u naar de pagina Instellingen  \> **geïntegreerde** \> **apps.**

2. Selecteer **Invoegvoegvoeging implementeren** boven aan de pagina en selecteer vervolgens **Volgende.**

    > [!NOTE]
    > Het beheercentrum wordt bijgewerkt naar implementatie-ervaring met geïntegreerde apps. Geïntegreerde apps zijn alleen zichtbaar voor globale beheerders, terwijl voor anderen de oude ervaring nog steeds bestaat. Als u de bovenstaande stappen niet ziet, gaat u naar de sectie Gecentraliseerde implementatie door naar Instellingen  >  **Geïntegreerde apps.** Kies invoegingen boven aan de pagina Geïntegreerde **apps.**

3. Selecteer een optie en volg de instructies.
  
4. Als u de optie hebt geselecteerd om een invoegvoeging toe te voegen vanuit de Office Store, maakt u de invoegselectie. </br>
    ...
    > [!NOTE]
    > Met de Office Store worden updates en verbeteringen automatisch geïmplementeerd voor gebruikers.
...
7. Er wordt een groene vinkje weergegeven wanneer de invoeging wordt geïmplementeerd. Volg de instructies op de pagina om de invoeging te testen.
    ...
    > [!NOTE]
    > Gebruikers moeten mogelijk een nieuwe start maken Office het invoegpictogram op het app-lint te bekijken. Outlook invoegvoegingen kunnen tot 24 uur duren voordat ze worden weergegeven op app-linten.
...
Globale beheerders en Exchange kunnen een invoegvoeging toewijzen aan iedereen of aan specifieke gebruikers en groepen. Elke optie heeft gevolgen:
...
## <a name="more-about-office-add-ins-security"></a>Meer informatie Office beveiliging van invoegvoegingen
