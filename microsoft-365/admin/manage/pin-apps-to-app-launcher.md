...
U kunt besturingselementen in de Azure Active Directory portal gebruiken om maximaal drie apps vast te maken aan Office.com en het start start-up voor apps voor alle gebruikers in uw organisatie. U kunt ook groepen toepassingen organiseren. Elke app die u toevoegt, kan later op elk moment door de gebruiker worden losgemaakt. Als u een app voor uw gebruikers wilt vastmaken, moet u een cloudtoepassingsbeheerder of toepassingsbeheerder zijn in Azure Active Directory of een globale beheerder in Office 365. Zie beheerdersrollen in Azure Active Directory beheerdersrollen [in](/azure/active-directory/users-groups-roles/directory-assign-admin-roles) Microsoft 365 voor [meer informatie over beheerdersrollen.](../add-users/about-admin-roles.md) 

Zie voor meer informatie over het start- en [](https://support.microsoft.com/office/79f12104-6fed-442f-96a0-eb089a3f476a) Office.com voor apps het start start- en updates voor office.com en het blogartikel Office 365 voor app-launcher. [](https://techcommunity.microsoft.com/t5/office-365-blog/updates-to-office-com-and-the-office-365-app-launcher/ba-p/1150503)

## <a name="use-the-azure-active-directory-portal-to-pin-apps"></a>Gebruik de Azure Active Directory portal om apps vast te maken
...
2. Kies in het linkernavigatieprogramma **Alles tonen** en kies onder **Beheercentra** de **Azure Active Directory.**
3. Kies **Azure Active Directory** **Enterprise-toepassingen**  >  **Gebruikersinstellingen**.
4. Kies in **Office 365 Instellingen** sectie Toepassing **toevoegen.**
...
> [!NOTE]
> De gebruikersinterface geeft aan of u extra Azure AD-licenties moet kopen om deze functie te kunnen gebruiken. Zie voor meer informatie [Azure Active Directory prijzen.](https://azure.microsoft.com/pricing/details/active-directory/)

1. Kies **Azure Active Directory** **Enterprise-toepassingen Nieuwe** toepassing boven aan de pagina Alle  >   **toepassingen.**
