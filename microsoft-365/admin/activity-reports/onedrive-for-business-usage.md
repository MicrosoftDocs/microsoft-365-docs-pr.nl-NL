...
1. Ga in het beheercentrum naar **Gebruik van** \> <a href="https://go.microsoft.com/fwlink/p/?linkid=2074756" target="_blank">rapporten.</a>

    
2. Selecteer **oneDrive-gebruik** in de **vervolgkeuze** van Een rapport \> **selecteren.** 
...
|Item|Beschrijving|
|:-----|:-----|
|1.  <br/> |In het rapport **Gebruik van OneDrive** worden trends weergegeven voor de laatste 7, 30, 90 of 180 dagen. Als u echter een bepaalde dag in het rapport selecteert, worden in de tabel (7) gegevens voor maximaal 28 dagen vanaf de huidige datum (niet de datum waarop het rapport is gegenereerd) weer te geven.  <br/> |
...
|4.  <br/> |In **de** weergave Bestanden ziet u het aantal totale en actieve bestanden. Een bestand wordt als actief beschouwd als het binnen een bepaalde periode is opgeslagen, gesynchroniseerd, gewijzigd of gedeeld.  <br/> OPMERKING: Een bestandsactiviteit kan meerdere keren voor één bestand plaatsvinden, maar wordt slechts als één actief bestand geteld. Zo kunt u bijvoorbeeld hetzelfde bestand meerdere malen opslaan en synchroniseren in een bepaalde periode, maar dit wordt als één actief bestand en één gesynchroniseerd bestand meegeteld in de gegevens.           |
|5.  <br/> |De weergave **Opslag** toont de trend voor de hoeveelheid OneDrive-opslagruimte die u gebruikt. Als u de opslaglimieten wilt controleren, raadpleegt u Controleren of een gebruiker de standaardopslaglimiet [of een specifieke limiet heeft.](/onedrive/set-default-storage-space#check-if-a-user-has-the-default-storage-limit-or-a-specific-limit)  <br/> OPMERKING: De grootte bevat alle versies en metagegevens die aan de bestanden zijn gekoppeld.           |
