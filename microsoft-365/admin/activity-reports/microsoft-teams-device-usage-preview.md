...
---
# <a name="microsoft-365-reports-in-the-admin-center---microsoft-teams-device-usage"></a>Microsoft 365 Rapporten in het beheercentrum - Microsoft Teams apparaatgebruik
...
U kunt het apparaatgebruik weergeven in het Teams rapport door het tabblad **Apparaatgebruik te** kiezen.<br/>![Microsoft 365 rapporten - Microsoft Teams apparaatgebruik.](../../media/e46c7f7c-8371-4a20-ae82-b20df64b0205.png)

Selecteer **Kolommen kiezen** om kolommen toe te voegen of te verwijderen uit het rapport.  <br/> ![Teams gebruikersapparaatrapport : kies kolommen](../../media/3358d5d9-931b-4d30-931f-450b2f5717da.png)
...
|Windows  <br/> |Geselecteerd als de gebruiker actief was in de Teams desktopclient op een Windows computer.  <br/> |
|Mac  <br/> |Geselecteerd als de gebruiker actief was in de Teams desktopclient op een macOS-computer.  <br/> |
|iOS  <br/> |Geselecteerd als de gebruiker actief was op de Teams mobiele client voor iOS.  <br/> |
|Android-telefoon  <br/> | Geselecteerd als de gebruiker actief was op de Teams mobiele client voor Android.  <br/> |
|Chrome OS  <br/> |Geselecteerd als de gebruiker actief was in de Teams desktopclient op een ChromeOS-computer.|
|Linux  <br/> | Geselecteerd als de gebruiker actief was in de Teams desktopclient op een Linux-computer.  <br/> |
|Web  <br/> |Geselecteerd als de gebruiker actief was in de Teams webclient op apparaten.|
|Laatste activiteitsdatum (UTC)  <br/> |De laatste datum (UTC) die de gebruiker heeft deelgenomen aan een Teams activiteit .  <br/> |
|Is gelicentieerd|Geselecteerd als de gebruiker een licentie heeft voor het gebruik van Teams.|
|||