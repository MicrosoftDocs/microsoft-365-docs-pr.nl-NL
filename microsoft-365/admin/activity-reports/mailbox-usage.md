...
3. Selecteer in **de vervolgkeuzelijst** E-mailactiviteit **Exchange** \> **Postvakgebruik.**
...
|4.  <br/> |De grafiek **Opslag** toont de hoeveelheid gebruikte opslagruimte in uw organisatie. Storage Grafiek bevat geen archiefpostvakken. Zie Overzicht van onbeperkt archiveren in Microsoft 365 voor meer informatie over het automatisch uitbreiden van [archivering.](../../compliance/unlimited-archiving.md)<br/> |
...
|10.  <br/> |U kunt de rapportgegevens ook exporteren naar een Excel .csv bestand door de **koppeling Exporteren te** selecteren.  <br/> |
|||
