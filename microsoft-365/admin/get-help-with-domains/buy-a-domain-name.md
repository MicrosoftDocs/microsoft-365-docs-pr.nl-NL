...
Als u een domein wilt instellen in Office 365, moet u eigenaar zijn van een domein en bepaalde DNS-records voor uw domein wijzigen.
...
Nadat u uw domein hebt geregistreerd (bij een domeinregistrar), meldt u zich als beheerder aan bij Office 365 en stelt u uw domein in, zodat u dit kunt gebruiken met uw e-mailadres en met andere services.
  
> [!NOTE]
> De informatie over de openbare SharePoint Online-website in dit artikel is alleen van toepassing als uw organisatie Office 365 heeft gekocht vóór 9 maart 2015. 

## <a name="domain-registrars-that-support-all-dns-records-required-for-office-365"></a>Domeinregistrars die ondersteuning bieden voor alle DNS-records die zijn vereist voor Office 365
...
[Een domein toevoegen aan Office 365](../setup/add-domain.md)
