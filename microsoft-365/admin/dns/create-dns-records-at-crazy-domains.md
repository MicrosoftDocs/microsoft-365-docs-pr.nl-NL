...
---
# <a name="create-dns-records-at-crazy-domains-for-microsoft"></a>DNS-records bij Crazy domains maken voor Microsoft
...
Nadat u deze records bij Crazy domains hebt toegevoegd, is uw domein ingesteld voor gebruik met Microsoft-services.
...
2. Selecteer in de sectie **My account** de optie **Domains**.
    
    ![Wiskundig symbool voor 1-2](../../media/778576c3-560e-4ffb-b3b4-bd92fc6a6bd4.png)
  
3. Selecteer op de pagina **Domain names** in het gedeelte **Domain** de naam van het domein dat u wilt bijwerken. 
    
    ![Wiskundig symbool voor 1-3](../../media/4dd7bb74-c8ed-4b4a-b4c1-d9538fc6bd9a.png)
  
4. Selecteer in de sectie **DNS Settings** het pictogram van de vervolgkeuzelijst. 
...
10. Als er andere MX-records worden vermeld in de sectie **MX record** , selecteert u **Modify** voor een van die records. 
...
12. Selecteer **bijwerken** om het verwijderen te bevestigen. 
...
9. Selecteer **Add CNAME record**.
    
    ![Wiskundig symbool voor 3-4](../../media/9bcba729-7085-4ebc-8183-ecde82f5c364.png)
  
10. Voeg de tweede CNAME-record toe:
    
    Gebruik de waarden uit de volgende rij van de tabel in de vakken voor de nieuwe record en selecteer vervolgens opnieuw **Add CNAME record**.
...
8. Voeg de eerste van de twee SRV-records toe.
    ...
    |:-----|:-----|:-----|:-----|:-----|:-----|
    |SRV Record  <br/> |_sip _sip._tls  <br/> |100  <br/> |1  <br/> |443  <br/> |sipdir.online.lync.com  <br/> |
    |SRV Record  <br/> |_sipfederationtls _sipfederationtls._tcp  <br/> |100  <br/> |1  <br/> |5061  <br/> |sipfed.online.lync.com  <br/> |
