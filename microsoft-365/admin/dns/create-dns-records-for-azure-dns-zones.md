...
Als Azure uw DNS-hostingprovider is, volgt u de stappen in dit artikel om uw domein te verifiëren en DNS-records in te stellen voor e-mail, Skype voor Bedrijven Online, en meer.
...
Nadat u deze records bij Azure hebt toevoegen, is uw domein ingesteld voor gebruik met Microsoft-services.
...
Wanneer u zich hebt aangemeld voor Azure, hebt u een resourcegroep gemaakt in een DNS-zone en vervolgens uw domeinnaam toegewezen aan die resourcegroep. Die domeinnaam is geregistreerd bij een externe domeinregistrar. Azure biedt geen domeinregistratieservices.
  
Als u DNS-records voor uw domein in Microsoft wilt verifiëren en maken, moet u eerst de naamservers bij uw domeinregistrar wijzigen, zodat ze de Azure-naamservers gebruiken die aan uw resourcegroep zijn toegewezen.
...
> [!TIP]
> U moet ten minste twee naamserverrecords gebruiken. Als er andere naamservers worden vermeld op de website van uw domeinregistrar, moet u deze verwijderen. 
...
1. Als u wilt beginnen, gaat u via deze [koppeling](https://portal.azure.com )naar uw domeinenpagina bij Azure. U wordt gevraagd u eerst aan te melden.
    
    ![Azure-BP-Configure-1-1](../../media/ed377cad-0c47-4f9f-b322-c3e06b309b1f.png)
  
2. Typ **dns-zones** met de zoekbalk op **de pagina Dashboard.**  Selecteer in de weergave resultaten **DNS-zones** onder het **gedeelte Services.** Nadat u bent omgeleid, selecteert u het domein dat u wilt bijwerken.
...
4. Selecteer in **het gebied Recordset** toevoegen in de vakken voor de nieuwe recordset de waarden uit de volgende tabel. 
    ...
    (Kies de **waarden Type** en **TTL-eenheid** in de vervolgkeuzelijsten.) 
...
4. Selecteer in **het gebied Recordset** toevoegen in de vakken voor de nieuwe recordset de waarden uit de volgende tabel. 
    ...
    |:-----|:-----|:-----|:-----|:-----|:-----|
    |@  <br/> |MX  <br/> |1  <br/> |Uren  <br/> |10  <br/> Zie [Wat is MX-prioriteit?](../setup/domains-faq.yml) voor meer informatie over prioriteit. <br/> | *\<domain-key\>*  .mail.protection.outlook.com  <br/> **Opmerking:** Haal uw  *\<domain-key\>*  uit uw Microsoft-account.   [Hoe kan ik dit vinden?](../get-help-with-domains/information-for-dns-records.md)  
...
6. Als er andere MX-records worden vermeld in de **sectie MX Records,** moet u deze verwijderen. 
    ...
    Selecteer eerst in het **DNS-zonegebied** de **MX-recordset.**
...
7. Selecteer het **snelmenu (...)** en kies **verwijderen.**
...
4. Voeg de eerste van de vier CNAME-records toe.
    ...
    Typ of kopieer en plak de waarden uit de eerste rij in de volgende tabel in het gebied Add **record set** in de vakken voor de nieuwe recordset. 
...
6. Voeg de andere drie CNAME-records toe.
    ...
    Selecteer in **het GEBIED DNS-zone** **de optie + Recordset**. Maak vervolgens in de lege recordset een record met behulp van de waarden uit de volgende rij in de tabel en selecteer **nogmaals OK** om die record te voltooien. 
    
    Herhaal deze procedure totdat u alle vier CNAME-records hebt gemaakt.
    
7.  (Optioneel) Voeg 2 CNAME-records voor MDM toe.
...
4. Selecteer in **het gebied Eigenschappen** van recordset in de vakken voor de nieuwe recordset de waarden in de volgende tabel. 
...
4. Voeg de eerste van de twee SRV-records toe.
    ...
    Selecteer in **het gebied Recordset** toevoegen in de vakken voor de nieuwe recordset de waarden uit de eerste rij in de volgende tabel. 
