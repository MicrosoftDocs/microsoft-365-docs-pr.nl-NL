...
> [!IMPORTANT]
> U moet de eerste procedure hieronder uitvoeren, [Uw domein aan uw hostingaccount wijzen,](#point-your-domain-to-your-hosting-account)voordat u DNS-records toevoegt met behulp van een van de andere procedures in dit artikel. 
...
5. Kies op de pagina **Naamservers** voor uw domein in de vervolgkeuzelijst Automatisch dit domein naar de vervolgkeuzelijst **van mijn hostingaccount.** 
...
3. Typ **Advanced Zone Editor** of kopieer en plak de waarden uit de volgende tabel in het gebied **Record toevoegen** in de vakken voor de nieuwe record. 
...
2. Selecteer op de pagina **Configuratiescherm** in het **e-mailgebied** DE optie **MX-vermelding**.
...
5. Typ of kopieer en plak de waarden uit de volgende tabel in het gebied **Een nieuwe record** toevoegen in de vakken voor de nieuwe record. 
    ...
    |:-----|:-----|
    |0  <br/> Zie [Wat is MX-prioriteit?](https://support.office.com/article/2784cc4d-95be-443d-b5f7-bb5dd867ba83.aspx) voor meer informatie over prioriteit.    <br/> | *\<domeinsleutel\>*  .mail.protection.outlook.com  <br/> **Let op:** Haal \< uw domeinsleutel\> uit uw Office 365-account. *domain-key*    [Hoe kan ik dit vinden?](../get-help-with-domains/information-for-dns-records.md)          |
...
3. Voeg de eerste van de zes CNAME-records toe.
    ...
    Typ **Advanced Zone Editor** of kopieer en plak de waarden uit de eerste rij in de volgende tabel in het gebied **Record toevoegen** in de vakken voor de nieuwe record en kopieer en plak de waarden uit de eerste rij. 
