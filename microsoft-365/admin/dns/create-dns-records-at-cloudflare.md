...
Nadat u deze records bij Cloudflare hebt toevoegen, is uw domein ingesteld voor gebruik met Microsoft 365-services.
...
Het domein dat u hebt toegevoegd, is gekocht bij Cloudflare of een afzonderlijke domeinregistrar. Als u DNS-records wilt controleren en maken voor uw domein in Microsoft 365, moet u eerst de naamservers bij uw domeinregistrar wijzigen, zodat ze de naamservers van Cloudflare gebruiken.
...
4. Klik op **de pagina DNS-beheer** op **Record toevoegen** en selecteer vervolgens de waarden uit de volgende tabel. 
    ...
    | Type | Naam | E-mailserver | Priority | TTL |
    |:-----|:-----|:-----|:-----|:-----|
    |MX  <br/> |@  <br/> |*\<domain-key\>*  .mail.protection.outlook.com  <br/> **Opmerking:** Haal uw  *\<domain-key\>*  uit uw Microsoft 365-account.   [Hoe kan ik dit vinden?](../get-help-with-domains/information-for-dns-records.md) |1  <br/> Zie [Wat is MX-prioriteit?](../setup/domains-faq.yml) voor meer informatie over prioriteit.    <br/>|30 minutes  <br/> |
...
5. Selecteer het **pictogram DNS-verkeer** (oranje wolk wijzigen in grijs) om de Cloudflare-servers te omzeilen.
...
> [!IMPORTANT]
> Houd er rekening mee dat Cloudflare verantwoordelijk is voor het beschikbaar stellen van deze functionaliteit. Als u verschillen ziet tussen de onderstaande stappen en de huidige Cloudflare GUI (Grafische gebruikersinterface), kunt u gebruikmaken van de [Cloudflare-community.](https://community.cloudflare.com/) 
...
4. Voeg de eerste van de twee SRV-records toe.
    ...
    | Type | Service | Protocol | Naam | TTL | Priority | Gewicht | Poort | Doel |
    |:-----|:-----|:-----|:-----|:-----|:-----|:-----|:-----|:-----|
