...
> [!CAUTION]
> De Freenom-website biedt geen ondersteuning voor SRV-records, wat betekent dat verschillende functies van Skype voor Bedrijven Online en Outlook Web App niet werken. Ongeacht welk Microsoft-abonnement u gebruikt, er zijn aanzienlijke servicebeperkingen en mogelijk wilt u overschakelen naar een andere DNS-hostingprovider. 
  
Als u ondanks de servicebeperkingen uw eigen Microsoft DNS-records bij Freenom wilt beheren, volgt u de stappen in dit artikel om uw domein te verifiëren en DNS-records in te stellen voor e-mail en andere services.
...
1. Als u wilt beginnen, gaat u via deze [koppeling](https://my.freenom.com/)naar uw domeinenpagina in Freenom. U wordt gevraagd u aan te melden.
    
    ![Freenom login](../../media/90a32855-bfdd-4dfe-881c-b9a36b2f0582.png)
  
2. Selecteer **Services** en selecteer **vervolgens Mijn domeinen.**
...
4. Stel de naam voor uw domein in op de standaardservers voor Freenom-naam. Selecteer **Beheerhulpmiddelen** en selecteer **vervolgens Nameservers.**
    
    ![Freenom Nameservers setting](../../media/a6ae877a-c248-42b9-bae9-210a80cd01e7.png)
  
5. Zorg ervoor **dat Standaardnaamservers gebruiken** is geselecteerd en selecteer **Vervolgens Naamservers wijzigen.**
...
8. Typ of kopieer en plak de waarden uit de eerste rij van de volgende tabel in de velden voor de nieuwe record. 
    ...
    |:-----|:-----|:-----|:-----|:-----|
    |(laat leeg)  <br/> |MX (Mail Exchanger)  <br/> |3600 (seconden)  <br/> |\<domain-key\>.mail.protection.outlook.com  <br/> **Opmerking:** Haal uw  *\<domain-key\>*  uit uw Microsoft-account.   [Hoe kan ik dit vinden?](../get-help-with-domains/information-for-dns-records.md)          |10  <br/> Zie [What is MX priority?](../setup/domains-faq.yml) voor meer informatie over prioriteit.    <br/> |
...
10. Als er andere MX-records zijn, verwijdert u ze allemaal. Selecteer Verwijderen voor **elke** record. Wanneer het bericht Wilt u dit item echt **verwijderen?** wordt weergegeven, selecteert u **OK.**
