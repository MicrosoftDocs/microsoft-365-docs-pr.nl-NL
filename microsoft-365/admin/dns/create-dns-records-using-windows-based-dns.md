...
Voeg de CNAME-records toe die voor Microsoft vereist zijn. Als er aanvullende CNAME-records worden vermeld in Microsoft, voegt u deze toe volgens dezelfde algemene stappen die hier worden weergegeven.
...
Voordat u de DNS-records toevoegt om uw Microsoft-services in te stellen, moet Microsoft bevestigen dat u eigenaar bent van het domein dat u toevoegt. Hiertoe voegt u een record toe aan de hand van onderstaande stappen.
...
4. Selecteer **stap 1 starten**op de pagina Een domein toevoegen aan **Microsoft** . 
