...
Nadat u deze records bij Network Solutions hebt toevoegen, is uw domein ingesteld voor gebruik met Microsoft-services.
...
6. Typ of kopieer en plak de waarden uit de volgende tabel in de vakken voor de nieuwe record.
    ...
    |:-----|:-----|:-----|
    |10  <br/> Zie [Wat is MX-prioriteit?](../setup/domains-faq.yml) voor meer informatie over prioriteit.    <br/> |3600  <br/> | *\<domain-key\>*  .mail.protection.outlook.com.  <br/> **Deze waarde MOET eindigen op een punt (.)** <br/> **Opmerking:** Haal uw  *\<domain-key\>*  uit uw Microsoft-account. [Hoe kan ik dit vinden?](../get-help-with-domains/information-for-dns-records.md)          |
...
10. Als ze allemaal zijn geselecteerd, selecteert u **Doorgaan.**
...
5. Schuif omlaag naar de **sectie Host Aliases (CNAME Records)** en selecteer **vervolgens CNAME-records bewerken.**
