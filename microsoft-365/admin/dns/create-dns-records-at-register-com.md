...
Nadat u deze records hebt Register.com, is uw domein ingesteld voor gebruik met Microsoft-services.
...
4. Zoek de rij met de naam van het domein dat u wilt wijzigen. en selecteer vervolgens beheren in die **rij.**
...
5. Blader naar de **sectie Geavanceerde technische** instellingen en selecteer Vervolgens Mail **Exchanger-records bewerken.**
...
6. Typ of kopieer en plak de waarden uit de volgende tabel in de vakken voor de nieuwe record.
    ...
    |:-----|:-----|:-----|
    |@  <br/> |High  <br/> Zie [Wat is MX-prioriteit?](../setup/domains-faq.yml) voor meer informatie over prioriteit. <br/> | *\<domain-key\>*  .mail.protection.outlook.com  <br/>  <br/>**Opmerking:** Haal uw \<*domain-key*\> uit uw Microsoft-account. <br> [Hoe kan ik dit vinden?](../get-help-with-domains/information-for-dns-records.md)          |
...
5. Blader naar de **sectie Geavanceerde technische** instellingen en selecteer vervolgens Domain **Aliases Records bewerken.**
...
5. Blader naar de **sectie Geavanceerde technische** instellingen en selecteer vervolgens **TXT-records (SPF) bewerken.**
...
5. Blader naar de **sectie Geavanceerde technische** instellingen en selecteer vervolgens **SRV-records bewerken.**
