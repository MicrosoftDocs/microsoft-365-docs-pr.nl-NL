...
- Zodra u e-mail doorsturen hebt ingesteld, worden alleen **nieuwe** e-mails doorgestuurd die naar het postvak *van* het postvak worden verzonden. 
...
U moet exchange-beheerder of globale beheerder in Office 365 zijn om deze stappen uit te voeren. Zie het onderwerp [Over beheerdersrollen](../add-users/about-admin-roles.md)voor meer informatie .
