...
In deze tabel worden de verschillende samenwerkingsopties voor u uitgelegd.
...
In de volgende tabel ziet u snel de verschillende typen groepen en wordt uitgelegd wanneer en hoe u deze kunt gebruiken met de verschillende samenwerkingsfuncties.
  

||**Groepen in Outlook**|**Distributielijsten**|**Gedeelde postvakken**|**Openbare mappen**|
|:-----|:-----|:-----|:-----|:-----|
|**Gebruikt door** <br/> |Gebruikers die een werkruimte voor samenwerking willen voor hun groepsberichten, bestanden en agenda die is geïntegreerd met de services die ze al gebruiken (Outlook Web App, OneDrive voor Bedrijven)  <br/> |Gebruikers die e-mail willen verzenden naar een groep geadresseerden met een gemeenschappelijk belang of kenmerk.  <br/> |Gedeelde postvakken zijn een goede manier om vragen over e-mail van klanten te verwerken, omdat verschillende personen in uw organisatie de verantwoordelijkheid kunnen delen voor het bewaken van het postvak en het beantwoorden van query's. Uw klantvragen krijgen sneller antwoorden en gerelateerde e-mailberichten worden allemaal in één postvak opgeslagen.  <br/><br/> Gemachtigden die werken namens een virtuele identiteit, zoals support@contoso.com. Gemachtigden kunnen e-mail beantwoorden met deze gedeelde postvakidentiteit.  <br/> |Met de juiste machtigingen kan iedereen in uw organisatie openbare mappen openen en doorzoeken. Deze zijn ideaal voor het archiveren van e-mail of voor het delen van documenten.  <br/> |
...
[Openbare mappen in Microsoft 365 en Exchange Online](/exchange/collaboration-exo/public-folders/public-folders)
