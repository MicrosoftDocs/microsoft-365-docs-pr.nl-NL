...
In dit artikel wordt uitgelegd hoe u wachtwoorden opnieuw instelt voor uzelf en voor uw gebruikers wanneer u een Microsoft 365 voor een zakelijk abonnement hebt.
...
## <a name="watch-reset-a-business-password-for-a-user"></a>Horloge: Een bedrijfswachtwoord opnieuw instellen voor een gebruiker

Bekijk een korte video over het opnieuw instellen van gebruikerswachtwoorden.<br><br>
...
3. Volg de instructies op de pagina **Wachtwoord opnieuw instellen** om automatisch een nieuw wachtwoord voor de gebruiker te genereren of er zelf een aan te maken. Selecteer vervolgens **Opnieuw instellen**.  
...
Gebruik deze stappen als u uw wachtwoord bent vergeten, maar u kunt zich aanmelden bij Microsoft 365 omdat uw wachtwoord bijvoorbeeld is opgeslagen in uw browser:
...
3. Afmelden: selecteer uw naam in de rechterbovenhoek \> **Afmelden**.
...
- Zorg ervoor dat u alternatieve contactgegevens hebt opgegeven, waaronder een mobiel telefoonnummer.

- U kunt ook [Microsoft Ondersteuning bellen](../../business-video/get-help-support.md).

## <a name="reset-all-business-passwords-for-everyone-in-your-organization-at-the-same-time"></a>Reset alle bedrijfswachtwoorden voor iedereen in uw organisatie tegelijkertijd
...
2. Selecteer de optie naast **Weergavenaam** om iedereen in uw bedrijf te selecteren. Vervolgens heft u de selectie van uzelf op. U kunt uw eigen wachtwoord niet opnieuw instellen op hetzelfde moment dat u dat van anderen opnieuw instelt.

3. Selecteer **Wachtwoord opnieuw instellen**. 

4. Volg de aanwijzingen op de pagina **Wachtwoord opnieuw instellen** en selecteer **Opnieuw instellen**.  Als u ervoor hebt gekozen om het wachtwoord automatisch te genereren, worden de nieuwe tijdelijke wachtwoorden weergegeven.

5. Voer een e-mailadres in waarop u de tijdelijke wachtwoorden kunt ontvangen. U moet uw gebruikers op de hoogte stellen van hun tijdelijke wachtwoorden.
  
## <a name="reset-business-passwords-in-bulk"></a>Bedrijfswachtwoorden in bulk opnieuw instellen
<a name="bkmk_forgot"> </a>
...
## <a name="i-dont-have-a-microsoft-365-for-business-subscription"></a>Ik heb geen Microsoft 365 voor zakelijk abonnement
...
[Het beleid voor het verlopen van wachtwoorden voor uw organisatie instellen](../manage/set-password-expiration-policy.md) (artikel)
