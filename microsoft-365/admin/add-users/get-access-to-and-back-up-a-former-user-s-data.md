...
4. Selecteer **Exporteren naar een bestand**en selecteer **Volgende**.
    
    ![De optie Exporteren naar bestand in de wizard Importeren en exporteren](../../media/458466a0-366b-4fbf-a2db-1919412c6527.jpg)
  
5. Selecteer **Outlook-gegevensbestand (.pst)** en selecteer **Volgende**.
...
2. Selecteer **Importeren uit een ander programma of bestand**en selecteer **Volgende**.
