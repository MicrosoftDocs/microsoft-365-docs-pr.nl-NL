...
Nee, nieuwe groepsthema's moeten zijn toegesneden op een of meer groepen Microsoft 365 en niet beveiligingsgroepen of distributiegroepen.
...
Nee, nieuwe groepsthema's moeten zijn toegesneden op een of meer Microsoft 365 groepen. Gebruikers die lid zijn van de Microsoft 365 groep krijgen het thema toegepast op hun groep. U kunt [nieuwe leden maken en toevoegen](../create-groups/create-groups.md) aan een **** Microsoft 365 groep door naar de Instellingen   >  **Groepen** in het beheercentrum te gaan.
...
Zorg ervoor dat het logo dat u gebruikt, is opgegeven als een openbaar adresseerbare URL. Volg deze stappen voor [het uploaden van logo's](/azure/storage/blobs/storage-upload-process-images?tabs=dotnet) naar Azure Blob Storage of Office 365 Content Delivery Network [met SharePoint Online.](../../enterprise/use-microsoft-365-cdn-with-spo.md)
...
### <a name="if-i-define-a-theme-which-places-in-microsoft-365-will-this-be-used"></a>Als ik een thema definieert, welke plaatsen in Microsoft 365 wordt dit gebruikt?
