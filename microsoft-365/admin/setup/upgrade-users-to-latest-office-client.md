...
---
# <a name="upgrade-your-microsoft-365-for-business-users-to-the-latest-office-client"></a>Uw Microsoft 365 voor Bedrijven-gebruikers upgraden naar de nieuwste Office-client

## <a name="office-2010-reaches-end-of-support"></a>Office 2010 bereikt einde ondersteuning

Office 2010 heeft op 13 oktober 2020 het einde van de ondersteuning bereikt. Microsoft biedt niet langer het volgende:
...
Zie routekaart voor het einde van ondersteuning van [Office 2010](/deployoffice/endofsupport/office-2010-end-support-roadmap) voor meer informatie.
...
[Controleer de systeemvereisten voor](https://www.microsoft.com/microsoft-365/microsoft-365-and-office-resources) Office om te controleren of uw apparaten compatibel zijn met de nieuwste versie van Office. Nieuwere versies van Office kunnen bijvoorbeeld niet worden geïnstalleerd op computers met Windows XP of Windows Vista.
  
> [!TIP]
> Als u gebruikers in uw organisatie hebt met oudere versies van Windows op hun pc of laptops, raden we u aan een upgrade uit te naar Windows 10. Windows 7 heeft het einde van de ondersteuning bereikt. Lees [Ondersteuning voor Windows 7 eindigt in januari 2020](https://www.microsoft.com/microsoft-365/windows/end-of-windows-7-support?rtc=1) voor meer informatie.

Bekijk de systeemvereisten [voor Windows 10](https://www.microsoft.com/windows/windows-10-specifications) om te zien of u hun besturingssystemen kunt upgraden.
...
Sommige Microsoft 365-abonnementen bevatten niet de volledige bureaubladversies van Office en de stappen voor een upgrade zijn anders als Office niet in uw abonnement is vermeld.
 ...
 **Optie 1: Schakelen tussen Office-abonnementen**

Stap over op een abonnement waarin Office is opgenomen. Zie [Overschakelen naar een ander Microsoft 365 voor Bedrijven-abonnement.](../../commerce/subscriptions/switch-to-a-different-plan.md)

**Optie 2: Afzonderlijke, een een-tijdsaankopen van Office kopen of Office kopen via een volumelicentie**

 - Koop een individuele, een een-tijdsaankoop van Office. Zie [Office Voor Bedrijven &amp; of](https://www.microsoft.com/microsoft-365/buy/compare-all-microsoft-365-products-b) [Office Professional](https://www.microsoft.com/microsoft-365/p/office-professional-2019/CFQ7TTC0K7C5/)
...
Voordat u de nieuwste versie van Office installeert, raden we u aan alle oudere versies van Office te verwijderen. Als u echter van gedachten verandert over het upgraden van Office, moet u rekening houden met de volgende gevallen waarin u Office niet meer kunt installeren nadat u office hebt verwijderd.
...
> [!TIP]
> Als u problemen krijgt tijdens het verwijderen van Office, kunt u het hulpprogramma Ondersteunings- en herstelassistent van Microsoft gebruiken om Office te verwijderen: Download en voer de Microsoft Ondersteunings- en [Herstelassistent uit.](https://go.microsoft.com/fwlink/?LinkID=2155008)
 ...
 **Office via een volumelicentie** Als u geen toegang meer hebt tot de bronbestanden van deze volumelicentieversies van Office, kunt u deze niet opnieuw installeren.

 **Office vooraf geïnstalleerd op uw computer** Als u geen schijf of productcode meer hebt (als Office er een heeft), kunt u deze niet meer installeren.

 **Niet-ondersteunde abonnementen** Als uw exemplaar van Office is verkregen via beëindigde abonnementen, zoals Office 365 Voor Kleine Bedrijven Premium of Office 365 voor Middelgrote en Grote Bedrijven, kunt u geen oudere versie van Office installeren, tenzij u de productcode hebt die bij uw abonnement is betrokken.
...
> [!TIP]
> Zie Downloadinstellingen voor software beheren [in Office 365](/DeployOffice/manage-software-download-settings-office-365)als u niet wilt dat uw gebruikers Office zelf installeren. U kunt het [Office-implementatieprogramma](/DeployOffice/overview-office-deployment-tool) gebruiken om de Office-software naar uw lokale netwerk te downloaden en Vervolgens Office te implementeren met behulp van de softwareimplementatiemethode die u gewoonlijk gebruikt.