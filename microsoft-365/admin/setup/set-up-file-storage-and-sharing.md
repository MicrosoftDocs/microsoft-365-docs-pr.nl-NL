...
Bekijk een korte video over waar u bestanden opslaan in Office 365.<br><br>
...
- Een teamsite is ontworpen om regelmatig bestanden te delen en samen te werken. Een teamsite is ideaal voor het opslaan van bestanden die gedeeld eigendom hebben waar meerdere mensen eigenaar zijn van de bestanden en eraan kunnen samenwerken. Maak een Microsoft Team om een teamsite toe te voegen. [Meer informatie bij Een team maken in Teams](https://support.office.com/article/174adf5f-846b-4780-b765-de1a0a737e2b).

Zowel OneDrive- als teamsites bieden u en uw medewerkers overal toegang.
  
![Een diagram dat laat zien hoe Office 365-producten OneDrive- of Team-sites kunnen gebruiken](../../media/7493131e-665f-4dbd-9a60-f5612aea7e42.png)
...
4. Laat op de pagina **Koppeling verzenden** de standaardselectie achter Iedereen met de koppeling kan **deze weergeven en bewerken.**

    Typ namen of e-mailadressen van teamleden die u toegang tot de map wilt hebben en voeg een optioneel bericht toe.

    Als u uw eigen kopie wilt van de e-mail die wordt verzonden, voegt u uw e-mailadres toe aan de lijst.

    ![Deel een koppelingsdialoogvenster met het weergeven van typen en het selecteren van een naam.](../../media/877e6587-db9d-4903-a87b-11e570eee926.png)
  
5. Wanneer u klaar bent met het invoeren met wie u wilt delen, selecteert u **Verzenden**. De e-mail wordt onmiddellijk verzonden naar de mensen die u uitnodigt.
...
5. U kunt de bestanden van uw computer verwijderen. In de volgende stap, [Synchroniseer online bestanden met uw pc of Mac](#sync-online-files-with-your-pc-or-mac), gaat u een nieuwe locatie voor deze bestanden op uw computer maken.

    Lees deze tips voor het [uploaden van grote bestanden of veel bestanden naar een bibliotheek](https://support.office.com/article/da549fb1-1fcb-4167-87d0-4693e93cb7a0.aspx#__toc384119242) als u een groot aantal bestanden of grote bestanden hebt die u wilt uploaden naar uw teamsite.
...
Nu dat u bestanden op uw teamsite hebt, kunt u instellen dat deze met uw pc of Mac worden gesynchroniseerd. Op deze manier u vanaf uw pc of Mac aan uw bestanden werken in plaats van in Microsoft Edge, Chrome of een andere browser te werken. Het is ook handig om een versie van uw bestanden op uw pc of Mac te synchroniseren, voor het geval dat u een bestand nodig hebt en geen verbinding met internet hebt.
...
3. Kies **Ja**als u wordt gevraagd om van app te wisselen. OneDrive is het proces dat de synchronisatie doet.
...
5. Als u uw OneDrive nog niet hebt gesynchroniseerd, ziet u mogelijk een scherm met **de Map dit is uw OneDrive.** Controleer hier het pad onder **de map OneDrive.** Kies **Locatie wijzigen** als u een ander pad wilt gebruiken en selecteer **Vervolgens**.

    ![Uw lokale map wijzigen op dit scherm](../../media/6395485a-e729-4a9a-8e7d-b35e662435da.png)
...
- **Eenmanszaken:** Gebruik OneDrive om uw eigen bestanden op te slaan en per geval met klanten te delen.

- **Mede-eigendommen**: Beide eigenaren gebruiken OneDrive en delen bestanden heen en weer.

- **Bedrijven met externe klanten of partners die toegang tot bestanden nodig hebben:** Maak een nieuwe teamsite om documenten op te slaan en te delen die bestemd zijn voor een specifieke klant. Stel de site in om alleen die klant toegang te geven. U hoeft zich dan geen zorgen te maken dat één klant per ongeluk toegang krijgt tot informatie die voor een andere klant is bedoeld.

### <a name="keep-private-files-private"></a>Persoonlijke bestanden privé houden

Wanneer u een bestand opslaat in OneDrive, is het alleen toegankelijk voor u, tenzij u het met anderen deelt. Wanneer u bestanden deelt, u ervoor kiezen een koppeling te maken die kan worden doorgestuurd of om te delen met alleen specifieke personen. U kunt ook afzonderlijke mappen in OneDrive maken voor verschillende doeleinden, zoals openbare, persoonlijke of afzonderlijke projecten. Elke map kan met een andere persoon of groep worden gedeeld, of met helemaal niemand.
  
Zie Ook Bestanden en [mappen delen met Office 365](https://support.office.com/article/72f26d6c-bf9e-432c-8b96-e3c2437f5b65.aspx)voor meer informatie over delen.
  
### <a name="track-how-much-space-you-have-left"></a>Controleren hoeveel opslagruimte u nog hebt

Zie Uw [OneDrive voor Bedrijven-opslag](https://support.office.com/article/31519161-059C-4764-B6F8-F5CD29F7FE68.aspx)beheren als u nog hoeveel opslagruimte u nog hebt in OneDrive.
...
2. Ga naar de pagina Instellingen <a href="https://go.microsoft.com/fwlink/p/?linkid=2118715" target="_blank">voor</a> **Instellingen.** \>
