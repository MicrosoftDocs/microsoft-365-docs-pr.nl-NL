...
Als u meer informatie op een team site wilt weergeven, kunt u de startpagina van SharePoint aanpassen, zodat u en uw werknemers snel de informatie kunnen vinden die u nodig hebt. U hebt bijvoorbeeld een koppeling naar OneDrive-mappen voor werknemers en koppelingen naar documenten, contactpersonen, taken, Agenda's en een OneNote-notitieblok waar u Vergader agenda's en notities opslaat.
  
Zie [het uiterlijk van uw SharePoint-site wijzigen](https://support.microsoft.com/office/06bbadc3-6b04-4a60-9d14-894f6a170818)voor informatie over het aanpassen van het uiterlijk van uw startpagina.
...
Als u de detectie van een site wilt verbeteren, kunt u deze als een aanbevolen koppeling toevoegen aan de startpagina van SharePoint. Zie [aanbevolen koppelingen toevoegen aan de startpagina van SharePoint](/sharepoint/change-links-list-on-sharepoint-home-page)voor informatie.
  
Als u een afbeelding wilt toevoegen aan de startpagina van een team site, raadpleegt u [een afbeelding of afbeeldingsbestand toevoegen aan een SharePoint-pagina](https://support.microsoft.com/office/4a9b0e98-c89a-4a41-8adb-b7750dccca16).
  
Zie [een pagina toevoegen aan een site](https://support.microsoft.com/office/b3d46deb-27a6-4b1e-87b8-df851e503dec)voor meer informatie over het toevoegen van pagina's aan uw site.
...
Zie [grote lijsten en bibliotheken beheren in SharePoint](https://support.microsoft.com/office/B8588DAE-9387-48C2-9248-C24122F07C59)als u een groot aantal gegevens in een lijst wilt opslaan.
...
Als u gebruikers wilt toevoegen aan een Microsoft 365-groep, raadpleegt u [gebruikers toevoegen en licenties toewijzen](../add-users/add-users.md).
