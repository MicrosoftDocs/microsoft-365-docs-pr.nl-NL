...
-  Als u niet weet wie de DNS-hostingprovider of domeinregistrar voor uw domein is, raadpleegt u [Zoeken naar uw domeinregistrar of DNS-hostingprovider](../get-help-with-domains/find-your-domain-registrar.md). Zie DNS-basisbeginselen voor beschrijvingen van wat de [DNS-records doen.](../get-help-with-domains/dns-basics.md)
