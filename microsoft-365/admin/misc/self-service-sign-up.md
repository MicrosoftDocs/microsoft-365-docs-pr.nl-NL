...
3. We valideren hun e-mailadres en dan kunnen ze meteen microsoft 365, Power BI of andere services gaan gebruiken.

4. Als bedrijfsbeheerder ziet u wie zich heeft aangemeld voor een abonnement door de pagina **Uw producten** in het beheercentrum te bekijken. Op deze manier u zien wanneer er nieuwe of niet-erkende licenties voor services in uw tenant zijn. Als u wilt bepalen of gebruikers zich kunnen aanmelden voor selfservice-abonnementen, gebruikt u de PowerShell-cmdlet [Set-MsolCompanySettings](https://docs.microsoft.com/powershell/module/msonline/set-msolcompanysettings?view=azureadps-1.0) met de parameter **AllowAdHocSubscriptions.** Zie [Hoe beheer ik de zelfbedieningsinstellingen voor](https://docs.microsoft.com/microsoft-365/commerce/subscriptions/self-service-purchase-faq?view=o365-worldwide) meer informatie?
...
|Office 365 A1**** <br/> |Elke leerling of docent kan een schoole-mailadres gebruiken om zich aan te melden voor gratis Office 365 en Office-apps voor het web, 1 TB OneDrive-cloudopslag en SharePoint Online te downloaden voor klas-, team- en projectsites.  <br/> |[Office 365 Education - veelgestelde technische vragen](https://go.microsoft.com/fwlink/p/?LinkId=536625) <br/> |[Office 365 Education](https://go.microsoft.com/fwlink/p/?linkid=140841) <br/> |
|**Office 365 A1 Plus** <br/> |In aanmerking komende studenten en docenten kunnen zich aanmelden voor Office 365 A1 Plus, dat alles wat hierboven is vermeld plus Microsoft 365 Apps voor bedrijven bevat. Microsoft 365 Apps for enterprise is productiviteitssoftware, waaronder Word, PowerPoint, Excel, Outlook, OneNote, Publisher, Access en Skype voor Bedrijven, die is geïnstalleerd op uw desktop- of laptopcomputer.  <br/> |[Office 365 Education - veelgestelde technische vragen](https://go.microsoft.com/fwlink/p/?LinkId=536625) <br/> |[Office 365 Education](https://go.microsoft.com/fwlink/p/?linkid=140841) <br/> |
|**Power BI** <br/> |Power BI stelt gebruikers in staat om gegevens te visualiseren, ontdekkingen te delen en op intuïtieve nieuwe manieren samen te werken. <br/> Als uw organisatie zich al abonneert, u bovendien licenties voor 'Power BI Pro Individual User Trial' zien, waarmee gebruikers beperkte, gratis toegang hebben tot geavanceerde mogelijkheden.  <br/> |[Power BI in uw organisatie](https://go.microsoft.com/fwlink/p/?LinkId=536626) <br/> |[Microsoft Power BI](https://go.microsoft.com/fwlink/p/?LinkId=536629) <br/> |
...
|**Energie automatiseren** <br/> |Power Automate is een product waarmee u geautomatiseerde workflows instellen tussen uw favoriete apps en services om bestanden te synchroniseren, meldingen te ontvangen, gegevens te verzamelen en meer.  <br/> |[Meld u aan en meld u aan voor Power Automate](https://docs.microsoft.com/power-automate/sign-up-sign-in) <br/> |[Energie automatiseren](https://go.microsoft.com/fwlink/p/?linkid=841465) <br/> |
|**Virtuele poweragents** <br/> |Power Virtual Agents stelt teams in staat om eenvoudig krachtige bots te maken met behulp van een geleide, no-code grafische interface zonder de noodzaak voor data scientists of ontwikkelaars. Power Virtual Agents adressen veel van de belangrijkste problemen met bot gebouw in de industrie van vandaag. Het elimineert de kloof tussen het onderwerp deskundigen en de ontwikkelingsteams het bouwen van de bots, en de lange latentie tussen teams herkennen van een probleem en het bijwerken van de bot om het aan te pakken.  <br/> |[Licentie- en toegangsgegevens](https://go.microsoft.com/fwlink/?linkid=2113708) <br/> |[Meld u aan voor Power Virtual Agents](https://aka.ms/TryPVA) <br/> |
|**Azure AD B2B** <br/> |Met de B2B-samenwerking (Azure Active Directory) (Azure AD) u externe gebruikers (of 'gastgebruikers') uitnodigen om uw betaalde Azure AD-services te gebruiken. Sommige functies zijn gratis, maar voor alle betaalde Azure AD-functies u maximaal vijf gastgebruikers uitnodigen voor elke Azure AD-editielicentie die u bezit voor een werknemer of een niet-gastgebruiker in uw tenant. <br/> |[Selfservice voor aanmelding voor Azure AD B2B-samenwerking](https://docs.microsoft.com/azure/active-directory/b2b/self-service-portal) <br/> |[Azure Active Directory B2B-richtlijnen voor samenwerkingslicenties](https://docs.microsoft.com/azure/active-directory/b2b/licensing-guidance) <br/> |