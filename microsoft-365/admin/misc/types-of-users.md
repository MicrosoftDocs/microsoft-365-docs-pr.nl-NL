...
ms.locfileid: "50914567"
---
# <a name="quick-help-types-of-users"></a>Snelle Help: Typen gebruikers

Op de **pagina Actieve gebruikers** in het Microsoft 365-beheercentrum kunt u filteren op de volgende typen gebruikers. 
...
|Gebruikers voor wie aanmelding is geblokkeerd  <br/> |Deze gebruikers kunnen zich niet aanmelden bij Microsoft 365. Een voorbeeld hiervan is een gebruiker die het bedrijf heeft verlaten en u de toegang tot Microsoft 365 hebt geblokkeerd.  <br/> |
|Gebruikers zonder licentie  <br/> |Deze gebruikers hebben geen Microsoft 365-licentie, zoals Microsoft 365 Business Standard of Office 365 Enterprise E3, dus ze kunnen microsoft 365-functies niet gebruiken. Voorbeelden hiervan zijn beheerders die alleen Microsoft 365 hoeven te beheren, werknemers die het bedrijf hebben verlaten of gedeelde en resourcepostvakken die niet aan personen zijn gekoppeld.  <br/> |
...
|Globale beheerders  <br/> |Deze gebruikers hebben toegang tot alle beheerfuncties. De persoon die zich bij Microsoft 365 meldt, wordt een globale beheerder, maar u kunt er meerdere hebben als u wilt. Globale beheerders zijn de enige beheerders die beheerdersrollen aan anderen kunnen toewijzen.  <br/> |
...
|Aangepast filter toevoegen  <br/> |Met deze optie kunt u een aangepast filter maken om alleen bepaalde typen gebruikers van uw voorkeur weer te geven, zoals welke gebruikers deel hebben aan het Microsoft 365 Apps voor Bedrijven-abonnement. [Snelle hulp: Filter gebruikers.](../add-users/create-edit-or-delete-a-custom-user-view.md)  <br/> |
   
## <a name="related-articles"></a>Verwante artikelen

[Tegelijkertijd gebruikers toevoegen en licenties toewijzen](../add-users/add-users.md)
