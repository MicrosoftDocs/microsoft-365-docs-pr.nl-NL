...
- **Licentiebeheer en facturering** Bekijk een lijst met aangeschafte en toegewezen licenties, wijs licenties toe aan gebruikers, koop of verwijder licenties en bekijk en download facturen.
- **Ondersteuning** Maak een nieuwe serviceaanvraag en houd alle updates bij die betrekking hebben op de serviceaanvragen terwijl u onderweg bent.
- **Berichtencentrum** Blijf op de hoogte van alle aanstaande wijzigingen, gepland onderhoud of andere belangrijke aankondigingen met betrekking tot Microsoft 365
...
## <a name="watch-install-the-admin-mobile-app"></a>Kijken: De mobiele app voor beheerders installeren
...
Ja, maar met beperkte functionaliteit. U kunt zich aanmelden en servicegegevens weergeven, maar de meeste functies voor gebruikersbeheer zijn alleen-lezen. U kunt geen gebruikers toevoegen, bewerken of verwijderen. U kunt echter wel licenties toewijzen aan gebruikers in uw organisatie en meldingen ontvangen.
...
Als u een specifiek service-incident of een bericht selecteert, staat de optie Delen in de rechterbovenhoek.
  
### <a name="can-i-use-this-app-with-multiple-accounts-or-tenants"></a>Kan ik deze app gebruiken met meerdere accounts of tenants?

Ja, u kunt meerdere accounts of organisaties instellen.

### <a name="im-unable-to-login-or-my-app-is-acting-funny-what-can-i-do-to-troubleshoot-or-fix-the-issue"></a>Ik kan me niet aanmelden of mijn app doet raar. Wat kan ik doen om het probleem op te lossen of op te lossen?
...
Ga in het linkernavigatiemenu naar **Instellingen**  >  **Meldingen.** U kunt hier service- en berichtencentrum- en factureringsmeldingen beheren.
