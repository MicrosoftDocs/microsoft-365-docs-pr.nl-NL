...
We bieden een primair inzicht met de belangrijkste gegevens voor de samenwerking van inhoud. Vervolgens wordt een score Framework dat hieronder wordt beschreven, gebruikt om de score te berekenen.

### <a name="primary-insight"></a>Primaire inzichten

Microsoft OneDrive voor bedrijven en SharePoint bieden gebruikers de mogelijkheid hun afzonderlijke en gedeelde inhoud in Microsoft 365 te kunnen maken, lezen en detecteren via meerdere apparaten en toepassingen. Gebruikers kunnen er ook voor zorgen dat mensen veilig inhoud delen en eraan samenwerken. Het belangrijkste inzicht bevat gegevens van iedereen die OneDrive voor bedrijven en SharePoint kunnen gebruiken. Daarnaast worden de details gesplitst van de hoeveelheid mensen die zijn opgeslagen in OneDrive voor bedrijven en SharePoint.
...
1. **Koptekst:** Hier ziet u het percentage van personen die toegang hebben tot OneDrive of SharePoint, en die samenwerken aan inhoud.
...
3. **Visualisatie (huidige status):**
    - Horizontale balken waarbij de blauwe gekleurde gedeelten het percentage weergeven van personen die zijn ingeschakeld voor samenwerking via OneDrive of SharePoint die een **lezer, Creator** of medewerkers zijn van online **bestanden in de** afgelopen 30 dagen.
    ...
    - Markeer de (teller/noemer) van de breuk die wordt gebruikt voor het berekenen van het percentage dat in elk van de horizontale balken wordt weergegeven.
    
      - **Programma's**</br>
          - Teller: het aantal personen dat online bestanden in OneDrive of SharePoint in de afgelopen 28 dagen opent of downloadt</br>
          - Noemer: het aantal personen dat OneDrive of SharePoint bevat voor minstens 1 van de afgelopen 30 dagen</br>
      - **Creators**</br>
...
Met de score voor de samenwerking van inhoud wordt gemeten of gebruikers in OneDrive of SharePoint in OneDrive of SharePoint-bestanden in Office-, Excel-, PowerPoint-of PDF-bestanden, zoals Word, Excel, PowerPoint, OneNote of PDF, aangeven.

## <a name="explore-how-your-organization-collaborates"></a>De werking van uw organisatie verkennen

We bieden u ook informatie waarmee u inzicht krijgt in de manier waarop mensen in uw organisatie aan inhoud kunnen samenwerken. Deze extra metrische gegevens leveren geen directe bijdrage aan de productiviteits Score, maar helpen u bij het maken van een actieplan voor het optimaliseren van de manier waarop personen werken.
...
3. **Visualisatie:** De uitsplitsing in de visualisatie is bedoeld om te voorkomen dat personen die inhoud in e-mailbijlagen bijvoegen, verschillende modi (bestanden die niet in OneDrive of SharePoint) worden gebruikt, in een koppeling naar online bestanden en koppelingen ingesloten in het e-mailbericht worden weergegeven:
      - **Bestanden bijvoegen:** Het blauwe (gekleurde) gedeelte van de balk en de breuk (teller/noemer) op de balk geeft het percentage aan van personen die bijlagen in e-mailberichten gebruiken.
        - Teller: het aantal personen dat bestand bijvoegt voor e-mail die niet is opgeslagen in OneDrive of SharePoint in de afgelopen 28 dagen
        - Noemer: het aantal gebruikers dat bijlagen gebruikt in een willekeurig formulier in e-mailberichten in de afgelopen 28 dagen
      - **Koppelingen naar online bestanden:** Het blauw (gekleurd) gedeelte van de balk en de breuk (teller/noemer) op de balk geven het percentage aan van de personen die bijlagen gebruiken en koppelingen naar bestanden in e-mailberichten bijvoegen.
        - Teller: het aantal personen dat wordt gekoppeld aan e-mailberichten die zijn gekoppeld aan online bestanden (opgeslagen in OneDrive of SharePoint) binnen de laatste 28 dagen.
        - Noemer: het aantal personen dat bijlagen gebruikt in een willekeurig formulier in e-mailberichten in de afgelopen 28 dagen.
      - **Koppelingen in E-mail insluiten:** Het blauwe (gekleurd) gedeelte van de balk en de breuk op de balk geeft het percentage aan van de personen die koppelingen in de hoofdtekst van de e-mail insluiten.
        - Teller: het aantal personen waarmee koppelingen in e-mailberichten van online bestanden (opgeslagen in OneDrive of SharePoint) worden ingesloten in de afgelopen 30 dagen
        - Noemer: het aantal gebruikers dat bijlagen gebruikt in een willekeurig formulier in e-mailberichten in de afgelopen 28 dagen
4. **Koppeling naar bronnen:** Selecteer deze koppeling om de Help-inhoud te bekijken.
...
In deze sectie wordt uitgelegd hoe u zich kunt richten op de metrieke gegevens door gebruikers details van activiteiten die relevant zijn voor alle inzichten weer te geven.
...
- **Bestanden gemaakt op OneDrive:** Booleaanse waarde die aangeeft of de persoon die u hebt gemaakt, gewijzigd, geüpload, gesynchroniseerd, ingecheckt, gekopieerd of verplaatst online bestanden (in Microsoft Word, Excel, PowerPoint of OneNote) in OneDrive binnen de laatste 28 dagen.
- **Bestanden gemaakt op SharePoint:** Booleaanse waarde die aangeeft of de persoon die de laatste 28 dagen heeft gemaakt, gewijzigd, geüpload, gesynchroniseerd, ingecheckt, gekopieerd of verplaatst online bestanden (in Microsoft Word, Excel, PowerPoint of OneNote).
- **Dagen als lezer:** Het aantal dagen dat de persoon heeft geprobeerd online bestanden (in Microsoft Word, Excel, PowerPoint, OneNote of PDF) in OneDrive of SharePoint in de afgelopen 30 dagen te openen of te downloaden.
- **Dagen als Creator:** Het aantal dagen dat de persoon heeft gemaakt, gewijzigd, geüpload, gesynchroniseerd, ingecheckt, gekopieerd of verplaatst online bestanden (in Microsoft Word, Excel, PowerPoint, OneNote of PDF) in OneDrive of SharePoint in de afgelopen 30 dagen.
- **Bestanden die zijn samengewerkt aan:** Het aantal online bestanden op OneDrive of SharePoint waartoe de persoon de laatste 28 dagen heeft samengewerkt.
- **Intern gedeelde bestanden:** Het aantal online bestanden op OneDrive of SharePoint dat de persoon heeft gedeeld met andere personen in uw organisatie in de afgelopen 30 dagen.
