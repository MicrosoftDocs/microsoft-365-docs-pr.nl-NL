...
Om aan de slag te gaan met mobiliteitsinzichten, moeten personen in uw organisatie een licentie hebben voor:
...
We bieden een primair inzicht in de ervaring die de belangrijkste metrische gegevens voor deze categorie bevat. Vervolgens wordt een hieronder beschreven scorekader gebruikt voor deze metrische gegevens om de score van uw organisatie te berekenen.
...
1. **Koptekst:** Toont het percentage personen in uw organisatie dat toegang heeft tot een van Microsoft 365-apps en die actief zijn op ten minste één van deze toepassingen op meer dan één platform.
2. **Body:** Hier vindt u meer informatie over hoe het gebruik van deze toepassingen op meerdere platforms de efficiëntie en tevredenheid kan verhogen.
...
In deze grafiek ziet u de trendlijn, waarbij de teller het aantal personen is dat apps heeft gebruikt in de afgelopen 180 dagen. Elk gegevenspunt in het lijndiagram is een aggregaat van activiteit voor de afgelopen 28 dagen. Elk gegevenspunt bevat een aantal personen in uw organisatie dat een toepassing gebruikt op ten minste twee platforms in de afgelopen 28 dagen voor elke datum op de x-as.
...
## <a name="explore-how-your-org-works-across-platforms-and-locations"></a>Ontdek hoe uw organisatie werkt op verschillende platforms en locaties
...
3. **Visualisatie:** De gegroepeerde verticale lijn is bedoeld om het aantal personen weer te geven dat gebruik maakt van elk van de apps die worden beschouwd als Word, Excel, PowerPoint en OneNote- op één of meerdere platforms. Voor elk van deze toepassingen vertegenwoordigen balken het volgende:
      ...
      - **Alleen mobiel:** Het aantal gebruikers dat de afgelopen 28 dagen actief is op een app op een mobiel platform.
