...
description: 'Meer informatie over hoe gebruiksanalyse verbinding maakt met een API en de maandelijkse trend van het gebruik van verschillende Microsoft 365 services.  '
...
Microsoft 365 gebruiksanalyse maakt verbinding met een API die een multidimensionaal gegevensmodel blootstelt. De API's die Microsoft 365 gebruiksanalyse gebruiken om de gegevens te genereren, zijn afkomstig van de verschillende, algemeen beschikbare, Graph API's. De functie van de Microsoft 365 gebruiksanalyse-API op zichzelf is over het algemeen niet beschikbaar.
  
> [!NOTE]
> Zie Werken met Microsoft 365 [gebruiksrapporten in Microsoft](/graph/api/resources/report)Graph voor meer Graph. 
...
## <a name="data-tables-returned-by-the-microsoft-365-reporting-api"></a>Gegevenstabellen die worden geretourneerd door de Microsoft 365 Reporting API
...
|Tenant Microsoft 365 Groups Usage  <br/> |Bevat gegevens over Microsoft 365 Gebruik van groepen, waaronder Postvak, SharePoint en Yammer.  <br/> |Bevat gegevens over de status van het einde van de maand voor een lopende periode van twaalf maanden, inclusief de huidige gedeeltelijke maand.  <br/> |
|Tenant Office Activation  <br/> |Bevat gegevens over het aantal Office-abonnementsactiveringen, het aantal activeringen per apparaat (Android/iOS/Mac/PC), activeringen per serviceplan, bijvoorbeeld Microsoft 365-apps voor ondernemingen, Visio, Project.  <br/> |Bevat gegevens over de status van het einde van de maand voor een lopende periode van twaalf maanden, inclusief de huidige gedeeltelijke maand.  <br/> |
...
|IDType  <br/> |Id-type is ingesteld op 1 als de gebruiker een Yammer-gebruiker is die verbinding maakt met behulp van hun Yammer-id of 0 als ze verbinding maken met Yammer met hun Microsoft 365-id.  <br/> Waarde is 1 om aan te geven dat deze gebruiker verbinding maakt met Yammer met zijn of haar Yammer id en niet met Microsoft 365 id  <br/> |
...
|Deleted  <br/> |Is waar als de gebruiker is verwijderd uit Microsoft 365 in die laatste volledige maand.  <br/> |
|Verwijderde datum  <br/> |Datum waarop de gebruiker is verwijderd uit Microsoft 365.  <br/> |
|YAM_State  <br/> |Staten van de gebruiker in het Yammer, kunnen actief, verwijderd of opgeschort zijn.  <br/> |
...
|ODB_FileSharedInternally  <br/> |Het aantal bestanden dat deze gebruiker intern heeft gedeeld vanaf OneDrive voor Bedrijven of met gebruikers binnen groepen (waaronder mogelijk externe gebruikers).  <br/> |
...
|**Kolomnaam**|**Kolombeschrijving**|
|:-----|:-----|
|Product  <br/> |Naam van het product binnen Microsoft 365 waarvoor klantgebruiksgegevens beschikbaar zijn.  <br/> |
...
Deze tabel bestaat uit maand-op-maandoverzichtsgegevens over het gebruik of de activiteit van SharePoint onlinesites. Dit geldt alleen voor teamsites en groepssites. De status einde van de maand van SharePoint Online-sites wordt weergegeven in deze kolom, bijvoorbeeld als een gebruiker een vijftal documenten heeft gemaakt en 10 MB voor totale opslag heeft gebruikt, en vervolgens enkele bestanden heeft verwijderd en meer bestanden heeft toegevoegd, zodat aan het einde van de maand de status voor bestanden zeven totaal is die vijf MB opslagruimte gebruiken, de waarde van die in deze tabel staat voor het einde van de maand. Deze tabel is verborgen om dubbele aggregaties te voorkomen en wordt gebruikt als bron om twee verwijzingstabellen te maken.
...
|Diplansed  <br/> |De totale gebruikte opslagruimte wordt opgeteld in OneDrive account aan het einde van de periode.  <br/> |
...
|SPO_FileAccessedActiveGroups  <br/> |Het aantal SharePoint groepen met activiteiten die zijn toegankelijk voor bestanden.  <br/> |
|SPO_FileSyncedActiveGroups  <br/> |Het aantal SharePoint groepen met bestandsgesynchroniseerde activiteiten.  <br/> |
|SPO_FileSharedInternallyActiveGroups  <br/> |Het aantal SharePoint groepen met gedeelde activiteiten intern of met groepen (waaronder mogelijk externe gebruikers).  <br/> |
...
|SPO_FileSharedInternallyActivities  <br/> |Aantal gedeelde SharePoint of met groepen (mogelijk externe leden).  <br/> |
...
De tabel bevat gegevens over het aantal activeringen Office abonnementen in de serviceplannen, bijvoorbeeld Microsoft 365-apps voor ondernemingen, Visio, Project. De tabel bevat ook gegevens over het aantal activeringen per apparaat (Android/iOS/Mac/pc).
