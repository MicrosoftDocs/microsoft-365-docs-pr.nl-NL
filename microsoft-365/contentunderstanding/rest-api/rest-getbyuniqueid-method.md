...
Hiermee wordt informatie opgehaald of bijgewerkt over een SharePoint Syntex-model voor documentbegrip (zie [voorbeeld](rest-getbyuniqueid-method.md#examples)).
...
|-----|---|--------|----|-----------|
|modelUniqueId|query|Waar|tekenreeks|Id van het Syntex-modelbestand.|
...
### <a name="get-the-contoso-contract-model-by-id"></a>Het Contoso-contractmodel ophalen op id

In dit voorbeeld wordt `7645e69d-21fb-4a24-a17a-9bdfa7cb63dc` gebruikt als id van het Contoso-contractmodel voor documentbegrip.
...
### <a name="get-and-delete-the-contoso-contract-model-by-id"></a>Het Contoso-contractmodel ophalen en verwijderen op id
