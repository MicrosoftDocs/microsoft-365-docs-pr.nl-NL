...
Windows PowerShell syndicatie- en Cloud Solution Provider(CSP)-partners kunnen eenvoudig klantpachtinstellingen beheren en rapporteren die niet beschikbaar zijn in de Microsoft 365-beheercentrum. Houd er rekening mee dat machtigingen voor het beheren namens (AOBO) vereist zijn voor het account van de partnerbeheerder om verbinding te maken met de klanttenancies.
