...
Voordat contoso zijn gevoelige digitale assets naar de cloud verplaatst, heeft Contoso ervoor zorgen dat de vereisten voor de on-premises informatieclassificatie en -beveiliging werden ondersteund door de cloudservices van Microsoft 365 voor bedrijven.
...
## <a name="the-contoso-path-to-information-protection-with-microsoft-365-for-enterprise"></a>Het Contoso-pad naar informatiebeveiliging met Microsoft 365 voor bedrijven

Contoso heeft deze stappen gevolgd om Microsoft 365 voor ondernemingen voor te bereiden op hun vereisten voor informatiebeveiliging:
...
5.  Train werknemers hoe ze gevoeligheidslabels voor nieuwe documenten kunnen gebruiken, hoe ze kunnen werken met Contoso IT bij het maken van nieuwe SharePoint-sites en hoe u digitale assets altijd op SharePoint-sites kunt opslaan
...
- SharePoint gebruikt app-afdwingbare beperkingen.
...
## <a name="mapping-microsoft-365-for-enterprise-features-to-contoso-data-levels"></a>Microsoft 365 voor ondernemingsfuncties toewijzen aan Contoso-gegevensniveaus

In de volgende tabel worden contoso-gegevensniveaus aan informatiebeveiligingsfuncties in Microsoft 365 voor ondernemingen toe te staan.
...
| Niveau 3: sterk gereglementeerd | Niveau 2 plus: <BR><BR> Uw eigen sleutelversleuteling (BYOK) en beveiliging voor handelsgeheime informatie meenemen <BR> Azure Key Vault voor zakelijke toepassingen die werken met Microsoft 365-services | Niveau 2 | Niveau 1 |
|||||
...
Lees hoe Contoso de beveiligingsfuncties in [Microsoft 365](contoso-security-summary.md) voor ondernemingen gebruikt voor identiteits- en toegangsbeheer, bedreigingsbeveiliging, informatiebeveiliging en beveiligingsbeheer.
