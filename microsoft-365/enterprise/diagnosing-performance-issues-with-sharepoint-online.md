...
---
# <a name="diagnosing-performance-issues-with-sharepoint-online"></a>Prestatieproblemen met SharePoint Online diagnosticeren

In dit artikel wordt beschreven hoe u veelvoorkomende problemen met uw SharePoint Online-site kunt opsporen met behulp van hulpprogramma's voor ontwikkelaars van Internet Explorer.
...
In dit onderwerp wordt beschreven hoe u elk van deze methoden kunt gebruiken om prestatieproblemen te diagnosticeren. Nadat u de oorzaak van het probleem hebt gevonden, kunt u naar een oplossing werken met behulp van de artikelen over het verbeteren van De prestaties van SharePoint die u kunt vinden op https://aka.ms/tune .
...
De beste manier om de zwakke punten van de prestaties van uw site te bepalen, is door een volledig kant-en-klaar siteverzameling in SharePoint Online in te stellen. Op deze manier kunt u alle verschillende aspecten van uw site vergelijken met wat u zou krijgen zonder aanpassing op de pagina. De startpagina van OneDrive voor Bedrijven is een goed voorbeeld van een afzonderlijke siteverzameling die waarschijnlijk geen aanpassingen bevat.
  
## <a name="viewing-sharepoint-response-header-information"></a>SharePoint-antwoordkopgegevens weergeven
<a name="F12ToolInfo"> </a>
...
### <a name="to-view-sharepoint-response-header-information"></a>Informatie over de reactiekoptekst van SharePoint weergeven
