...
---
# <a name="sharepoint-2007-migration-options-to-consider"></a>SharePoint migratieopties voor 2007 om rekening mee te houden
...
## <a name="common-upgrade-strategies-for-sharepoint"></a>Gemeenschappelijke upgradestrategieën voor SharePoint

Er zijn meerdere methoden om een upgrade uit te voeren SharePoint serveromgeving. Als u een serverfarm Microsoft Office SharePoint Server 2007 hebt, zijn hier enkele voorbeelden van de upgrademethoden:
...
Uw kennis van wat uw farm doet en waarvoor u wordt gebruikt, is een tactische kracht als het gaat om upgraden. De manier waarop mensen de SharePoint farm gebruiken, helpt u bij het kiezen van uw opties.
  
> [!TIP]
> Microsoft Office SharePoint Server 2007 heeft ook een geleidelijke upgrade die hier niet wordt behandeld. Zie de roadmap voor het einde van de ondersteuning van Server 2007 voor een lijst met stapsgewijse upgrade-artikelen [SharePoint server 2007.](sharepoint-2007-end-of-support.md) 
  
Controleer de [productlevenscyclus-](https://support.microsoft.com/lifecycle/search) en systeemvereisten voor welke versie van SharePoint waar u een upgrade naar wilt uitvoeren. U weet dus wanneer de volgende upgrade nodig is (bijvoorbeeld als u pauzeert bij een oud product zoals SharePoint Server 2010 om meer upgrades te plannen, zorg ervoor dat u de einddatum van de ondersteuning kent) en dat u zeker weet dat u hardware hebt die uw abonnement ondersteunt. 
  
Als u van plan bent om bepaalde of alle SharePoint-sites over te brengen naar Microsoft 365 in de cloud, is dit een tijd om een bladwijzer te maken voor een koppeling naar de Microsoft 365- en [Office 365-servicebeschrijvingen.](/office365/servicedescriptions/office-365-service-descriptions-technet-library) U hebt servicebeschrijvingen nodig om meer te weten te komen SharePoint onlinefuncties en hoe deze kunnen verschillen van on-premises SharePoint Server. Upgrade functionele Microsoft Office SharePoint Server 2007-farms. Als uw installatie sites heeft die zijn verbroken, kunt u deze herstellen vóór de upgrade.
...
1. U kunt back-ups van uw serverdatabases Microsoft Office SharePoint Server 2007 gebruiken om ze afzonderlijk te upgraden, met behulp van database-bijlage.
    
2. Als u erachter komt dat slechts een klein aantal kritieke documentbibliotheken en andere informatie wordt gebruikt op uw Microsoft Office SharePoint Server 2007-farm, kunt u ervoor kiezen om gegevens handmatig te verplaatsen van Microsoft Office SharePoint Server 2007 naar SharePoint Server 2010, of alleen specifieke sites en webs naar de volgende versie te verplaatsen (wat uw taak gemakkelijker kan maken).
    
3. Hoe minder u doet met de serverfarm Microsoft Office SharePoint server van Server 2007, hoe veiliger de gegevens die farm bevat tijdens de upgrade.
    
Methoden zoals In-Place upgrade werken rechtstreeks op uw Microsoft Office SharePoint Server 2007-farm, waardoor u minder eenvoudige opties hebt om een pad te verlaten en opnieuw te beginnen met uw ongerepte omgeving. Bouw zoveel mogelijk enkele veiligheidsmaatregelen in (zoals het maken en testen van back-ups van de oorspronkelijke omgeving). Als uw Microsoft Office SharePoint Server 2007-farm bijvoorbeeld virtueel is en wordt gedupliceerd voor het maken van back-ups en herstellen, maakt u een back-up en herstelt u de meest recente databases vóór het servicevenster voor de upgrade. Als u weet dat u de optie hebt om databaseback-ups te herstellen, hebt u niet alleen een failsafe, maar kunt u ook gerust zijn.
...
Als u een upgrade wilt uitvoeren, hebt u een abonnement nodig en in deze gevallen past één formaat niet allemaal. Uw abonnement kan net zo eenvoudig zijn als 'Een abonnement Microsoft 365 maken met SharePoint Online, een domein registreren en personen omleiden om hun bestanden daar op te slaan'. En dat is het misschien niet. Die beslissing is aan u en het ligt aan wat u en uw gebruikers echt nodig hebben.
...
Als SharePoint aan deze behoeften hebt voldaan zonder dat u iets hoeft te doen buiten het gebruik van de ingebouwde software en u deze over het algemeen bijwerkt en normaal beheer en onderhoud voert, hebt u mogelijk 'Ingebouwde SharePoint' gekozen. Dit kan ook uw reden zijn om in een oudere versie van SharePoint te zitten. Met andere woorden, het doet al wat u nodig hebt en u hoeft tot nu toe niet te upgraden, bij Microsoft Office SharePoint Server 2007 einde van de ondersteuning.
...
|Migratie-API naar SPO in Microsoft 365 (voor persoonlijke sitegegevens)  <br/> |SharePoint Hybride (nog niet nodig)  <br/> |
|Sommige handmatige gegevensmigraties naar SharePoint Online voor kritieke gegevens  <br/> |FastTrack-wizard upgrade naar Microsoft 365  <br/> |
   
 **Mijn voorgestelde plan:**
  
Upgrade on-premises, met versies van SharePoint naast elkaar, sommige gevirtualiseerd, zodat we de databases eerst kunnen upgraden. Ga van SharePoint 2007 naar SharePoint 2010. Beheerders en ontwikkelaars testen de resulterende farm. Gebruikers testen de resulterende farm. Los eventuele problemen met het stoppen van de show in deze periode op. Nogmaals, naast elkaar een upgrade uitvoeren SharePoint 2010-databases naar SharePoint 2013. Test. Gebruikerstest/pilot. Los eventuele problemen met het stoppen van de show in deze periode op.
  
- Overweeg of een federatief hybride zoeken met SPO aan uw behoeften voldoet.
    
- Overweeg [FastTrack-hulp](https://fasttrack.microsoft.com) als u een upgrade wilt uitvoeren naar SharePoint Online vanaf hier. 
    
- Bepaal of siteverzamelingen kunnen worden geladen naar een Microsoft 365 abonnement. (Microsoft 365 voldoet aan veel [nalevingsstandaarden.](/compliance/regulatory/offering-home) Microsoft 365 [heeft eDiscovery](https://support.office.com/article/edea80d6-20a7-40fb-b8c4-5e8c8395f6da) en kan [dit](https://support.office.com/article/A18F8975-AA7F-43B4-A7D6-001D14744D8E) doen via het Compliancecentrum.) 
...
On-premises gebruiken we een virtuele omgeving om standaardinstellingen SharePoint Server 2010 en 2013 te maken. SharePoint Server 2016 wordt gebouwd op nieuwe hardware die voldoet aan de systeemvereisten voor 2016. We zullen database-attaches uitvoeren voor het upgraden van databases SharePoint 2007 via alle versies ertussen en SharePoint Server 2016. Kernaanpassingen worden op dit moment opnieuw gemaakt en getest in de SharePoint Server 2016-omgeving, als native functies nog niet aan onze behoeften voldoen. Als dit lukt, hebben we een on-premises farm met nieuwe hardware met bijgewerkte databases en minder aanpassingen. We voegen de bijgewerkte inhoudsdatabases toe aan nieuwe siteverzamelingen in SharePoint Server 2013, testen, gebruikerstest/pilot en doen vervolgens een DNS-cut-over aan de nieuwe SharePoint Server 2016-omgeving voor live gebruik.
  
- We overwegen federated Hybrid niet tussen SharePoint Server 2016 en SharePoint Online op dit moment.
    
- Naar schatting kan 35% van onze sites worden omgezet in nieuwe SPO-sites met vanity-domeinen, of uiteindelijk OneDrive voor Bedrijven opslagruimte. Op zoek naar andere mogelijkheden voor het converteren van sites of het doorverplaatsen van nieuwe sites naar SPO.
    
- Sommige van deze gedeelten van de migratie zijn handmatig, door te slepen en neer te slepen naar OneDrive voor Bedrijven persoonlijke sites, en sommige door migratie-API.
