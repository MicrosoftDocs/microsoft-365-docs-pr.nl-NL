...
### <a name="major-factors-that-affect-network-performance"></a>Belangrijke factoren die van invloed zijn op de netwerkprestaties
...
Zie voor meer informatie [Windows Prestaties en onderhoud](https://windows.microsoft.com/windows/performance-maintenance-help#performance-maintenance-help) en Tips pc-prestaties [in](https://support.microsoft.com/help/4002019/windows-10-improve-pc-performance)Windows 10.
...
### <a name="browsers-in-general"></a>Browsers in het algemeen
...
### <a name="browser-specific"></a>Browserspecifieke
...
- **FireFox:** Zie Firefox is traag of werkt niet meer voor [meer informatie.](https://support.mozilla.org/products/firefox/fix-problems/slowness-or-hanging)
- **Safari:** Zie Apple [- Safari voor](https://www.apple.com/safari/)meer informatie.
