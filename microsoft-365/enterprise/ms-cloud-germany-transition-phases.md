...
De meest recent gebruikte (MRU) service in Office is een cutover van de MCD naar Office 365 Global Services, niet een migratie. Alleen MRU-koppelingen van de kant globale services van Office 365 zijn zichtbaar na de migratie vanuit de Office.com portal. MRU-koppelingen van de MCD zijn niet zichtbaar als MRU-koppelingen in Globale office 365-services. In Globale Office 365-services zijn MRU-koppelingen alleen toegankelijk nadat de tenantmigratie fase 9 heeft bereikt.

## <a name="next-step"></a>Volgende stap

[Extra pre-work uitvoeren](ms-cloud-germany-transition-add-pre-work.md)
