...
ExpressRoute voor Office 365 biedt een alternatief routeringspad naar veel internetservices Office 365 services. De architectuur van ExpressRoute voor Office 365 is gebaseerd op het adverteren van openbare IP-voorvoegsels van Office 365-services die al via internet toegankelijk zijn in uw ingerichte ExpressRoute-circuits voor verdere herverdeling van deze IP-voorvoegsels in uw netwerk. Met ExpressRoute kunt u effectief verschillende routeringspaden inschakelen, via internet en via ExpressRoute, voor Office 365 services. Deze routeringstoestand op uw netwerk kan een belangrijke wijziging zijn in de manier waarop uw interne netwerktopologie is ontworpen.
  
 **Status:** Complete Guide v2
  
U moet uw ExpressRoute zorgvuldig plannen voor Office 365 implementatie, om rekening te houden met de netwerkcomplexiteiten van routering die beschikbaar is via zowel een speciaal circuit met routes die zijn ingespoten in uw kernnetwerk als via internet. Als u en uw team de gedetailleerde planning en tests niet uitvoeren in deze handleiding, bestaat er een hoog risico dat u met tussenpozen of een totaal verlies van connectiviteit met Office 365-services wordt verbonden wanneer het ExpressRoute-circuit is ingeschakeld.
...
4. Uw team heeft alle openbare richtlijnen en documentatie op gelezen en de Azure ExpressRoute voor Office 365 Training op Kanaal 9 bekeken om inzicht te krijgen in belangrijke technische [https://aka.ms/expressrouteoffice365](./azure-expressroute.md) [https://aka.ms/ert](https://aka.ms/ert) details, zoals: [](https://channel9.msdn.com/series/aer)
...
- Catalogiseer het binnenkomende en uitgaande netwerkverkeer voor de Office 365 services die uw organisatie gebruikt. Raadpleeg Office 365 url's en IP-adresbereikenpagina voor de beschrijving van stromen die verschillende Office 365 scenario's vereisen.
...
- Verzamel documentatie van bestaande netwerktopologie met details van uw interne WAN-backbone en -topologie, connectiviteit van satellietsites, last mile user connectivity, routing to network perimeter egress points, and proxy services.
  ...
  - Identificeer inkomende service-eindpunten in de netwerkdiagrammen waar Office 365 en andere Microsoft-services verbinding mee maken, met zowel internet- als voorgestelde ExpressRoute-verbindingspaden.
...
- Schat de verwachte en waargenomen netwerkprestaties en latentiekenmerken van belangrijke gebruikerslocaties tot Office 365. Houd er rekening mee dat Office 365 een globale en gedistribueerde set services is en dat gebruikers verbinding maken met locaties die mogelijk verschillen van de locatie van hun tenant. Daarom is het raadzaam om de latentie tussen de gebruiker en de dichtstbijzijnde rand van het wereldwijde Microsoft-netwerk te meten en te optimaliseren via ExpressRoute- en internetverbindingen. U kunt uw bevindingen uit de netwerkbeoordeling gebruiken om deze taak te helpen.

- Vermeld bedrijfsnetwerkbeveiliging en hoge beschikbaarheidsvereisten die moeten worden voldaan met de nieuwe ExpressRoute-verbinding. Hoe kunnen gebruikers bijvoorbeeld toegang blijven krijgen tot Office 365 in geval van een internetuitval of expressroute-circuitfout.

- Documenteren welke inkomende en uitgaande Office 365 netwerkstromen gebruikmaken van het internetpad en welke ExpressRoute gebruiken. Voor de specifieke geografische locaties van uw gebruikers en de details van uw on-premises netwerktopologie moet het plan mogelijk verschillen van de ene gebruikerslocatie naar de andere.
...
|**CDN Verwijzingen** <br/> |cdn.sharepointonline.com (en extra FQDN's) - IP-adressen die worden bijgehouden door CDN providers)  <br/> |
...
Zodra u de services en de bijbehorende netwerkverkeersstromen begrijpt, kunt u een netwerkdiagram maken waarin deze nieuwe connectiviteitsvereisten zijn opgenomen en worden de wijzigingen weergegeven die u zult aanbrengen om ExpressRoute te gebruiken voor Office 365. Het diagram moet het volgende bevatten:
  
1. Alle gebruikerslocaties waar Office 365 en andere services vandaan worden gebruikt.
...
Voor uitgaand verkeer hebben de personen toegang Office 365 op een van de drie manieren:
...
Op dezelfde manier is het binnenkomende netwerkverkeer Office 365 op een van de drie manieren:
...
De selectie van meet-me-locaties, de fysieke locatie waar uw ExpressRoute-circuit uw netwerk verbindt met het Microsoft-netwerk, wordt beïnvloed door de locaties waar mensen toegang tot Office 365 hebben. Als SaaS-aanbieding werkt Office 365 niet op dezelfde manier als Azure onder het regionale IaaS- of PaaS-model. In plaats daarvan is Office 365 een gedistribueerde set samenwerkingsservices, waar gebruikers mogelijk verbinding moeten maken met eindpunten in meerdere datacenters en regio's, die mogelijk niet altijd op dezelfde locatie of regio staan waar de tenant van de gebruiker wordt gehost.
  
Dit betekent dat de belangrijkste overweging die u moet maken bij het selecteren van meet-me-locaties voor ExpressRoute voor Office 365 de locatie is waar de mensen in uw organisatie verbinding mee maken. De algemene aanbeveling voor optimale Office 365-connectiviteit is het implementeren van routering, zodat gebruikersaanvragen naar Office 365-services via het kortste netwerkpad worden overgedragen aan het Microsoft-netwerk. Dit wordt ook wel 'hot potato' routing genoemd. Als de meeste Office 365 gebruikers zich bijvoorbeeld op een of twee locaties bevinden, wordt het optimale ontwerp gemaakt door meet-me-locaties te selecteren die zich het dichtst bij de locatie van die gebruikers bevinden. Als uw bedrijf grote gebruikerspopulaties heeft in veel verschillende regio's, kunt u overwegen meerdere ExpressRoute-circuits en meet-me-locaties te hebben. Voor sommige gebruikerslocaties is het kortste/meest optimale pad naar microsoft-netwerk en Office 365 mogelijk niet via uw interne WAN- en ExpressRoute-meet-me-punten, maar via internet.
...
## <a name="create-your-expressroute-for-office-365-implementation-plan"></a>Uw ExpressRoute maken voor Office 365 implementatieplan
...
Maak een plan voor bandbreedte die vereist is voor elke belangrijke Office 365 werkbelasting. Schat afzonderlijk Exchange Online, SharePoint online en Skype voor Bedrijven online bandbreedtevereisten. U kunt de schattingsberekeningen die we hebben opgegeven voor Exchange Online en Skype voor Bedrijven gebruiken als beginpunt; Een test met een representatief voorbeeld van de gebruikersprofielen en locaties is echter vereist om volledig inzicht te krijgen in de bandbreedtebehoeften van uw organisatie.
  
Voeg toe hoe de beveiliging op elke internet- en ExpressRoute-locatie wordt afgehandeld aan uw plan, onthoud alle ExpressRoute-verbindingen met Office 365 gebruik maken van openbare peering en moeten nog steeds worden beveiligd in overeenstemming met het beveiligingsbeleid van uw bedrijf om verbinding te maken met externe netwerken.
...
#### <a name="plan-bandwidth-requirements-including-skype-for-business-requirements-on-jitter-latency-congestion-and-headroom"></a>Bandbreedtevereisten plannen, Skype voor Bedrijven vereisten voor Jitter, Latentie, Congestie en Hoofdruimte
  
Skype voor Bedrijven Online bevat ook specifieke aanvullende netwerkvereisten die worden beschreven in het artikel [Mediakwaliteit en Netwerkconnectiviteitsprestaties in Skype voor Bedrijven Online.](https://support.office.com/article/Media-Quality-and-Network-Connectivity-Performance-in-Skype-for-Business-Online-5fe3e01b-34cf-44e0-b897-b0b2a83f0917)
...
Als uw netwerkontwerp niet aan deze vereisten voldoet, bestaat er een hoog risico dat uw gebruikers verbindingsproblemen met Office 365 en andere Microsoft-services ervaren vanwege routezwarte holing of asymmetrische routering. Dit gebeurt wanneer aanvragen voor Microsoft-services worden gerouteerd via ExpressRoute, maar antwoorden worden teruggeleid via internet, of omgekeerd, en de antwoorden worden gedropt door stateful netwerkapparaten, zoals firewalls.
...
Bij de meeste zakelijke Office 365-implementaties wordt uit een bepaalde vorm van binnenkomende connectiviteit van Office 365 naar on-premises services, zoals voor Exchange, SharePoint en Skype voor Bedrijven hybride scenario's, postvakmigraties en verificatie met behulp van ADFS-infrastructuur. Wanneer ExpressRoute u een extra routeringspad inschakelen tussen uw on-premises netwerk en Microsoft voor uitgaande verbindingen, kunnen deze binnenkomende verbindingen per ongeluk worden beïnvloed door asymmetrische routering, zelfs als u van plan bent dat deze stromen internet blijven gebruiken. Een paar voorzorgsmaatregelen die hieronder worden beschreven, worden aanbevolen om ervoor te zorgen dat er geen gevolgen zijn voor inkomende stromen op basis van internet van Office 365 naar on-premises systemen.
  
Als u de risico's van asymmetrische routering voor binnenkomende netwerkverkeersstromen wilt minimaliseren, moeten alle binnenkomende verbindingen bron NAT gebruiken voordat ze worden gerouteerd naar segmenten van uw netwerk die routeringszicht hebben naar ExpressRoute. Als de inkomende verbindingen zijn toegestaan op een netwerksegment met routeringszichtbaarheid naar ExpressRoute zonder bron-NAT, worden aanvragen die afkomstig zijn van Office 365 vanaf internet binnengekomen, maar het antwoord dat terug gaat naar Office 365 geeft de voorkeur aan het ExpressRoute-netwerkpad terug naar het Microsoft-netwerk, waardoor asymmetrische routering wordt veroorzaakt.
...
1. Office 365 kunnen alleen on-premises eindpunten targeten die openbare IPs gebruiken. Dit betekent dat zelfs als het on-premises inkomende eindpunt alleen wordt blootgesteld aan Office 365 via ExpressRoute, het nog steeds een openbaar IP-adres moet hebben dat aan het eindpunt is gekoppeld.

2. Alle DNS-naamresolutie die Office 365 om on-premises eindpunten op te lossen, gebeurt met openbare DNS. Dit betekent dat u de FQDN van inkomende service-eindpunten moet registreren bij IP-toewijzingen op internet.
...
1. De inkomende aanvraag van Office 365 haalt het IP-adres van het on-premises eindpunt op van openbare DNS en verzendt de aanvraag naar uw perimeternetwerk.
...
2. In deze foutconfiguratie is er geen bron-NAT geconfigureerd of beschikbaar in het perimeternetwerk waar het verkeer wordt verzonden, wat resulteert in het werkelijke bron-IP-adres dat wordt gebruikt als retourdoel.
  ...
  - Het resultaat is een asymmetrische pad voor die stroom naar Office 365, wat resulteert in een verbroken verbinding.
...
1. De inkomende aanvraag van Office 365 haalt het IP-adres op uit DNS en verzendt de aanvraag naar uw perimeternetwerk.
...
Op dit moment moet u op papier controleren of uw implementatieplan routesymmetrie biedt voor de verschillende scenario's waarin u de Office 365. U identificeert de specifieke netwerkroute die naar verwachting wordt genomen wanneer een persoon verschillende functies van de service gebruikt. Van de on-premises netwerk- en WAN-routering, naar de perimeterapparaten, naar het verbindingspad; ExpressRoute of internet en op de verbinding met het online-eindpunt.
...
Als u een proxyserver gebruikt voor internetverkeer, moet u pac- of clientconfiguratiebestanden aanpassen om ervoor te zorgen dat clientcomputers in uw netwerk correct zijn geconfigureerd om het ExpressRoute-verkeer te verzenden dat u wilt Office 365 zonder de proxyserver door te sturen, en wordt het resterende verkeer, inclusief sommige Office 365-verkeer, naar de desbetreffende proxy verzonden. Lees onze handleiding over [het beheren Office 365 eindpunten,](./managing-office-365-endpoints.md) bijvoorbeeld PAC-bestanden.
...
3. Bij voorkeur moet het testen van binnenkomende en uitgaande services worden uitgevoerd op een geïsoleerd testnetwerk met een test Office 365 tenant.
      ...
      - U kunt ook testen op een productienetwerk uitvoeren als de klant nog geen Office 365 of als de testfase is uitgevoerd.
...
3. Als u een Office 365 voor de eerste keer implementeert, gebruikt u de ExpressRoute-netwerkimplementatie als een pilot voor een klein aantal personen.
...
2. Valideer de 500+ Office 365 en CRM Online IP-adresadvertenties worden ontvangen door uw on-premises router.
...
9. Test functionaliteit op toepassingsniveau voor Exchange Online.

  - Test Outlook verbinding kan maken met Exchange Online e-mail verzenden/ontvangen.

  - Test Outlook is in staat om de onlinemodus te gebruiken.
...
11. Test de functionaliteit op toepassingsniveau voor Skype voor Bedrijven belscenario's:
...
- Een testplan voor het testen van Office 365 en netwerkservice.
...
QoS is nodig om spraak- en vergadervoordelen te verkrijgen voor Skype voor Bedrijven Online. U kunt QoS configureren nadat u ervoor hebt gezorgd dat de ExpressRoute-netwerkverbinding geen andere servicetoegang Office 365 blokkeren. Configuratie voor QoS wordt beschreven in het artikel [ExpressRoute en QoS in Skype voor Bedrijven Online.](https://support.office.com/article/ExpressRoute-and-QoS-in-Skype-for-Business-Online-20c654da-30ee-4e4f-a764-8b7d8844431d)
...
[Office 365-URL's en IP-adresbereiken](https://support.office.com/article/8548a211-3fe7-47cb-abb1-355ea5aa88a2)
