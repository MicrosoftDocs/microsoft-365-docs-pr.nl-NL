...
|6|Postvakmigratie. Wanneer de migratie van postvakken wordt gestart van on-premises [Exchange Hybrid](/exchange/exchange-deployment-assistant) naar Office 365, maken Office 365 verbinding met uw gepubliceerde Exchange Web Services (EWS)/Mailbox Replication Services (MRS)-server. Als u de NAT-IP-adressen nodig hebt die door Exchange Online-servers worden gebruikt om binnenkomende verbindingen uit specifieke bron-IP-bereik te beperken, worden deze weergegeven in [Office 365 URL & IP-bereik](urls-and-ip-address-ranges.md) onder het servicegebied 'Exchange Online'. <p> Zorg ervoor dat de toegang tot gepubliceerde EWS-eindpunten zoals OWA niet wordt beïnvloed door ervoor te zorgen dat de MRS-proxy wordt opgelost naar een afzonderlijk FQDN- en openbaar IP-adres voordat TCP 443-verbindingen worden beperkt vanuit specifieke bron-IP-bereiken.|Klant on-premises EWS/MRS Proxy <br> TCP-poort 443|Binnenkomende serververkeer|
...
|9|Gebruikt voor het [configureren Exchange hybride](/exchange/exchange-deployment-assistant), met de [wizard Exchange hybride configuratie](/exchange/hybrid-configuration-wizard) <p> Opmerking: Deze eindpunten zijn alleen vereist om de Exchange configureren|domains.live.com op TCP-poorten 80 & 443, alleen vereist voor Exchange 2010 SP3 Hybrid Configuration Wizard <p> GCC Hoog, DOD IP-adressen: 40.118.209.192/32; 168.62.190.41/32 <p> Worldwide Commercial & GCC: \* .store.core.windows.net; asl.configure.office.com; tds.configure.office.com; mshybridservice.trafficmanager.net ; <br> aka.ms/hybridwizard; <br> shcwreleaseprod.blob.core.windows.net/shcw/ \* ;|Alleen uitgaande serververkeer|
|10|De AutoDetect-service wordt gebruikt in [Exchange hybride](/exchange/exchange-deployment-assistant) scenario's met hybride moderne verificatie met Outlook [voor iOS en Android](/Exchange/clients/outlook-for-ios-and-android/use-hybrid-modern-auth) <p> `*.acompli.net` <br> `*.outlookmobile.com` <br> `*.outlookmobile.us` <br> `52.125.128.0/20` <br> `52.127.96.0/23`|On-premises klantserver Exchange TCP 443|Binnenkomende serververkeer|
...
|20|[Azure AD Verbinding maken](/azure/active-directory/hybrid/) met 21 ViaNet in China om on-premises gebruikersaccounts te synchroniseren met Azure AD.|\*.digicert.com:80 <BR> \*.entrust.net:80 <BR> \*.chinacloudapi.cn:443 <br> secure.aadcdn.partner.microsoftonline-p.cn:443 <br> \*.partner.microsoftonline.cn:443 <p> Zie Ook [Problemen met de Ingressie van Azure AD-connectiviteit oplossen.](https://docs.azure.cn/zh-cn/active-directory/hybrid/tshoot-connect-connectivity)|Alleen uitgaande serververkeer|
