...
Project Server 2010 krijgt het einde van de ondersteuning op **13 April 2021**. Deze datum is verlengd vanaf de vorige datum van de laatste dag van de ondersteuning, namelijk 13 oktober 2020. Als u momenteel Project Server 2010 gebruikt, zijn deze andere verwante producten de volgende einden van de ondersteunings datums:
...
|:-----|:-----|
|Bedrijfsregels verhinderen me voor de exploitatie van mijn bedrijf in de Cloud.  <br/>  Ik wil zelf bepalen welke updates er in mijn omgeving worden uitgevoerd.  <br/> | Ik heb mobiele of externe gebruikers.  <br/>  Kosten voor het migreren van on-premises servers is een grote bezorgdheid (hardware, software, uren en inspanning voor implementatie, enzovoort).  <br/>  Na de migratie zijn de kosten voor het onderhouden van de omgeving een grote rol (zoals automatische updates, gegarandeerde uptime, enzovoort).  <br/>  |
...
|[Servicebeschrijving van Project Online](https://go.microsoft.com/fwlink/p/?linkid=829088) <br/> |Informatie over de verschillende project online-abonnementen die voor u beschikbaar zijn.  <br/> |
