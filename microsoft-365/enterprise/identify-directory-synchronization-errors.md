...
---
# <a name="view-directory-synchronization-errors-in-microsoft-365"></a>Adreslijstsynchronisatiefouten weergeven in Microsoft 365
...
## <a name="view-directory-synchronization-errors-in-the-microsoft-365-admin-center"></a>Adreslijstsynchronisatiefouten weergeven in het Microsoft 365 beheercentrum
...
3. Kies op de kaart **Synchronisatiefouten** onder **Azure AD Verbinding maken** om de fouten op de pagina **Adreslijstsynchronisatiefouten weer te** geven.   
...
Zie na het weergeven [problemen met adreslijstsynchronisatie](fix-problems-with-directory-synchronization.md) oplossen om Microsoft 365 geïdentificeerde problemen te corrigeren.