...
Een virtuele netwerk (VNet) in azure-infrastructuurservices die is verbonden met andere netwerken, moet een gateway-subnet hebben. De aanbevolen procedures voor het definiëren van dit subnet zijn de volgende:
...
Voor de tweede aanbeveling kunt u de adresruimte van het gateway subnet bepalen door de gebruikte bits voor het gateway subnet in te stellen op 0 en de resterende variabele bits in de VNet-adresruimte te 1. Als u de adresruimte van de gateway niet snel wilt berekenen zonder te converteren naar een binair getal of een decimale waarde, kunt u een consoletoepassing gebruiken die is geschreven in C# of python of met een PowerShell-opdracht blok.

Dit artikel bevat C#-, python-en PowerShell-codeblokken die vijf gehele getallen verzamelen: de waarden van w. x. y. z/n voor het VNet-adresprefix en de breedte van het subnet met de gateway.
...
Vul de waarden in en voer de uitkomst van de opdracht uit in een PowerShell-venster of in het PowerShell-ISE.
