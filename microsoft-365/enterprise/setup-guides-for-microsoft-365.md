...
Elke handleiding biedt u stapsgewijze instructies, informatiebronnen, artikelen, en indien nodig kunt u scripts gebruiken om wijzigingen aan te brengen in de configuratie. Deze handleidingen geven u de keuzen die de specifieke behoeften van zowel kleine als grote organisaties weerspiegelen. Daarnaast biedt de geboden richtlijnen ondersteuning voor zowel nieuwe als meer ervaren beheerders.
...
De [AD FS-implementatie adviseur](https://aka.ms/adfsguidance) biedt u stapsgewijze instructies voor het implementeren van een on-PREMISES AD FS-infrastructuur die gebruikers verifieert voor microsoft 365 en Office 365-Services. Met deze handleiding kunnen uw organisatie AD FS-onderdelen en-vereisten controleren, de SSL-certificaten verkrijgen en installeren die nodig zijn voor de implementatie, en de vereiste webtoepassingsproxy-server installeren. 

## <a name="guides-for-collaboration"></a>Handleidingen voor samenwerking

### <a name="microsoft-365-apps-for-enterprise-deployment-advisor"></a>Microsoft 365-apps voor Enterprise Deployment adviseur
...
### <a name="mobile-apps-setup-assistant"></a>Configuratie-assistent voor mobiele apps

De [installatie-assistent voor mobiele apps](https://aka.ms/officeappguidance) bevat instructies voor het downloaden en installeren van Office-apps op mobiele apparaten met Windows, Ios en Android. Deze handleiding bevat stapsgewijze informatie over het downloaden en installeren van Microsoft 365 en Office 365-apps op uw telefoon en Tablet apparaten.
...
### <a name="sharepoint-deployment-advisor"></a>SharePoint-implementatie adviseur

[SharePoint Online-implementatie adviseur](https://aka.ms/spoguidance) helpt u bij het instellen van uw opslag-en inhoudsbeheer voor SharePoint-documenten, het maken van sites, het extern delen van gegevens en het configureren van geavanceerde instellingen, zodat u gebruikers opdrachten en communicatie binnen uw organisatie kunt uitvoeren. U volgt stappen voor het configureren van uw machtigingsbeleid voor het delen van inhoud, kies de hulpmiddelen voor migratie synchronisatie, en schakel de beveiligingsinstellingen voor uw SharePoint-omgeving in. 

### <a name="onedrive-quick-start-guide"></a>Handleiding aan de slag met OneDrive
