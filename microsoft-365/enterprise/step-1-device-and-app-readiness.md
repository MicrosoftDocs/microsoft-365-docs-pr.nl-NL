...
In het verleden was toepassings- en hardwarecompatibiliteit een belangrijke horde voor het upgraden van de desktops van gebruikers. Het goede nieuws bij het plannen van uw overstap naar Windows 10 en Office 365 ProPlus is dat zo ongeveer elke toepassing die in de afgelopen 10 jaar is geschreven, kan worden uitgevoerd op Windows 10. De eventuele COM-invoegtoepassingen en VBA-macro's van uw organisatie die werden gebruikt in versies van Office die teruggaan tot Office 2010 blijven werken met de nieuwste versies van Office, zonder aanpassingen.
