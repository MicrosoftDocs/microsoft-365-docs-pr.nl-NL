...
De meeste ondernemingen hebben een heterogene omgeving met meerdere versies van besturingssystemen, clientsoftware en serversoftware. Microsoft 365 voor Enterprise bevat de veiligste versies van de belangrijkste onderdelen van uw IT-infrastructuur met productiviteitsfuncties die zijn ontworpen om te profiteren van Cloud technologieën.
...
- Office-servers die op uw servers zijn geïnstalleerd, naar zijn equivalente Services in Microsoft 365
...
3. Microsoft 365-apps voor ondernemingen installeren, afzonderlijk of in combinatie met een IT-implementatie. Zie [Implementatiehandleiding voor Microsoft 365-apps](https://docs.microsoft.com/deployoffice/deployment-guide-microsoft-365-apps)voor meer informatie.
...
- Postvakken van gebruikers van Exchange Server naar Exchange Online: Zie [postvakken verplaatsen tussen on-premises en Exchange Online-organisaties](https://docs.microsoft.com/exchange/hybrid-deployment/move-mailboxes).
- SharePoint-gegevens van SharePoint Server naar SharePoint Online: Zie [uw inhoud migreren naar Microsoft 365](https://docs.microsoft.com/sharepointmigration/migrate-to-sharepoint-online).
- Skype voor bedrijven online voor Microsoft teams: Zie [richtlijnen voor migratie en interoperabiliteit](https://docs.microsoft.com/microsoftteams/migration-interop-guidance-for-teams-with-skype).
...
- [Roadmap voor einde van ondersteuning voor Exchange 2007](exchange-2007-end-of-support.md)
- [Roadmap voor het einde van de levensduur van SharePoint Server 2007](sharepoint-2007-end-of-support.md)
- [Roadmap voor einde van ondersteuning voor Project Server 2007](project-server-2007-end-of-support.md)
...
- [Roadmap voor einde van ondersteuning voor PerformancePoint Server 2007](pps-2007-end-of-support.md)
...
1. De gegevens op uw Office 2007-servers migreren naar Microsoft 365. U kunt een Microsoft-partner inhuren om u hierbij te helpen.
...
1. De gegevens op uw Office 2013-servers migreren naar Microsoft 365. Zie voor meer informatie [FastTrack voor Microsoft 365](https://fasttrack.microsoft.com/microsoft365) of schakel de hulp van een Microsoft-partner in.
2. De nieuwe functionaliteit en werkprocessen implementeren voor uw gebruikers.
...
1. De gegevens op uw Office 2016-servers migreren naar Microsoft 365. Zie voor meer informatie [FastTrack voor Microsoft 365](https://fasttrack.microsoft.com/microsoft365) of schakel de hulp van een Microsoft-partner in.
2. De nieuwe functionaliteit en werkprocessen implementeren voor uw gebruikers.
...
Deze poster van één pagina is een snelle manier om de diverse paden te begrijpen die u kunt nemen om te voorkomen dat Office 2010-client en-Server producten en Windows 7 niet meer worden ondersteund, met de voorkeurs paden en de resultaten van de resultaten in Microsoft 365 voor Enterprise gemarkeerd.

U kunt [deze poster downloaden](https://github.com/MicrosoftDocs/microsoft-365-docs/raw/public/microsoft-365/downloads/Office2010Windows7EndOfSupport.pdf) en afdrukken in de indeling Letter, Legal of Tabloid (11 x 17).
