...
U kunt PowerShell gebruiken om adreslijstsynchronisatie uit te schakelen en uw gesynchroniseerde gebruikers te converteren naar alleen-cloud. Het wordt echter afgeraden om adreslijstsynchronisatie uit te schakelen als een stap voor het oplossen van problemen. Zie Problemen met adreslijstsynchronisatie oplossen voor Microsoft 365 als u hulp nodig hebt bij het oplossen [van adreslijstsynchronisatie.](fix-problems-with-directory-synchronization.md) 
