...
- [**Gebruikersaccounts, licenties en groepen**](manage-user-accounts-and-licenses-with-microsoft-365-powershell.md)
    ...
    Begin hier als u meer wilt weten over het gebruik van automatiseringsopdrachten voor het beheren van gebruikersaccounts, licenties en groepen.
...
- [**Beveiligings- en compliancecentrum**](/powershell/exchange/scc-powershell)

    Begin hier als u beveiligingsfuncties & compliancecentrum wilt beheren.
