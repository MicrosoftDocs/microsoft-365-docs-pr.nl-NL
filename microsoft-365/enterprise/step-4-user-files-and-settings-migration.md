...
<p>Bij het vernieuwen of vervangen van pc's kunt u tijd besparen door een back-up te maken van de gebruikersstatus en deze terug te zetten. Met de nieuwe opties voor Cloud-bestandssynchronisatie kunt u per gebruiker de mappen van de desktop, documenten en afbeeldingen in OneDrive synchroniseren voor naadloze toegang tot bestanden vanuit nieuwe Windows-installaties.</p></td>
...
>[!NOTE]
>Hoewel u de migratieprocessen die u in het verleden hebt gebruikt, kunt blijven gebruiken, raden we u bij uw overstap naar Office 365 ProPlus aan OneDrive ‘Known Folder Move’ te gebruiken (zie hieronder). Ga naar het [Desktop Deployment Center](https://aka.ms/HowToShift) om het volledige desktop-implementatieproces te bekijken.
>

Een van de lastigste taken van een grootschalige implementatie is de overdracht van de bestanden en instellingen van uw gebruikers. In dit artikel vindt u de beschikbare opties voor het migreren van gebruikers naar nieuwe, vernieuwde en herstelde pc's.
...
## <a name="onedrive-known-folder-move"></a>Known Folder Move in OneDrive
