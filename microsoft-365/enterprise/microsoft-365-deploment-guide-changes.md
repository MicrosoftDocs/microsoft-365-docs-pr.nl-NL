...
- [Team voor een zeer geheim project van Contoso Corporation](contoso-team-for-top-secret-project.md)
  ...
  [![Team voor een zeer geheim project van Contoso Corporation](../media/contoso-team-for-highly-confidential-assets/final-config-example-file.png)](contoso-team-for-top-secret-project.md)
...
- [SharePoint-sites voor poster voor sterk gereglementeerde gegevens](teams-sharepoint-online-sites-highly-regulated-data.md#poster)
  ...
  [![SharePoint-sites voor poster voor sterk gereglementeerde gegevens](../media/teams-sharepoint-online-sites-highly-regulated-data/sharepoint-sites-highly-regulated-data-poster.png)](../media/teams-sharepoint-online-sites-highly-regulated-data/SharePointSitesHighlyRegulatedData.pdf)

  U kunt deze poster ook downloaden in [PDF-](https://github.com/MicrosoftDocs/microsoft-365-docs/raw/public/microsoft-365/enterprise/media/teams-sharepoint-online-sites-highly-regulated-data/SharePointSitesHighlyRegulatedData.pdf) of [PowerPoint-](https://github.com/MicrosoftDocs/microsoft-365-docs/raw/public/microsoft-365/enterprise/media/teams-sharepoint-online-sites-highly-regulated-data/SharePoint-Sites-Highly-Regulated-Data.pptx) indeling en deze afdrukken op papier met een formaat Letter, Legal of Tabloid (27,9 x 43,2 cm).

- [De poster Windows 10 met AutoPilot implementeren](windows10-deploy-autopilot.md) 

  [![Poster Windows 10 met AutoPilot implementeren](../media/windows10-deploy-autopilot/windows10-autopilot-flowchart.png)](https://docs.microsoft.com/windows/deployment/media/Windows10AutopilotFlowchart.pdf)
...
- [De poster Windows 10-implementatie met Configuration Manager](windows10-deploy-inplaceupgrade.md)
  ...
  [![De poster Windows 10-implementatie met Configuration Manager](../media/windows10-deploy-inplaceupgrade/windows10-deployment-config-manager.png)](https://docs.microsoft.com/windows/deployment/media/Windows10DeploymentConfigManager.pdf)
...
- [Teams voor scenario met sterk gereglementeerde gegevens](secure-teams-highly-regulated-data-scenario.md)
  ...
  [![Het scenario Teams voor sterk gereglementeerde gegevens](../media/secure-teams-highly-regulated-data-scenario/secure-team-final.png)](secure-teams-highly-regulated-data-scenario.md)
...
- [Poster Externe werknemers mogelijkheden bieden](empower-people-to-work-remotely.md#poster)
  ...
  U kunt deze poster ook downloaden in [PDF-](https://github.com/MicrosoftDocs/microsoft-365-docs/raw/public/microsoft-365/enterprise/media/empower-people-to-work-remotely/empower-remote-workers-scenario.pdf) of [PowerPoint-](https://github.com/MicrosoftDocs/microsoft-365-docs/raw/public/microsoft-365/enterprise/media/empower-people-to-work-remotely/Empower-Remote-Workers-Poster.pptx) indeling en deze afdrukken op papier met een formaat Letter, Legal of Tabloid (27,9 x 43,2 cm).
...
- Vernieuwing van het [scenario SharePoint-sites voor sterk gereglementeerde gegevens](teams-sharepoint-online-sites-highly-regulated-data.md)
  ...
  [![Het scenario SharePoint-sites voor sterk gereglementeerde gegevens](../media/teams-sharepoint-online-sites-highly-regulated-data/end-to-end-configuration.png)](teams-sharepoint-online-sites-highly-regulated-data.md)
...
- [Scenario Externe werknemers](empower-people-to-work-remotely.md)
  ...
  [![Configuratie van externe werknemers voor een organisatie met hybride identiteit](../media/empower-people-to-work-remotely/remote-workers-hybrid.png)](empower-people-to-work-remotely.md) 
...
- [De poster Foundation-infrastructuur](deploy-foundation-infrastructure.md#at-a-glance)
  ...
  [![Afbeelding voor de poster Foundation-infrastructuur voor Microsoft 365 voor bedrijven](../media/deploy-foundation-infrastructure/Microsoft365EnterpriseFoundInfra.png)](../media/deploy-foundation-infrastructure/Microsoft365EnterpriseFoundInfra.pdf)
...
- [Artikel Microsoft 365 voor bedrijven voor andere organisaties dan bedrijven](deploy-foundation-infrastructure-non-enterprises.md)
  ...
  [![Overzicht van de infrastructuur wanneer uw organisatie een cloudidentiteit gebruikt](../media/deploy-foundation-infrastructure-non-enterprises/final-cloud-only-config.png)](deploy-foundation-infrastructure-non-enterprises.md)
