...
- Als u ook Gebruik maakt van Azure-services die niet zijn opgenomen in uw Office 365-abonnement, gaat u als [volgende stap te werk.](#microsoft-azure)
...
| Stap(en) | Beschrijving | Gevolg |
|:-------|:-------|:-------|
| Werk op elk gewenst moment bij naar de nieuwste versie van de wizard Hybride configuratie (HCW) voordat uw tenant de migratiefase 5 gaat invoeren. U kunt deze activiteit direct starten nadat u de melding van het berichtencentrum hebt ontvangen dat de migratie van uw Office 365-tenant is gestart.<br><br> Klanten met hybride Exchange Online voor Microsoft Cloud Deutschland moeten eerdere versies van HCW verwijderen en vervolgens de meest recente versie (17.0.5378.0 of hoger) installeren en uitvoeren van [https://aka.ms/hybridwizard](https://aka.ms/hybridwizard) . |<ul><li>De nieuwste versie van de HCW bevat benodigde updates ter ondersteuning van klanten die overstappen van Microsoft Cloud Deutschland naar Office 365 Services.</li><li> Updates zijn onder andere wijzigingen in de instellingen van het on-premises certificaat voor de connector Verzenden en de ontvangstconnector.</li><li> Exchange-beheerders moeten de HCW op elk gewenst moment opnieuw installeren voordat fase 5 van 9 (Exchange-migratie) van start gaat.<br>Bij het uitvoeren van de HCW vóór fase 5, selecteert u 'Office 365 Germany' op de tweede pagina van de HCW onder _Office 365 Exchange Online_ in de keuzelijst onder Mijn Office _365-organisatie wordt_ gehost door</li><li>**OPMERKING:** als de migratie van de Office 365-tenant is voltooid, verwijdert u de HCW en installeert u deze keer opnieuw met behulp van de instellingen voor Office 365 Worldwide op de tweede pagina van de HCW om de hybride installatie te voltooien met de globale Exchange Online-service.</li></ul>|Het niet uitvoeren van de HCW vóór fase 5 (Exchange-migratie) kan leiden tot een service- of clientfout. |
||||
...
| Stap(en) | Beschrijving | Gevolg |
|:-------|:-------|:-------|
| Bepaal of herconfiguratie is vereist na de migratie. | Externe services en toepassingen die kunnen worden geïntegreerd met Office 365, zijn mogelijk gecodeerd om IP-adressen en URL's van Microsoft Cloud Deutschland te verwachten. | Vereiste actie. Inactiviteit kan leiden tot fouten in de service of clientsoftware. |
||||
