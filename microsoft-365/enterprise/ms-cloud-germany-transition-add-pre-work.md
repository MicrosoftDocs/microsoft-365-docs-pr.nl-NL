...
- Als u ook Gebruik maakt van Azure-services die niet zijn opgenomen in uw Office 365-abonnement, gaat u als [volgende stap te werk.](#azure)
...
| Stap(en) | Beschrijving | Van toepassing op | Gevolg |
|:-------|:-----|:-------|:-------|
| Werk vóór de migratie bij naar de nieuwste versie van de wizard Hybride configuratie (HCW). <br><br> Klanten met hybride Exchange Online voor Microsoft Cloud Deutschland moeten eerdere versies van HCW verwijderen en vervolgens de meest recente versie (17.0.5378.0 of hoger) installeren en uitvoeren van [https://aka.ms/hybridwizard](https://aka.ms/hybridwizard) . | De nieuwste versie van de HCW bevat benodigde updates ter ondersteuning van klanten die overstappen van Microsoft Cloud Deutschland naar Office 365 Services. <br><br> Updates zijn onder andere wijzigingen in de instellingen van het on-premises certificaat voor de connector Verzenden en de ontvangstconnector. <br><br> Klanten moeten de instellingen van Office 365 Duitsland opnieuw installeren voordat fase 5 van 9 (Exchange-migratie) begint. <br><br> OPMERKING: Als de migratie naar Office 365-services is voltooid, verwijdert u de HCW en installeert u deze opnieuw. Ditmaal gebruikt u de instellingen van Office 365 Worldwide om uw hybride installatie te voltooien met de globale service. | Exchange Online-klanten die een hybride implementatie uitvoeren | Vereiste actie. Als u dit niet doet vóór fase 5 van 9 (Exchange-migratie), kan dit leiden tot een service- of clientfout. |
|||||
