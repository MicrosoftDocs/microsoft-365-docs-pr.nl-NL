...
[Configuraties voor identiteits-en Apparaattoegang](../security/office-365-security/microsoft-365-policies-configurations.md) zijn een set configuraties en regels voor voorwaardelijke toegang om toegang te beschermen tot alle services die zijn geïntegreerd in azure Active Directory (Azure AD).
...
Het resultaat is een testomgeving die voldoet aan de vereisten van de [vereiste configuratie alleen in de cloud](../security/office-365-security/identity-access-prerequisites.md#prerequisites) voor identiteits- en apparaattoegang. 
