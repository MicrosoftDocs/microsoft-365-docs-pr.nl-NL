...
|Onboarding of offboarding-postvakken verplaatsen stoppen of verwijderen, namelijk geen postvakken verplaatsen tussen Exchange on-premises en Exchange Online  | Op deze manier mislukt de aanvraag voor het verplaatsen van postvakken niet met een fout. | Als u dit niet doet, kan dit leiden tot een fout in de service of van software-clients. |
||||
...
| Items delen via Outlook | Items delen in SharePoint Online en OneDrive voor Bedrijven via Outlook werkt niet meer na tenant cutover. |<ul><li>In SharePoint Online en OneDrive voor Bedrijven kunt u items delen via Outlook. Nadat u op de Outlook-knop hebt gedrukt, wordt er een deelbare koppeling gemaakt en wordt er een nieuw bericht in de Outlook Web App weergegeven.</li><li>Na de cutover van de tenant werkt deze methode voor delen niet. We herkennen dat dit een bekend probleem is. Aangezien deze Outlook-functie echter op het afroepingspad staat, is het oplossen van het probleem niet gepland totdat het aftrekken is uitgerold. </li></ul>|
||||
