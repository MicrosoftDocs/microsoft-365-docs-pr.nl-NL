...
Voor het cloud-only-identiteitsmodel kunt u Microsoft 365-licenties toewijzen aan gebruikersaccounts terwijl deze worden gemaakt, afhankelijk van hoe u ze maakt.

Voor het hybride identiteitsmodel worden gebruikersaccounts van Active Directory Domain Services (AD DS) niet automatisch een locatie of een Microsoft 365-licentie toegewezen. **U moet elk gebruikersaccount configureren met een gebruikerslocatie vóór of samen met het toewijzen van een licentie.**
...
- [Beveiliging implementeren](../security/office-365-security/security-roadmap.md)
