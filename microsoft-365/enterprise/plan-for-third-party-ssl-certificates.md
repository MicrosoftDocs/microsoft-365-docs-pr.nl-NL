...
---
# <a name="plan-for-third-party-ssl-certificates-for-microsoft-365"></a>SSL-certificaten van derden plannen voor Microsoft 365
...
Zie het TechNet-artikel Certificaatvereisten begrijpen voor een overzicht van het gebruik van digitale certificaten om de communicatie tussen de on-premises Exchange-organisatie en Exchange Online veilig [te maken.](/previous-versions/exchange-server/exchange-141/gg476123(v=exchg.141))
...
Voor uw externe Exchange 2013-, Exchange 2010-, Exchange 2007- en Exchange 2003-clienttoegangsservers (CAS's) is een SSL-certificaat van derden vereist voor veilige verbindingen voor Autodiscover-, Outlook Anywhere- en Active Directory-synchronisatieservices. Mogelijk hebt u dit certificaat al geïnstalleerd in uw on-premises omgeving.
  
## <a name="certificate-for-an-exchange-hybrid-server"></a>Certificaat voor een hybride Exchange-server

Voor uw externe hybride Exchange-server of -servers is een SSL-certificaat van derden vereist voor veilige connectiviteit met de Exchange Online-service. U moet dit certificaat verkrijgen van uw externe SSL-provider.
  
## <a name="microsoft-365-certificate-chains"></a>Microsoft 365 Certificate Chains
