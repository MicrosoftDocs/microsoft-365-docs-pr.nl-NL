...
2. Zie rechtsboven op de pagina de hoeveelheid opslagruimte die op alle sites wordt gebruikt en de totale opslagruimte voor uw abonnement. (Als uw organisatie Multi-Geo heeft geconfigureerd in Office 365, wordt op de balk ook de hoeveelheid opslagruimte weergegeven die op alle geolocaties wordt gebruikt.) 
...
3. Selecteer **Extra bestandsopslag van Office 365**.

4. Kies op de pagina Extra bestandsopslag van **Office 365,** als deze wordt weergegeven, het basisabonnement en voer vervolgens het aantal gigabytes opslagruimte in dat u wilt toevoegen.

5. Selecteer **Uitchecken nu**.

6. Controleer op de pagina **Hoe ziet deze er?** **Next**

7. Controleer op de pagina **Bestelling voltooien** het totaal. Als u wijzigingen wilt aanbrengen, selecteert u **Volgorde bewerken**. Als de bestelling een kredietcontrole vereist, schakelt u het selectievakje in. Wanneer u klaar bent, selecteert u **Plaatsorder** \> **Ga naar Beheerstartpagina**.
...
4. Klik op de pagina **Services kopen** met de muis over of tik op **Extra bestandsopslag van Office 365**en selecteer **Nu kopen**.
  
5. Voer het aantal gebruikerslicenties in dat u nodig hebt en kies, indien aangegeven, een basisabonnement. Selecteer **Uitchecken nu**.
  
6. Controleer op de pagina **Hoe ziet deze er?** **Next**

7. Selecteer op de pagina **Bestelling voltooien** de optie **Volgorde plaatsen**.
...
3. Selecteer **Invoegtoepassingen**en kies **Hoeveelheid wijzigen**.

4. Voer in het deelvenster **Gigabytes toevoegen/verwijderen** de gewenste gigabytes voor het abonnement in en selecteer **Wijzigen verzenden**.
...
3. Selecteer onder **Office 365 Extra bestandsopslag**de optie **Hoeveelheid wijzigen**.
