...
| 'Deze productcode is al gebruikt. Voer een andere productcode in.' | Controleer of de sleutel nog niet is gebruikt door u of een lid van uw organisatie. Als de sleutel nog niet is gebruikt, neem dan contact op met uw partner of de wederverkoper waar u de productcode hebt gekocht. |
| "Sorry, we kunnen uw verzoek nu niet verwerken. Probeer het over enkele minuten opnieuw.' | Als latere pogingen meer dan 15 minuten in hetzelfde foutbericht leiden, neem dan [contact op met de ondersteuning](../admin/contact-support-for-business-products.md). |
| "Het aangevraagde abonnement is niet beschikbaar. Dit kan een van de volgende oorzaken hebben: De aanbieding is niet beschikbaar - De service is niet beschikbaar in uw land - Hetzelfde proefabonnement kan niet tweemaal worden gebruikt/geselecteerd. Als het probleem zich blijft voordoen, neemt u contact op met de ondersteuning van Microsoft." | Neem [contact op met de ondersteuning.](../admin/contact-support-for-business-products.md) Als u met een partner werkt, neem dan contact op met de partner voor ondersteuning. |
| "Je hebt meer gebruikerslicenties toegevoegd dan deze aanbieding toestaat. Het maximum is \<x\> gebruikerslicenties. Verwijder deze productcode en voer een code in waarvoor minder gebruikerslicenties worden toegevoegd.' | Neem contact op met uw wederverkoper of partner. U hebt meer licenties gekocht dan kunnen worden gebruikt met dit Office 365-abonnement. |
| 'U moet een globale of factureringsbeheerder zijn om een productcode in te wisselen.' | Zorg ervoor dat uw machtigingen zijn ingesteld als facturering of globale beheerder. Meld u aan bij [Office 365](https://support.office.com/article/e9eb7d51-5430-4929-91ab-6157c5a050b4) met uw werk- of schoolaccount en ga naar het beheercentrum. <br/><br/>In het beheercentrum selecteert u **Gebruikers** \> **Actieve gebruikers**. In **Filters** kiest u **Globale beheerders** of **Factureringsbeheerder**.  <br/><br/>Controleer of u wordt vermeld in de resultaten. |
