...
> [!IMPORTANT]
> Dit artikel is alleen van toepassing Microsoft Teams vrije organisaties in India.

## <a name="before-you-begin"></a>Voordat u begint

U moet een gratis beheerder Microsoft Teams om een gratis organisatie Microsoft Teams upgraden. U bent automatisch een beheerder als u de gratis Microsoft Teams hebt gemaakt.

## <a name="step-1-get-your-work-or-school-account-id"></a>Stap 1: Uw werk- of schoolaccount-id krijgen

Als u het proces wilt starten, krijgt u uw onderliggende werk- of schoolaccount-id. Deze account-id verschilt van het e-mailadres dat u gebruikt voor toegang tot Microsoft Teams Gratis.
...
Nadat u het onderliggende werk- of schoolaccount voor uw Microsoft Teams Gratis organisatie hebt, moet u het wachtwoord voor het account opnieuw instellen.
...
Gebruik het onderliggende werk- of schoolaccount dat u hebt hersteld en uw nieuwe beheerderswachtwoord om een nieuw abonnement Microsoft 365 voor bedrijven te kopen.

1. Ga in Microsoft 365 beheercentrum naar   >  <a href="https://go.microsoft.com/fwlink/p/?linkid=868433" target="_blank">Factureringsaankoopservices.</a>
2. Zoek de Microsoft 365 voor bedrijven die u wilt kopen.
    > [!IMPORTANT]
    > Zorg ervoor dat u er een kiest met Microsoft Teams.
3. Voltooi de aankoop. Vergeet niet om voldoende licenties te kopen voor alle gebruikers in uw Microsoft Teams Gratis organisatie die u wilt verplaatsen naar Microsoft 365 voor bedrijven.

## <a name="step-4-assign-new-licenses-to-users"></a>Stap 4: Nieuwe licenties toewijzen aan gebruikers

Nu u een nieuw abonnement Microsoft 365 voor bedrijven, kunt u licenties toewijzen aan de bestaande gebruikers in uw Microsoft Teams Gratis organisatie.
...
2. Selecteer de gebruikers aan wie u een Microsoft 365 voor zakelijke licenties wilt toewijzen en selecteer **vervolgens Productlicenties beheren.**
