...
> [!NOTE]
> Als u zich in de geïntegreerde Microsoft 365-beveiligingsportal (security.microsoft.com) kunt u hier een Defender voor Office 365-evaluatie starten: E-mail & Samenwerking > Beleid & Regels > Bedreigingsbeleid > Extra beleid.
...
Met verbeterde filtering voor connectors wordt de filternauwkeurigheid verbeterd, maar kan de bezorging van bepaalde berichten worden gewijzigd als u een ESG hebt voor Defender voor Office 365 en op dit moment EOP-filtering niet overbrugt. Het effect is beperkt tot EOP-beleid. MDO-beleidsregels die zijn ingesteld als onderdeel van de evaluatie, worden gemaakt in de modus niet-afdwingen. Als u de potentiële productie-impact wilt minimaliseren, kunt u alle EOP-filtering omzeilen door een transportregel te maken om het betrouwbaarheidsniveau voor spam (SCL) in te stellen op -1. Zie [De EAC gebruiken om een e-mailstroomregel te maken die](/exchange/security-and-compliance/mail-flow-rules/use-rules-to-set-scl#use-the-eac-to-create-a-mail-flow-rule-that-sets-the-scl-of-a-message)de SCL van een bericht in stelt voor meer   informatie.
...
Zodra u de juiste rol hebt, is het aanbevolen pad om een proeflicentie voor Microsoft Defender voor Office 365 (Abonnement 2) te verkrijgen in het Microsoft 365-beheercentrum door naar Facturering > Services kopen te gaan. De proefversie bevat een gratis proefversie van 30 dagen voor 25 licenties. [Een proefabonnement voor Microsoft Defender voor Office 365 (Plan 2)](https://admin.microsoft.com/AdminPortal/Home#/catalog/offer-details/microsoft-defender-for-office-365-plan-2-/223860DC-15D6-42D9-A861-AE05473069FA).
...
Zoek de Microsoft Defender voor Office 365 evaluatie-set-upkaart in het Office 365 Security & Compliance center https://protection.office.com/homepage) (vanaf drie toegangspunten:
