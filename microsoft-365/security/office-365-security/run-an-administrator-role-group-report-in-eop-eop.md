...
1. Ga in het Beheerbeheer naar  \> **Auditing** en **kies Een rapport met beheerdersrolgroep uitvoeren.**
...
Als er wijzigingen worden aangetroffen aan de hand van de criteria die u hebt opgegeven, worden deze weergegeven in het deelvenster met resultaten. Klik op een rollengroep in de zoekresultaten om de wijzigingen in het detailvenster te bekijken.
...
In dit voorbeeld heeft het beheerdersaccount de volgende wijzigingen aangebracht:
...
In dit voorbeeld wordt gezocht naar alle vermeldingen in het auditlogboek met de volgende criteria:
