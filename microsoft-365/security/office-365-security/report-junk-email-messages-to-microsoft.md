...
|[De invoegtoepassing Rapportbericht inschakelen in Microsoft 365](enable-the-report-message-add-in.md)|Werkt met Outlook, Outlook voor Mac en de webversie van Outlook (voorheen outlook web app) en is de aanbevolen invoegtoepassing. <br/><br/> Afhankelijk van uw abonnement zijn berichten die gebruikers met de invoegtoepassing hebben gerapporteerd, beschikbaar in [de resultaten van Automated Investigation and Response (AIR),](air-view-investigation-results.md)het rapport met door de gebruiker [gerapporteerde berichten](view-email-security-reports.md#user-reported-messages-report)en Threat [Explorer](threat-explorer-views.md#email--submissions).|
|[De invoegtoepassing Voor het melden van ongewenste e-mail voor Microsoft Outlook installeren en gebruiken in Microsoft 365](junk-email-reporting-add-in-for-microsoft-outlook.md)|Werkt alleen in Outlook.|
|[Ongewenste en phishing-e-mail melden in de webversie van Outlook in Microsoft 365](report-junk-email-and-phishing-scams-in-outlook-on-the-web-eop.md)|Gebruik de ingebouwde mogelijkheden in de webversie van Outlook voor organisaties met Exchange Online-postvakken (niet beschikbaar in zelfstandige EOP).|
