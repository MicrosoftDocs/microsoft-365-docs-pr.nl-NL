...
Wanneer beveiligingswaarschuwingen worden geactiveerd, is het aan uw beveiligingsteam om deze waarschuwingen te bekijken en stappen te ondernemen om uw organisatie te beschermen. Soms kunnen beveiligingsbewerkingsteams worden overstelpt door het aantal waarschuwingen dat wordt geactiveerd. Geautomatiseerde mogelijkheden voor onderzoek en antwoord (AIR) in Microsoft Defender voor Office 365 kunnen helpen.
...
- [Voorbeeld 3: Een beveiligingsteam integreert AIR met de SIEM met de Office 365 Management Activity API](#example-a-security-operations-team-integrates-air-with-their-siem-using-the-office-365-management-activity-api)
...
- Er wordt een controle uitgevoerd Exchange Online Protection ([EOP](exchange-online-protection-overview.md)) en ([Microsoft Defender voor](defender-for-office-365.md)Office 365 ) om te zien of er andere soortgelijke berichten zijn gerapporteerd door gebruikers.
...
AIR-mogelijkheden in Microsoft Defender voor Office 365 bevatten rapporten [& details](air-view-investigation-results.md) die beveiligingsbewerkingsteams kunnen gebruiken om bedreigingen te bewaken en aan te pakken. Maar u kunt air-mogelijkheden ook integreren met andere oplossingen. Voorbeelden hiervan zijn een SIEM-systeem (Security Information and Event Management), een case management system of een aangepaste rapportageoplossing. Dit soort integraties kan worden uitgevoerd met de Office 365 [Management Activity API](/office/office-365-management-api/office-365-management-activity-api-reference).
