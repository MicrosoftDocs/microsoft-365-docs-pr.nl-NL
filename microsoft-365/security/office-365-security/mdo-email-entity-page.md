...
3. U kunt uitgebreidere analyses uitvoeren door de rest van de pagina te sorteren. Controleer de details van e-maildetectie, de status van de e-mailverificatie en de koptekst. Dit gebied moet per geval worden bekeken, maar de informatie in deze tabbladen is beschikbaar voor elk e-mailbericht.
...
1. **Tijdlijn:** De tijdlijnweergave voor een e-mailbericht (volgens de tijdlijn van Bedreigingsverkenner) toont de oorspronkelijke bezorging bij gebeurtenissen na bezorging die plaatsvinden in een e-mailbericht. Voor e-mailberichten zonder acties na bezorging wordt in de weergave de oorspronkelijke bezorgingsrij weergegeven in de tijdlijnweergave. Gebeurtenissen zoals: Zero-hour Auto Purge (ZAP), Herstellen, URL-klikken, et balk, van bronnen zoals: systeem, beheerder en gebruiker, worden hier weergegeven, in de volgorde waarin ze hebben plaatsgevonden.
2. **Analyse:** Analyse toont velden die beheerders helpen een e-mailbericht uitgebreid te analyseren. Voor gevallen waarin beheerders meer informatie moeten hebben over detectie, afzender/geadresseerde en gegevens over e-mailverificatie, moeten ze het tabblad Analyse gebruiken. Koppelingen voor bijlagen en URL's vindt u ook op deze pagina, onder Gerelateerde entiteiten. Zowel bijlagen als geïdentificeerde bedreigingen worden hier genummerd, en als u klikt, gaat u rechtstreeks naar de pagina's Bijlagen en URL. Dit tabblad heeft ook de optie Koptekst weergeven om *de koptekst van de e-mail weer te geven.* Beheerders kunnen alle details in e-mailberichtkoppen naast de informatie in het hoofdvenster vergelijken voor duidelijkheid.
...
*Tags:* dit zijn tags die worden toegepast op gebruikers. Als de gebruiker een geadresseerde is, zien beheerders een *tag voor de geadresseerde.* En als de gebruiker een afzender is, is dit ook een *tag voor de* afzender. Dit wordt weergegeven aan de linkerkant van de pagina met e-mailentiteiten (in het gedeelte dat wordt beschreven als plakkerig en dus verankerd aan de pagina). 
...
*E-maildetails:* details zijn vereist voor een beter begrip van e-mail op het *tabblad* Analyse.
...
- *Overschrijven* systeem: Dit is een manier om uitzonderingen op de bezorgingslocatie voor een bericht aan te brengen door de leveringslocatie te vervangen die door het systeem wordt gegeven (volgens de technologie van bedreiging en detectie).
...
- *Regel voor ongewenste* e-mail: Ongewenste e-mail is een verborgen regel voor Postvak IN die standaard in elk postvak is ingeschakeld.
    ...
    - Wanneer de regel voor ongewenste e-mail *is* uitgeschakeld in het postvak, kan EOP geen berichten verplaatsen naar de map Ongewenste e-mail op basis van de actie spamfilter bericht verplaatsen naar de map Ongewenste e-mail *of* de veilige lijstverzameling in het postvak.
...
- *Spam-betrouwbaarheidsniveau (SCL:* het betrouwbaarheidsniveau voor spam) van het bericht. Hoe hoger de waarde, hoe groter de kans dat het bericht spam is.
...
- **SPF**(Sender Policy Framework): De resultaten van de SPF-controle voor het bericht worden beschreven. Mogelijke waarden zijn:
...
- Domain-based Message Authentication, Reporting and Conformance **(DMARC**):
    ...
    - Bestguesspass: Hiermee wordt aangegeven dat er geen DMARC TXT-record voor het domein bestaat, maar als er een had bestaan, zou de DMARC-controle voor het bericht zijn doorgegeven.
