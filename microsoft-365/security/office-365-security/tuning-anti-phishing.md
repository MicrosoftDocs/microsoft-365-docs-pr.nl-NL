...
- Bekijk het rapport [Bedreigingsbeveiligingsstatus regelmatig.](view-reports-for-atp.md#threat-protection-status-report)
...
- Het doorsturen van regels naar externe geadresseerden wordt vaak door aanvallers gebruikt om gegevens op te halen. Gebruik de **informatie over het doorsturen van postvakken** in [Microsoft Secure Score](../mtp/microsoft-secure-score.md) om regels voor doorsturen naar externe geadresseerden te zoeken en zelfs te voorkomen. Zie [Mitigating Client External Forwarding Rules](/archive/blogs/office365security/mitigating-client-external-forwarding-rules-with-secure-score)with Secure Score (Regels voor extern doorsturen van client met secure score) voor meer informatie.