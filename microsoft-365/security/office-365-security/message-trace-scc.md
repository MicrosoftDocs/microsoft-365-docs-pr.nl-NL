...
Berichtspoor in het Beveiligings- & compliancecentrum verbetert de oorspronkelijke bericht trace die beschikbaar was in het Exchange-beheercentrum (EAC). U kunt de informatie uit bericht traceren gebruiken om gebruikersvragen efficiënt te beantwoorden over wat er met berichten is gebeurd, problemen met de e-mailstroom op te lossen en beleidswijzigingen te valideren.
...
2. Vouw **E-mailstroom** uit en selecteer **vervolgens Bericht traceren.**
...
- **verwijzing**: Dit veld bevat aanvullende informatie voor specifieke typen gebeurtenissen. Bijvoorbeeld:
  ...
  - **POSTVAKREGEL:** bevat **de internal_message_id** waarde van het binnenkomende bericht waardoor de regel Postvak IN het uitgaande bericht heeft gegenereerd.
