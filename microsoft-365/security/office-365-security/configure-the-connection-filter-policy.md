...
2. Vouw op **de pagina Antispaminstellingen** het verbindingsfilterbeleid **uit** door op het pictogram Uitv waarom u klikt en vervolgens op ![ Beleid ](../../media/scc-expand-icon.png) **bewerken.**
...
3. Configureer **een van** de volgende instellingen in de standaard flyout die wordt weergegeven:
   ...
   - **Lijst met toegestane** IP-adressen: klik **op Bewerken.** Voer in **de flyout** Lijst met ip-adressen die  wordt weergegeven, een IPV4-adres in het vak Adres of adresbereik in met behulp van de volgende syntaxis:
     ...
     Als u het IP-adres of adresbereik wilt toevoegen, klikt u op **Pictogram** ![ ](../../media/ITPro-EAC-AddIcon.png) toevoegen. Als u een vermelding wilt verwijderen, selecteert u de vermelding in **Het toegestane IP-adres** en klikt u **op** ![ ](../../media/scc-remove-icon.png) Verwijderen. Klik op **Opslaan** wanneer u gereed bent.
...
### <a name="scenarios-where-messages-from-sources-in-the-ip-allow-list-are-still-filtered"></a>Scenario's waarin berichten van bronnen in de lijst met toegestane IP-adressen nog steeds worden gefilterd
...
- Regelvoorwaarde: Pas deze **regel toe als** het IP-adres van de afzender in een van deze bereiken staat of precies overeenkomt \>  \>  \> (uw IP-adres of -adressen).
