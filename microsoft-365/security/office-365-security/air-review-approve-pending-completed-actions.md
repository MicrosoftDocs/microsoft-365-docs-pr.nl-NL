...
> [!IMPORTANT]
> Er zijn passende machtigingen vereist om herstelacties goed te keuren of af te wijzen. Zie [Vereiste machtigingen voor het gebruik van AIR-mogelijkheden](office-365-air.md#required-permissions-to-use-air-capabilities).
...
- [Threat Explorer gebruiken](threat-explorer.md)