...
De eerste stap in het gebruik van Microsoft Cloud App Security voor het beheren van SaaS-apps is om deze te ontdekken en vervolgens toe te voegen aan uw Azure AD-tenant. Zie [SaaS-apps](/cloud-app-security/tutorial-shadow-it)in uw netwerk ontdekken en beheren als u hulp nodig hebt bij detectie. Nadat u apps hebt gevonden, voegt [u deze toe aan uw Azure AD-tenant.](/azure/active-directory/manage-apps/add-application-portal)
...
|---|---|---|
|Alle beveiligingsniveaus|[Voorwaardelijke toegang app-beheer gebruiken in cloud-app-beveiliging](/cloud-app-security/proxy-deployment-aad#configure-integration-with-azure-ad)|Hiermee configureert u uw IdP (Azure AD) om te werken met Cloud App Security.|
||||
...
Zie Apps beveiligen met Microsoft Cloud App Security Conditional Access App Control voor meer [informatie.](/cloud-app-security/proxy-intro-aad)
...
[Hoe Cloud App Security uw Box-omgeving](/cloud-app-security/protect-box) helpt beveiligen, toont de typen besturingselementen waarmee u uw zakelijke gegevens kunt beveiligen in Box en andere apps met gevoelige gegevens.
...
Zie Microsoft [Cloud App Security-documentatie](//cloud-app-security/)voor meer informatie over het gebruik van cloud-appbeveiliging.
