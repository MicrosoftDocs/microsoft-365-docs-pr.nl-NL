...
ms.locfileid: "50604040"
---
# <a name="remediate-malicious-email-delivered-in-office-365"></a>Herstel schadelijke e-mail die wordt geleverd in Office 365
...
Nadat e-mailberichten zijn geselecteerd via Bedreigingsverkenner, kunt u beginnen met herstel door directe actie te ondernemen of door e-mailberichten in de wachtrij te zetten voor een actie:
...
- **Tabblad** E-mailverzending: Hier wordt het aantal e-mailberichten weergegeven dat is verzonden via Bedreigingsverkenner of via geautomatiseerde onderzoeken die moeten worden teruggezonden. Er kan al dan niet een actie worden ondernomen via deze e-mails.

  > [!div class="mx-imgBorder"]
  > [![Het actiecentrum met bedreigingen die wel en niet kunnen worden actie ondernemen.](../../media/tp-RemediationArticle5.png)](../../media/tp-RemediationArticle5.png#lightbox)
...
- **Actielogboeken:** dit tabblad bevat de berichten die zijn herstellen, inclusief de goedgekeurde datum, de beheerder die de actie, actie, status en tellingen heeft goedgekeurd.
  ...
  - **Al in bestemming:** De gewenste actie is al ondernomen op het e-mailbericht OF het e-mailbericht bestaat al op de doellocatie. Bijvoorbeeld: Een e-mailbericht is op dag 1 door de beheerder in Verkenner soft verwijderd. Op dag 2 worden vergelijkbare e-mailberichten we zien, die weer zacht worden verwijderd door de beheerder. Als u deze e-mailberichten selecteert, worden sommige e-mailberichten van de eerste dag automatisch door de beheerder verwijderd. Er wordt nu geen actie ondernomen op deze e-mailberichten, ze worden alleen maar als 'al in bestemming' gezien, omdat er geen actie is ondernomen op deze berichten zoals ze op de doellocatie aanwezig waren.
...
Het beveiligingsteam kan tot 50 gelijktijdige handmatige herstelmaatregelen nemen. Er is echter geen limiet ingesteld voor automatisch onderzoek en reactieacties.
