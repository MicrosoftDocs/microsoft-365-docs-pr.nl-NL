...
---
# <a name="move-domains-and-settings-from-one-eop-organization-to-another"></a><span data-ttu-id="5e048-103">Domeinen en instellingen van één EOP-organisatie naar een andere verplaatsen</span><span class="sxs-lookup"><span data-stu-id="5e048-103">Move domains and settings from one EOP organization to another</span></span>

[!INCLUDE [Microsoft 365 Defender rebranding](../includes/microsoft-defender-for-office.md)]

<span data-ttu-id="5e048-104">**Van toepassing op**</span><span class="sxs-lookup"><span data-stu-id="5e048-104">**Applies to**</span></span>
-  [<span data-ttu-id="5e048-105">Zelfstandige versie van Exchange Online Protection</span><span class="sxs-lookup"><span data-stu-id="5e048-105">Exchange Online Protection standalone</span></span>](https://go.microsoft.com/fwlink/?linkid=2148611)

<span data-ttu-id="5e048-106">Als de bedrijfsvereisten veranderen, kan het soms nodig zijn om één Microsoft Exchange Online Protection (EOP)-organisatie (tenant) te splitsen in twee afzonderlijke organisaties, twee organisaties samen te voegen tot één organisatie of uw domeinen en EOP-instellingen van de ene organisatie te verplaatsen naar een andere organisatie.</span><span class="sxs-lookup"><span data-stu-id="5e048-106">Changing business requirements can sometimes require splitting one Microsoft Exchange Online Protection (EOP) organization (tenant) into two separate organizations, merging two organizations into one, or moving your domains and EOP settings from one organization to another organization.</span></span> <span data-ttu-id="5e048-107">Een overstap van de ene EOP-organisatie naar een tweede EOP-organisatie kan lastig zijn, maar met een paar eenvoudige externe Windows PowerShell-scripts en een kleine voorbereiding kan dit worden bereikt met een relatief klein onderhoudsvenster.</span><span class="sxs-lookup"><span data-stu-id="5e048-107">Moving from one EOP organization to a second EOP organization can be challenging, but with a few basic remote Windows PowerShell scripts and a small amount of preparation, this can be achieved with a relatively small maintenance window.</span></span>

> [!NOTE]
>
> - <span data-ttu-id="5e048-108">Instellingen kunnen betrouwbaar worden verplaatst van een zelfstandige EOP-organisatie (Standard) naar een andere EOP Standard- of Exchange Enterprise CAL met Services-organisatie (EOP Premium), of van een EOP Premium-organisatie naar een andere EOP Premium-organisatie.</span><span class="sxs-lookup"><span data-stu-id="5e048-108">Settings can be reliably moved only from an EOP standalone (Standard) organization to either another EOP Standard or an Exchange Enterprise CAL with Services (EOP Premium) organization, or from an EOP Premium organization to another EOP Premium organization.</span></span> <span data-ttu-id="5e048-109">Omdat sommige premiumfuncties niet worden ondersteund in EOP Standard-organisaties, is de overstap van een EOP Premium-organisatie naar een EOP Standard-organisatie mogelijk niet gelukt.</span><span class="sxs-lookup"><span data-stu-id="5e048-109">Because some premium features are not supported in EOP Standard organizations, moves from an EOP Premium organization to an EOP Standard organization might not be successful.</span></span>
>
> - <span data-ttu-id="5e048-110">Deze instructies zijn alleen beschikbaar voor organisaties die uitsluitend EOP-filters gebruiken.</span><span class="sxs-lookup"><span data-stu-id="5e048-110">These instructions are for EOP filtering-only organizations.</span></span> <span data-ttu-id="5e048-111">Er zijn extra overwegingen om over te gaan van de ene Exchange Online-organisatie naar een andere Exchange Online-organisatie.</span><span class="sxs-lookup"><span data-stu-id="5e048-111">There are additional considerations in moving from one Exchange Online organization to another Exchange Online organization.</span></span> <span data-ttu-id="5e048-112">Exchange Online-organisaties vallen buiten het bereik voor deze instructies.</span><span class="sxs-lookup"><span data-stu-id="5e048-112">Exchange Online organizations are out of scope for these instructions.</span></span>

<span data-ttu-id="5e048-113">In het volgende voorbeeld is Contoso, Ltd. samengevoegd met Contoso Suites.</span><span class="sxs-lookup"><span data-stu-id="5e048-113">In the following example, Contoso, Ltd. has merged with Contoso Suites.</span></span> <span data-ttu-id="5e048-114">In de volgende afbeelding ziet u het proces voor het verplaatsen van domeinen, e-mailgebruikers en groepen en instellingen van de bron-EOP-organisatie (contoso.onmicrosoft.com) naar de doel-EOP-organisatie (contososuites.onmicrosoft.com):</span><span class="sxs-lookup"><span data-stu-id="5e048-114">The following image shows the process of moving domains, mail users and groups, and settings from the source EOP organization (contoso.onmicrosoft.com) to the target EOP organization (contososuites.onmicrosoft.com):</span></span>

![EOP-domeinen en -instellingen verplaatsen](../../media/EOP-Move-domains-and-settings.jpg)

<span data-ttu-id="5e048-116">Het probleem bij het verplaatsen van domeinen van de ene organisatie naar de andere is dat een geverifieerd domein niet kan bestaan in twee organisaties tegelijk.</span><span class="sxs-lookup"><span data-stu-id="5e048-116">The challenge in moving domains from one organization to another is that a verified domain can't exist in two organizations at the same time.</span></span> <span data-ttu-id="5e048-117">De volgende stappen helpen u om dit te doen.</span><span class="sxs-lookup"><span data-stu-id="5e048-117">The following steps help you work through this.</span></span>

## <a name="step-1-collect-data-from-the-source-organization"></a><span data-ttu-id="5e048-118">Stap 1: Gegevens verzamelen van de bronorganisatie</span><span class="sxs-lookup"><span data-stu-id="5e048-118">Step 1: Collect data from the source organization</span></span>

<span data-ttu-id="5e048-119">Als u de bronorganisatie in de doelorganisatie opnieuw wilt maken, moet u de volgende gegevens over de bronorganisatie verzamelen en opslaan:</span><span class="sxs-lookup"><span data-stu-id="5e048-119">In order to re-create the source organization in the target organization, make sure that you collect and store the following information about the source organization:</span></span>

- <span data-ttu-id="5e048-120">Domeinen</span><span class="sxs-lookup"><span data-stu-id="5e048-120">Domains</span></span>
- <span data-ttu-id="5e048-121">E-mailgebruikers</span><span class="sxs-lookup"><span data-stu-id="5e048-121">Mail users</span></span>
- <span data-ttu-id="5e048-122">Groepen</span><span class="sxs-lookup"><span data-stu-id="5e048-122">Groups</span></span>
- <span data-ttu-id="5e048-123">Antispam</span><span class="sxs-lookup"><span data-stu-id="5e048-123">Anti-spam</span></span>
  - <span data-ttu-id="5e048-124">Antispambeleid (ook wel inhoudsfilterbeleid genoemd)</span><span class="sxs-lookup"><span data-stu-id="5e048-124">Anti-spam policies (also known as content filter policies)</span></span>
  - <span data-ttu-id="5e048-125">Beleid voor uitgaande spamfilters</span><span class="sxs-lookup"><span data-stu-id="5e048-125">Outbound spam filter policies</span></span>
  - <span data-ttu-id="5e048-126">Verbindingsfilterbeleid</span><span class="sxs-lookup"><span data-stu-id="5e048-126">Connection filter policies</span></span>
- <span data-ttu-id="5e048-127">Anti-malwarebeleid</span><span class="sxs-lookup"><span data-stu-id="5e048-127">Anti-malware policies</span></span>
- <span data-ttu-id="5e048-128">Verbindingslijnen</span><span class="sxs-lookup"><span data-stu-id="5e048-128">Connectors</span></span>
- <span data-ttu-id="5e048-129">E-mailstroomregels (ook wel transportregels genoemd)</span><span class="sxs-lookup"><span data-stu-id="5e048-129">Mail flow rules (also known as transport rules)</span></span>

  > [!NOTE]
  > <span data-ttu-id="5e048-130">Ondersteuning voor cmdlet's voor het exporteren en importeren van de verzameling regels voor de e-mailstroom wordt momenteel alleen ondersteund voor EOP Premium-abonnementen.</span><span class="sxs-lookup"><span data-stu-id="5e048-130">Cmdlet support for the export and import of the mail flow rule collection is currently only supported for EOP Premium subscription plans.</span></span>

<span data-ttu-id="5e048-131">De eenvoudigste manier om al uw instellingen te verzamelen is met PowerShell.</span><span class="sxs-lookup"><span data-stu-id="5e048-131">The easiest way to collect all of your settings is to use PowerShell.</span></span> <span data-ttu-id="5e048-132">Zie [Verbinding maken met Exchange Online Protection PowerShell](https://docs.microsoft.com/powershell/exchange/connect-to-exchange-online-protection-powershell) als je verbinding wilt maken met zelfstandige EOP PowerShell.</span><span class="sxs-lookup"><span data-stu-id="5e048-132">To connect to standalone EOP PowerShell, see [Connect to Exchange Online Protection PowerShell](https://docs.microsoft.com/powershell/exchange/connect-to-exchange-online-protection-powershell).</span></span>

<span data-ttu-id="5e048-133">Vervolgens kunt u alle instellingen verzamelen en deze exporteren naar een XML-bestand dat u wilt importeren in de doelten tenant.</span><span class="sxs-lookup"><span data-stu-id="5e048-133">Next, you can collect all your settings and export them to an .xml file to be imported into the target tenant.</span></span> <span data-ttu-id="5e048-134">In het algemeen kunt u voor elke instelling de **uitvoer** van de cmdlet Get doorvergeven naar de cmdlet **Export-Clixml** om de instellingen op te slaan in XML-bestanden, zoals wordt weergegeven in het volgende codevoorbeeld.</span><span class="sxs-lookup"><span data-stu-id="5e048-134">In general, you can pipe the output of the **Get** cmdlet for each setting to the **Export-Clixml** cmdlet to save the settings in .xml files, as shown in the following code sample.</span></span>

<span data-ttu-id="5e048-135">Maak in zelfstandige EOP PowerShell een adreslijst met de naam Exporteren op een locatie die u eenvoudig kunt vinden en wijzigen in die adreslijst.</span><span class="sxs-lookup"><span data-stu-id="5e048-135">In standalone EOP PowerShell, create a directory called Export in a location that's easy to find and change to that directory.</span></span> <span data-ttu-id="5e048-136">Bijvoorbeeld:</span><span class="sxs-lookup"><span data-stu-id="5e048-136">For example:</span></span>
...
<span data-ttu-id="5e048-137">Het volgende script kan worden gebruikt om alle e-mailgebruikers, groepen, antispaminstellingen, antimalware-instellingen, connectors en regels voor de e-mailstroom in de bronorganisatie te verzamelen.</span><span class="sxs-lookup"><span data-stu-id="5e048-137">The following script can be used to collect all the mail users, groups, anti-spam settings, anti-malware settings, connectors, and mail flow rules in the source organization.</span></span> <span data-ttu-id="5e048-138">Kopieer en plak de volgende tekst in een teksteditor zoals Kladblok, sla het bestand op als Source_EOP_Settings.ps1 in de map Exporteren die u zojuist hebt gemaakt en voer de volgende opdracht uit:</span><span class="sxs-lookup"><span data-stu-id="5e048-138">Copy and paste the following text into a text editor like Notepad, save the file as Source_EOP_Settings.ps1 in the Export directory you just created, and run the following command:</span></span>
...
<span data-ttu-id="5e048-139">Voer de volgende opdrachten uit vanuit de map Exporteren om de XML-bestanden bij te werken met de doelorganisatie.</span><span class="sxs-lookup"><span data-stu-id="5e048-139">Run the following commands from the Export directory to update the .xml files with the target organization.</span></span> <span data-ttu-id="5e048-140">Vervang contoso.onmicrosoft.com en contososuites.onmicrosoft.com door de namen van de bron- en doelorganisatie.</span><span class="sxs-lookup"><span data-stu-id="5e048-140">Replace contoso.onmicrosoft.com and contososuites.onmicrosoft.com with your source and target organization names.</span></span>
...
## <a name="step-2-add-domains-to-the-target-organization"></a><span data-ttu-id="5e048-141">Stap 2: Domeinen toevoegen aan de doelorganisatie</span><span class="sxs-lookup"><span data-stu-id="5e048-141">Step 2: Add domains to the target organization</span></span>

<span data-ttu-id="5e048-142">Voeg domeinen toe aan de doelorganisatie met behulp van het volgende script.</span><span class="sxs-lookup"><span data-stu-id="5e048-142">Add domains to the target organization by using the following script.</span></span> <span data-ttu-id="5e048-143">Kopieer en plak de tekst in een teksteditor zoals Kladblok, sla het script op als C:\EOP\Export\Add_Domains.ps1 en voer de volgende opdracht uit:</span><span class="sxs-lookup"><span data-stu-id="5e048-143">Copy and paste the text into a text editor like Notepad, save the script as C:\EOP\Export\Add_Domains.ps1, and run the following command:</span></span>

```PowerShell
& "C:\EOP\Export\Add_Domains.ps1"
```

<span data-ttu-id="5e048-144">Deze domeinen worden niet geverifieerd en kunnen niet worden gebruikt om e-mail te routen, maar nadat de domeinen zijn toegevoegd, kunt u de benodigde gegevens verzamelen om de domeinen te verifiëren en uiteindelijk uw MX-records voor de nieuwe tenant bijwerken.</span><span class="sxs-lookup"><span data-stu-id="5e048-144">These domains won't be verified and can't be used to route mail, but after the domains are added, you can collect the information needed to verify the domains and eventually update your MX records for the new tenant.</span></span>
...
<span data-ttu-id="5e048-145">U kunt de gegevens nu bekijken en verzamelen in het Microsoft 365-beheercentrum van uw doelorganisatie, zodat u snel uw domeinen kunt verifiëren wanneer het tijd is:</span><span class="sxs-lookup"><span data-stu-id="5e048-145">Now you can review and collect the information from the Microsoft 365 admin center of your target organization so you can quickly verify your domains when the time comes:</span></span>

1. <span data-ttu-id="5e048-146">Meld u aan bij het Microsoft 365-beheercentrum op <https://portal.office.com> .</span><span class="sxs-lookup"><span data-stu-id="5e048-146">Sign in to the Microsoft 365 admin center at <https://portal.office.com>.</span></span>

2. <span data-ttu-id="5e048-147">Klik **op Domeinen.**</span><span class="sxs-lookup"><span data-stu-id="5e048-147">Click **Domains**.</span></span>

   <span data-ttu-id="5e048-148">Als u geen domeinen ziet, klikt u op Navigatie **aanpassen,** **selecteert** u Setup en klikt u vervolgens op **Opslaan.**</span><span class="sxs-lookup"><span data-stu-id="5e048-148">If you don't see domains, click **Customize navigation**, select **Setup**, and then click **Save**.</span></span>

3. <span data-ttu-id="5e048-149">Klik op **elke koppeling voor het** instellen starten en ga door met de installatiewizard.</span><span class="sxs-lookup"><span data-stu-id="5e048-149">Click each **Start setup** link, and then proceed through the setup wizard.</span></span>

4. <span data-ttu-id="5e048-150">Selecteer algemene instructies **op** de pagina Eigendom bevestigen voor stapsgewijs instructies voor het uitvoeren van deze  **stap.**</span><span class="sxs-lookup"><span data-stu-id="5e048-150">On the **Confirm ownership** page, for **See step-by-step instructions for performing this step with**, select **General instructions**.</span></span>

5. <span data-ttu-id="5e048-151">Neem de MX-record of TXT-record op die u gebruikt om uw domein te verifiëren en sluit de installatiewizard af.</span><span class="sxs-lookup"><span data-stu-id="5e048-151">Record the MX record or TXT record that you'll use to verify your domain, and finish the setup wizard.</span></span>

6. <span data-ttu-id="5e048-152">Voeg de verificatie-TXT-records toe aan uw DNS-records.</span><span class="sxs-lookup"><span data-stu-id="5e048-152">Add the verification TXT records to your DNS records.</span></span> <span data-ttu-id="5e048-153">Hierdoor kunt u sneller de domeinen in de bronorganisatie verifiëren nadat deze zijn verwijderd uit de doelorganisatie.</span><span class="sxs-lookup"><span data-stu-id="5e048-153">This will let you more quickly verify the domains in the source organization after they're removed from the target organization.</span></span> <span data-ttu-id="5e048-154">Zie DNS-records maken bij een [DNS-hostingprovider voor Microsoft 365](https://docs.microsoft.com/microsoft-365/admin/get-help-with-domains/create-dns-records-at-any-dns-hosting-provider)voor meer informatie over het configureren van DNS.</span><span class="sxs-lookup"><span data-stu-id="5e048-154">For more information about configuring DNS, see [Create DNS records at any DNS hosting provider for Microsoft 365](https://docs.microsoft.com/microsoft-365/admin/get-help-with-domains/create-dns-records-at-any-dns-hosting-provider).</span></span>

## <a name="step-3-force-senders-to-queue-mail"></a><span data-ttu-id="5e048-155">Stap 3: Afzenders dwingen om e-mail in de wachtrij te zetten</span><span class="sxs-lookup"><span data-stu-id="5e048-155">Step 3: Force senders to queue mail</span></span>

<span data-ttu-id="5e048-156">Wanneer u uw domeinen van de ene tenant naar de andere verplaatst, moet u de domeinen uit de bronorganisatie verwijderen en vervolgens in uw doelorganisatie verifiëren.</span><span class="sxs-lookup"><span data-stu-id="5e048-156">While moving your domains from one tenant to another, you'll need to delete the domains from the source organization and then verify them in your target organization.</span></span> <span data-ttu-id="5e048-157">Tijdens deze periode kunt u geen e-mail door sturen via EOP.</span><span class="sxs-lookup"><span data-stu-id="5e048-157">During this time, you won't be able to route mail through EOP.</span></span>

<span data-ttu-id="5e048-158">Een optie om afzenders af te dwingen e-mail in de wachtrij te zetten, is door uw MX-records bij te werken, die rechtstreeks naar de on-premises e-mailserver wijzen.</span><span class="sxs-lookup"><span data-stu-id="5e048-158">One option to force senders to queue mail is to update your MX records to point directly to your on-premises mail server.</span></span>

<span data-ttu-id="5e048-159">Een andere mogelijkheid is om een ongeldige MX-record in elk domein te plaatsen waar de DNS-records voor uw domein worden bewaard (ook wel uw DNS-hostingservice genoemd).</span><span class="sxs-lookup"><span data-stu-id="5e048-159">Another option is to put an invalid MX record in each domain where the DNS records for your domain are kept (also known as your DNS hosting service).</span></span> <span data-ttu-id="5e048-160">Hierdoor wordt uw e-mail in de wachtrij geplaatst en opnieuw geprobeerd (de standaardpogingen voor opnieuw proberen zijn 48 uur, maar dit kan per provider verschillen).</span><span class="sxs-lookup"><span data-stu-id="5e048-160">This will cause the sender to queue your mail and retry (typical retry attempts are for 48 hours, but this might vary from provider to provider).</span></span> <span data-ttu-id="5e048-161">U kunt een invalid.outlook.com gebruiken als ongeldig MX-doel.</span><span class="sxs-lookup"><span data-stu-id="5e048-161">You can use invalid.outlook.com as an invalid MX target.</span></span> <span data-ttu-id="5e048-162">Door de TTL-waarde (Time to Live) te verlagen tot vijf minuten in de MX-record, kan de wijziging sneller worden doorgegeven aan DNS-providers.</span><span class="sxs-lookup"><span data-stu-id="5e048-162">Lowering the Time to Live (TTL) value to five minutes on the MX record will help the change propagate to DNS providers more quickly.</span></span>

<span data-ttu-id="5e048-163">Zie DNS-records maken bij een [DNS-hostingprovider voor Microsoft 365](https://docs.microsoft.com/microsoft-365/admin/get-help-with-domains/create-dns-records-at-any-dns-hosting-provider)voor meer informatie over het configureren van DNS.</span><span class="sxs-lookup"><span data-stu-id="5e048-163">For more information about configuring DNS, see [Create DNS records at any DNS hosting provider for Microsoft 365](https://docs.microsoft.com/microsoft-365/admin/get-help-with-domains/create-dns-records-at-any-dns-hosting-provider).</span></span>

> [!IMPORTANT]
> <span data-ttu-id="5e048-164">E-mail van verschillende providers wordt gedurende verschillende perioden in de wachtrij geplaatst.</span><span class="sxs-lookup"><span data-stu-id="5e048-164">Different providers queue mail for different periods of time.</span></span> <span data-ttu-id="5e048-165">U moet uw nieuwe tenant snel instellen en uw DNS-instellingen herstellen om te voorkomen dat rapporten over niet-levering (NDR's) naar de afzender worden verzonden als de wachtrijtijd verloopt.</span><span class="sxs-lookup"><span data-stu-id="5e048-165">You'll need to set up your new tenant quickly and revert your DNS settings to avoid non-delivery reports (NDRs) from being sent to the sender if the queuing time expires.</span></span>

## <a name="step-4-remove-users-groups-and-domains-from-the-source-organization"></a><span data-ttu-id="5e048-166">Stap 4: Gebruikers, groepen en domeinen verwijderen uit de bronorganisatie</span><span class="sxs-lookup"><span data-stu-id="5e048-166">Step 4: Remove users, groups, and domains from the source organization</span></span>

<span data-ttu-id="5e048-167">Met het volgende script worden gebruikers, groepen en domeinen verwijderd uit de bronten tenant met behulp van Azure Active Directory PowerShell.</span><span class="sxs-lookup"><span data-stu-id="5e048-167">The following script removes users, groups, and domains from the source tenant by using Azure Active Directory PowerShell.</span></span> <span data-ttu-id="5e048-168">Kopieer en plak de volgende tekst in een teksteditor zoals Kladblok, sla het bestand op als C:\EOP\Export\Remove_Users_and_Groups.ps1 en voer de volgende opdracht uit:</span><span class="sxs-lookup"><span data-stu-id="5e048-168">Copy and paste the following text into a text editor like Notepad, save the file as C:\EOP\Export\Remove_Users_and_Groups.ps1, and run the following command:</span></span>
...
## <a name="step-5-verify-domains-for-the-target-organization"></a><span data-ttu-id="5e048-169">Stap 5: Domeinen voor de doelorganisatie verifiëren</span><span class="sxs-lookup"><span data-stu-id="5e048-169">Step 5: Verify domains for the target organization</span></span>

1. <span data-ttu-id="5e048-170">Meld u aan bij het beheercentrum op <https://portal.office.com> .</span><span class="sxs-lookup"><span data-stu-id="5e048-170">Sign in to the admin center at <https://portal.office.com>.</span></span>

2. <span data-ttu-id="5e048-171">Klik **op Domeinen.**</span><span class="sxs-lookup"><span data-stu-id="5e048-171">Click **Domains**.</span></span>

3. <span data-ttu-id="5e048-172">Klik op **elke koppeling voor het** instellen van het doeldomein starten en ga door met de installatiewizard.</span><span class="sxs-lookup"><span data-stu-id="5e048-172">Click each **Start setup** link for the target domain and proceed through the setup wizard.</span></span>

## <a name="step-6-add-mail-users-and-groups-to-the-target-organization"></a><span data-ttu-id="5e048-173">Stap 6: E-mailgebruikers en groepen toevoegen aan de doelorganisatie</span><span class="sxs-lookup"><span data-stu-id="5e048-173">Step 6: Add mail users and groups to the target organization</span></span>

<span data-ttu-id="5e048-174">Een goede gewoonte voor EOP is om Azure Active Directory te gebruiken om uw on-premises Active Directory te synchroniseren met uw doel-tenant.</span><span class="sxs-lookup"><span data-stu-id="5e048-174">A best practice for EOP is to use Azure Active Directory to sync your on-premises Active Directory to your target tenant.</span></span> <span data-ttu-id="5e048-175">Zie 'Adreslijstsynchronisatie gebruiken om e-mailgebruikers te beheren' in [EOP e-mailgebruikers beheren voor](manage-mail-users-in-eop.md)meer informatie over hoe u dit doet.</span><span class="sxs-lookup"><span data-stu-id="5e048-175">For more information about how to do this, see "Use directory synchronization to manage mail users" in [Manage mail users in EOP](manage-mail-users-in-eop.md).</span></span> <span data-ttu-id="5e048-176">U kunt ook het volgende script gebruiken om uw gebruikers en groepen opnieuw te maken vanuit uw bron-tenant.</span><span class="sxs-lookup"><span data-stu-id="5e048-176">You can also use the following script to recreate your users and groups from your source tenant.</span></span> <span data-ttu-id="5e048-177">Opmerking: Gebruikerswachtwoorden kunnen niet worden verplaatst.</span><span class="sxs-lookup"><span data-stu-id="5e048-177">Note: User passwords cannot be moved.</span></span> <span data-ttu-id="5e048-178">Nieuwe gebruikerswachtwoorden worden gemaakt en opgeslagen in het bestand met de UsersAndGroups.ps1.</span><span class="sxs-lookup"><span data-stu-id="5e048-178">New user passwords are created and saved in the file named UsersAndGroups.ps1.</span></span>

<span data-ttu-id="5e048-179">Als u het script wilt gebruiken, kopieert en plakt u de volgende tekst in een teksteditor zoals Kladblok, sla het bestand op als C:\EOP\Export\Add_Users_and_Groups.ps1 en voer u de volgende opdracht uit:</span><span class="sxs-lookup"><span data-stu-id="5e048-179">To use the script, copy and paste the following text into a text editor like Notepad, save the file as C:\EOP\Export\Add_Users_and_Groups.ps1, and run the following command:</span></span>
...
## <a name="step-7-add-protection-settings-to-the-target-organization"></a><span data-ttu-id="5e048-180">Stap 7: Beveiligingsinstellingen toevoegen aan de doelorganisatie</span><span class="sxs-lookup"><span data-stu-id="5e048-180">Step 7: Add protection settings to the target organization</span></span>

<span data-ttu-id="5e048-181">U kunt het volgende script uitvoeren vanuit de exportmap terwijl u bent aangemeld bij de doelorganisatie om de instellingen te recreëren die eerder vanuit de bronorganisatie naar XML-bestanden zijn geëxporteerd.</span><span class="sxs-lookup"><span data-stu-id="5e048-181">You can run the following script from the Export directory while logged in to your target organization to recreate the settings exported to .xml files earlier from the source organization.</span></span>

<span data-ttu-id="5e048-182">Kopieer en plak de scripttekst in een teksteditor zoals Kladblok, sla het bestand op als C:\EOP\Export\Import_Settings.ps1 en voer de volgende opdracht uit:</span><span class="sxs-lookup"><span data-stu-id="5e048-182">Copy and paste the script text into a text editor like Notepad, save the file as C:\EOP\Export\Import_Settings.ps1, and run the following command:</span></span>

```PowerShell
& "C:\EOP\Export\Import_Settings.ps1"
```

<span data-ttu-id="5e048-183">Dit script importeert de XML-bestanden en maakt een Windows PowerShell-scriptbestand met de naam Settings.ps1 dat u kunt bekijken, bewerken en vervolgens opnieuw kunt uitvoeren om uw beveiligings- en e-mailstroominstellingen opnieuw te maken.</span><span class="sxs-lookup"><span data-stu-id="5e048-183">This script imports the .xml files and create a Windows PowerShell script file called Settings.ps1 that you can review, edit, and then run to recreate your protection and mail-flow settings.</span></span>
...
## <a name="step-8-revert-your-dns-settings-to-stop-mail-queuing"></a><span data-ttu-id="5e048-184">Stap 8: De DNS-instellingen herstellen om de wachtrij voor e-mail te stoppen</span><span class="sxs-lookup"><span data-stu-id="5e048-184">Step 8: Revert your DNS settings to stop mail queuing</span></span>

<span data-ttu-id="5e048-185">Als u ervoor kiest om uw MX-records in te stellen op een ongeldig adres, om ervoor te zorgen dat [](https://admin.microsoft.com)de afzenders tijdens de overgang e-mail in de wachtrij zetten, moet u deze terug instellen op de juiste waarde, zoals is opgegeven in het beheercentrum.</span><span class="sxs-lookup"><span data-stu-id="5e048-185">If you chose to set your MX records to an invalid address to cause the senders to queue mail during your transition, you'll need to set them back to the correct value as specified in the [admin center](https://admin.microsoft.com).</span></span> <span data-ttu-id="5e048-186">Zie DNS-records maken bij een [DNS-hostingprovider voor Microsoft 365](https://docs.microsoft.com/microsoft-365/admin/get-help-with-domains/create-dns-records-at-any-dns-hosting-provider)voor meer informatie over het configureren van DNS.</span><span class="sxs-lookup"><span data-stu-id="5e048-186">For more information about configuring DNS, see [Create DNS records at any DNS hosting provider for Microsoft 365](https://docs.microsoft.com/microsoft-365/admin/get-help-with-domains/create-dns-records-at-any-dns-hosting-provider).</span></span>
