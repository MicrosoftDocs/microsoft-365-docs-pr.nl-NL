...
> [!NOTE]
> De volgende functies bevinden zich in de algemene instellingen van het beleid voor veilige bijlagen in het & compliancecentrum. Deze instellingen worden echter globaal in- of uitgeschakeld en er is geen beleid voor veilige bijlagen vereist:
>
...
- **Safe Attachments unknown malware response:** This setting controls the action for Safe Attachments malware scanning in email messages. De beschikbare opties worden in de volgende tabel beschreven:
  ...
  ****
  ...
  |**Dynamische bezorging**|Berichten worden direct verzonden, maar worden vervangen door tijdelijke aanduidingen totdat het scannen van veilige bijlagen is voltooid. <p> Zie de sectie [Beleidsregels voor dynamische bezorging in veilige](#dynamic-delivery-in-safe-attachments-policies) bijlagen verderaan in dit artikel.|Voorkom vertraging van berichten bij het beveiligen van geadresseerden tegen schadelijke bestanden. <p> Geadresseerden in staat stellen een voorbeeld van bijlagen in de veilige modus te bekijken terwijl het scannen wordt plaatsvinden.|
  |
...
Als u een mobiel apparaat gebruikt en PDF-bestanden niet worden weergegeven in de Voorbeeldweergave voor dynamische bezorging op uw mobiele apparaat, opent u het bericht in de webversie van Outlook (voorheen Outlook Web App genoemd) in uw mobiele browser.
