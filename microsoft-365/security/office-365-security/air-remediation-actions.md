...
|E-mail|Schadelijke URL<br/>(Er is een schadelijke URL gedetecteerd door [veilige koppelingen](atp-safe-links.md).)|E-mail/cluster zacht verwijderen <p>E-mail met een schadelijke URL wordt als schadelijk beschouwd.|
...
|E-mail|Zapped phish <br>(E-mailberichten zijn bezorgd en vervolgens [gezap.)](zero-hour-auto-purge.md)|E-mail/cluster zacht verwijderen <p>Rapporten zijn beschikbaar om gezapde berichten weer te geven. [Kijk of ZAP een bericht en veelgestelde vragen heeft verplaatst.](zero-hour-auto-purge.md#how-to-see-if-zap-moved-your-message)|
...
|Gebruiker|E-mail doorsturen <br> (Regels voor het doorsturen van postvakken zijn geconfigureerd, die kunnen worden gebruikt voor gegevensverbestanding.)|Doorsturenregel verwijderen <p> Met [inzichten in de e-mailstroom,](mail-flow-insights-v2.md)waaronder het rapport Automatisch vooruitgestuurde berichten, kunt u specifiekere details over doorgestuurde e-mail bekijken. [](mfi-auto-forwarded-messages-report.md)|
...
|Gebruiker|Gegevens exfiltration <br> (Een gebruiker heeft DLP-beleidsregels voor e-mail of bestandsdeling [geschonden.)](https://docs.microsoft.com/microsoft-365/compliance/data-loss-prevention-policies)|Automatisch onderzoek heeft geen specifieke actie in behandeling. <p> [Bekijk DLP-rapporten en onderneemt actie.](https://docs.microsoft.com/microsoft-365/compliance/view-the-dlp-reports)|
