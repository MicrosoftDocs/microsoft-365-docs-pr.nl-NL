...
Bedreigingsbeveiligingsfuncties in [Microsoft Defender voor Office 365 bevatten](office-365-atp.md) bepaalde herstelacties. Dergelijke herstelacties kunnen bestaan uit:
...
|E-mail|Schadelijke URL<br/>(Er is een schadelijke URL gedetecteerd door [Veilige koppelingen](atp-safe-links.md).)|E-mail/cluster zacht verwijderen <br/>URL blokkeren (tijd-van-klikverificatie)<p> E-mail met een schadelijke URL wordt beschouwd als schadelijk.|
