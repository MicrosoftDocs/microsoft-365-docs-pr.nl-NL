...
> [!NOTE]
> Dit onderwerp is bedoeld voor Office 365-beheerders. Zie [Overzicht van het filter ongewenste e-mail](https://support.office.com/article/5ae3ea8e-cf41-4fa0-b02a-3b96e21de089) en ongewenste [e-mail en phishing](https://support.office.com/article/86c1d76f-4d5a-4967-9647-35665dc17c31)voor onderwerpen van eindgebruikers.

Als u een Office 365-klant bent met postvakken in Exchange Online of een zelfstandige Exchange Online Protection(EOP)-klant zonder Exchange Online-postvakken, worden uw e-mailberichten automatisch beveiligd tegen spam (ongewenste e-mail) door EOP.
...
- **Spoofinformatie:** zie Meer [informatie over spoofinformatie in Office 365](learn-about-spoof-intelligence.md)voor meer informatie.
...
- **Richt uw MX-record op Office 365:** Om EOP de beste bescherming te bieden, raden we u altijd aan om eerst e-mail naar Office 365 te laten bezorgen. Zie [DNS-records maken bij elke DNS-hostingprovider voor Office 365 voor](https://docs.microsoft.com/microsoft-365/admin/get-help-with-domains/create-dns-records-at-any-dns-hosting-provider)instructies.
...
- **Controleer de instellingen van het filterfilter voor ongewenste e-mail van de gebruiker:**
  ...
  Zie Instellingen voor ongewenste [e-mail configureren in Exchange Online-postvakken in Office 365](configure-junk-email-settings-on-exo-mailboxes.md)voor meer informatie over deze instellingen.

- **Lijsten met beschikbare veilige afzenders gebruiken:** zie [Lijsten met veilige afzenders maken in Office 365](create-safe-sender-lists-in-office-365.md)voor meer informatie.
