...
> [!TIP]
> De Backscatter.org website () raadt aan de service te gebruiken om inkomende e-mail te controleren in de Safe-modus in plaats van de modus Weigeren (grote e-mailservices sturen vrijwel altijd wat <http://www.backscatterer.org/?target=usage> backscatter).
