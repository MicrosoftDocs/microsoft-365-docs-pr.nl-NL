...
|---|---|---|
|**Communicatie compliance**|Machtigingen verlenen aan alle communicatie compliance rollen: beheerder, analist, aandurf, en viewer.|Case Management <p> Beheerder voor communicatie compliance <p> Communicatie compliance-analyse <p> Beheer van communicatie compliance-case management <p> Onderzoek naar communicatie compliance <p> Viewer voor communicatie compliance <p> Gegevensclassificatiefeedbackprovider <p> View-Only|
|**Beheerders voor communicatie compliance**|Beheerders van communicatie compliance die beleidsregels kunnen maken/bewerken en globale instellingen kunnen definiëren.|Beheerder voor communicatie compliance <p> Beheer van communicatie compliance-case management|
...
|**Medewerkers compliancebeheer**|Beoordelingen maken en werkzaamheden uitvoeren om verbeteringsacties te implementeren.|Bijdrage van Compliancemanager <p> Lezer voor Compliancebeheer|
|**Lezers van Compliancebeheer**|Alle inhoud van Compliancebeheer weergeven, behalve beheerdersfuncties.|Lezer voor Compliancebeheer|
...
|**Onderzoeker intern risicobeheer**|Gebruik deze groep om machtigingen toe te wijzen aan gebruikers die fungeren als insider-risicogegevens. Gebruikers in deze rollengroep hebben toegang tot alle waarschuwingen voor insider-risicobeheer, zaken, mededelingensjablonen en De Inhoudsverkenner voor alle gevallen.|Case Management <p> Onderzoek naar Insider-risicobeheer <p> View-Only|
...
|---|---|---|
|**Attack Simulator Admin**|Wordt gebruikt voor het maken en beheren van alle aspecten van campagnecampagnes voor aanvallen.||
...
|**Case Management**|Maak, bewerk, verwijder en beheer de toegang tot eDiscovery-zaken.|Communicatiecompliance <p> Communicatie compliance-eisen <p> Compliancebeheerder <p>eDiscovery-beheerder <p> Intern risicobeheer <p> Insider-beheerders van risicobeheer <p> Analist intern risicobeheer <p> Onderzoeker intern risicobeheer <p> Organisatiebeheer|
...
|**Communicatie compliance-analyse**|Wordt gebruikt voor het uitvoeren van onderzoek en herstel van de berichtovertredingen in de functie Communicatie compliance. Kan alleen metagegevens van berichten weergeven.|Communicatiecompliance <p> Communicatieve complianceanalisten <p> Communicatie compliance-eisen|
|**Beheer van communicatie compliance-case management**|Wordt gebruikt voor toegang tot communicatie compliance-zaken.|Communicatiecompliance <p> Beheerders voor communicatie compliance <p> Communicatieve complianceanalisten <p> Communicatie compliance-eisen <p> Viewers voor communicatie compliance|
|**Onderzoek naar communicatie compliance**|Wordt gebruikt voor het uitvoeren van onderzoek, herstellen en controleren van berichtovertredingen in de functie Communicatie compliance. Kan metagegevens en bericht van bericht weergeven.|Communicatiecompliance <p> Communicatie compliance-normen|
...
|**Bijdrage van Compliancemanager**|Beoordelingen maken en werkzaamheden uitvoeren om verbeteringsacties te implementeren.|Beheerders van Compliancebeheer <p> Assessors voor Compliancebeheer <p> Medewerkers compliancebeheer|
...
|**Gegevensclassificatiefeedbackprovider**|Hiermee kunt u feedback geven aan classificaties in Inhoudsverkenner.|Communicatiecompliance <p> Communicatie compliance-eisen <p> Compliancebeheerder|
...
|**Beheer van positie**|Machtigingen voor beheer van toegang tot Handmatig verwijderen in het & Compliancecentrum.|Compliancebeheerder <p> Beheerder van nalevingsgegevens <p> Recordbeheer|
...
|**Insider-analyse van risicobeheer**|Krijg toegang tot alle sjablonen voor insider-risicobeheer, meldingen en meldingen.|Intern risicobeheer <p> Analist intern risicobeheer|
...
|**Quarantaine**|Hiermee kunt u e-mail in quarantaine weergeven en vrijgeven.|Quarantainebeheerder <p> Beveiligingsbeheerder <p> Organisatiebeheer|
...
|**Beheerder van beoordeling door supervisor**|Beleidsregels van supervisors beheren, inclusief de communicatie die moet worden beoordeeld en wie de beoordeling moet doen.|Beoordeling door supervisor|
...
|**Auditlogboeken voor alleen-weergeven**|Controlerapporten weergeven en exporteren. Omdat deze rapporten gevoelige informatie kunnen bevatten, moet u deze rol alleen toewijzen aan personen die deze informatie expliciet willen bekijken.|Compliancebeheerder <p> Beheerder van nalevingsgegevens <p> Algemene lezer <p> Organisatiebeheer <p> Beveiligingsbeheerder <p> Beveiligingsoperator|
