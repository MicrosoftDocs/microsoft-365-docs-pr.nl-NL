...
Dit artikel bevat de belangrijkste aanbevelingen van het cyberbeveiligingsteam van Microsoft voor het implementeren van beveiligingsmogelijkheden om uw Microsoft 365 beschermen. Dit artikel is aangepast aan een Microsoft Ignite-sessie: Secure Microsoft 365 als een cyberbeveiligingsprof: Topprioriteiten voor de eerste [30 dagen, 90](https://www.youtube.com/watch?v=luignzNyR-o)dagen en daarna. Deze sessie is ontwikkeld en gepresenteerd door Mark Simos en Matt Kemelhar, Enterprise Cyberbeveiligingsarchitecten.
