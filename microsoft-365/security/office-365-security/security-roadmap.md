...
Deze roadmapaanbevelingen zijn in drie fasen in een logische volgorde gefaseerd met de volgende doelen.
...
|Meer|Pas belangrijke beleidsregels en besturingselementen aan en verfijn deze. <p> Beveiliging uitbreiden naar on-premises afhankelijkheden. <p> Integreer met bedrijfsprocessen en beveiligingsprocessen (juridisch, insider-bedreiging, enzovoort).|
|
