...
|Identiteits- en toegangsbeheer|* MFA in-en uitdwingen voor alle gebruikers. <br/> * Implementeer een set [voorwaardelijke toegang en gerelateerde beleidsregels](microsoft-365-policies-configurations.md). |
...
|Gegevensbescherming|Beleidsregels voor informatiebescherming verfijnen: <br/> * Microsoft 365 en Office 365-labels en preventie van gegevensverlies (DLP) of Azure Information Protection. <br/> * Beveiligingsbeleid en waarschuwingen voor Cloud apps.|
|
