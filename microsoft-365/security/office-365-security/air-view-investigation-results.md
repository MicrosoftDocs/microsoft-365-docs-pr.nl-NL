...
- Als u alle acties goedkeurt en/of weigert, kan het onderzoek volledig worden gesloten (de status wordt hersteld), terwijl sommige acties onvolledige resultaten in de status van het onderzoek veranderen in een gedeeltelijk herstelde status.
