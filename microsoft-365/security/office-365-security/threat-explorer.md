...
Stel dat u phishingpogingen via URL's in e-mail wilt zien, inclusief een lijst met URL's die zijn toegestaan, geblokkeerd en overschrijven. Als u URL's wilt identificeren waar op is geklikt, [moeten](atp-safe-links.md) veilige koppelingen zijn geconfigureerd. Zorg ervoor dat u beleidsregels voor [veilige koppelingen](set-up-atp-safe-links-policies.md) in te stellen voor time-of-click beveiliging en logboekregistratie van klik-vonnissen door Veilige koppelingen.
...
- [Schadelijke bestanden weergeven die zijn gedetecteerd in SharePoint Online, OneDrive en Microsoft Teams](./atp-for-spo-odb-and-teams.md)
...
- [Geautomatiseerd onderzoek en antwoord in Microsoft Threat Protection](../mtp/mtp-autoir.md)

## <a name="required-licenses-and-permissions"></a>Vereiste licenties en machtigingen

U moet [Microsoft Defender voor Office 365](office-365-atp.md) hebben om Explorer- of realtimedetecties te kunnen gebruiken.
