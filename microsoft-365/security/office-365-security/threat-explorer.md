...
Zie [Schadelijke e-mailberichten onderzoeken en herstellen die in Office 365 is bezorgd](investigate-malicious-email-that-was-delivered.md)voor meer discussie over het onderzoeken van schadelijke e-mailberichten.
...
3. Klik op **Afzender**en kies vervolgens**Basisdetectietechnologie** **Basic** > .
...
2. Kies**Phish** **e-mail** > en in het menu **Weergave** .

   ![Menu Weergeven voor Explorer](../../media/ExplorerViewEmailPhishMenu.png)

3. Klik **op Afzender**en kies **URL's** > **Klik op het vonnis**.

4. Selecteer een of meer opties, zoals **Geblokkeerd** en **Overschreven blokkeren,** en klik op de knop **Vernieuwen** die zich op dezelfde lijn bevindt als de opties om dat filter toe te passen. (Vernieuw uw browservenster niet.)
