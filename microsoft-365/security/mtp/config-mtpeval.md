...
8. Zorg ervoor dat de optie **Niet bijhouden wanneer gebruikers op** veilige koppelingen klikken niet is geselecteerd, terwijl de overige opties zijn geselecteerd. Zie [Instellingen voor veilige koppelingen](../office-365-security/recommended-settings-for-eop-and-office365-atp.md) voor meer informatie. Klik op **Opslaan**. 
...
Zie [Microsoft 365 Defender in- en in- en uit- zetten voor uitgebreidere richtlijnen.](mtp-enable.md) 
