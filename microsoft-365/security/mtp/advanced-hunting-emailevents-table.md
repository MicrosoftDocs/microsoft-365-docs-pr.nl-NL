...
| `EmailId` | tekenreeks | Unieke id voor e-mail en geadresseerde |
...
| `PhishFilterVerdict` | tekenreeks | Bij het filteren van e-mails wordt bepaald of de e-mail phish is: Phish of Not Phish |
...
| `UserLevelPolicy` | tekenreeks | Postvakbeleid voor eindgebruikers dat de actie heeft geactiveerd die wordt ondernomen op de e-mail |
