...
Technologieën voor [Microsoft Threat Protection](https://www.microsoft.com/security/business/threat-protection/integrated-threat-protection) leveren consequent hoge scores in onafhankelijke tests, waarbij de sterkte van de functies voor Enterprise Threat Protection wordt aangetoond. Microsoft streeft ernaar transparantie te hebben over deze testresultaten. Deze pagina bevat een overzicht van de resultaten en analyse.
...
- ATT&op basis van de handleiding op basis van de handleiding van december 2018: de [belangrijkste functies voor het detecteren en detecteren](https://www.microsoft.com/security/blog/2018/12/03/insights-from-the-mitre-attack-based-evaluation-of-windows-defender-atp/)van producten  |  [Analysis](https://techcommunity.microsoft.com/t5/Windows-Defender-ATP/MITRE-evaluation-highlights-industry-leading-EDR-capabilities-in/ba-p/369831)

    Microsoft Defender ATP beschikt uitgebreide aflevering van aanvals technieken gedurende de hele aanvals keten. Met hooglichten wordt de breedte van telemetrie, de sterkte van de bedreigings informatie en het Geavanceerd, automatisch detecteren, en de werking van de machine learning, heuristisch en de werking van het gedrag inbegrepen.
...
Meer [informatie over Microsoft Threat Protection](https://www.microsoft.com/security/business/threat-protection/integrated-threat-protection) of [de service gaan gebruiken](https://docs.microsoft.com/microsoft-365/security/mtp/mtp-enable).
