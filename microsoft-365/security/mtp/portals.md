...
|---|---|---| 
| Microsoft 365-beveiligingscentrum | Bewaak en reageer op de bedreigings activiteit en versteviging van beveiligings Posture alle identiteiten, e-mail, gegevens, eindpunten en apps met [Microsoft Threat Protection](microsoft-threat-protection.md) | [security.microsoft.com](https://security.microsoft.com/) |
| Microsoft Defender-Beveiligingscentrum | Bewaak en reageer op de bedreigings activiteit op uw eindpunten met de mogelijkheden van [Microsoft Defender ATP](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/microsoft-defender-advanced-threat-protection) | [securitycenter.windows.com](https://securitycenter.microsoft.com/) |
...
| Portal van Azure Security Center | [Azure-Beveiligingscentrum](https://docs.microsoft.com/azure/security-center/security-center-intro) gebruiken om de beveiligings Posture van uw datacenters en uw hybride werklasten te versterken in de Cloud | [portal.azure.com/#blade/Microsoft_Azure_Security](https://portal.azure.com/#blade/Microsoft_Azure_Security/SecurityMenuBlade/0) |
| Azure ATP-Portal | Detectie, detectie en onderzoek van geavanceerde bedreigingen, compromisloze identiteiten en schadelijke Insider-acties met behulp van Active Directory-signalen met [Azure ATP](https://docs.microsoft.com/azure-advanced-threat-protection/what-is-atp) | [portal.atp.azure.com](https://portal.atp.azure.com/) |
...
| Portal van Microsoft Defender Security Intelligence | Beveiligingsupdates voor Microsoft Defender ATP ontvangen, steekproeven verzenden en de bedreigings encyclopedie verkennen | [microsoft.com/wdsi](https://microsoft.com/wdsi) |
