...
>[!NOTE]
>In de recente release van Microsoft Secure Score is een verbeterd scoremodel uitgebracht dat Microsoft Secure Score tijdelijk onverenigbaar maakte met Identity Secure Score en de Graph API. [Details weergeven](microsoft-secure-score-preview.md#incompatibility-with-identity-secure-score-and-graph-api)
...
![Overzichtspagina van de beveiligde score ](../../media/secure-score/secure-score-homepage.png)
 *homepage figuur 1: Microsoft Secure Score*
