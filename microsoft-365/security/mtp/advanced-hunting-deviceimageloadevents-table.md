...
De `DeviceImageLoadEvents` tabel in het [geavanceerde jachtschema](advanced-hunting-overview.md) bevat informatie over DLL-laadgebeurtenissen. Gebruik deze verwijzing om query's te maken die informatie uit deze tabel retourneren.
