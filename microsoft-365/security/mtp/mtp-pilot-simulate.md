...
2. Controleer de configuratie van de domeincontroller voor testen:
   ...
   - Controleer of [Microsoft Defender voor Microsoft Cloud-beveiliging](https://docs.microsoft.com/cloud-app-security/mdi-integration) is ingeschakeld.
...
## <a name="run-the-attack-scenario-simulation"></a>De simulatie scenario van aanval uitvoeren
...
#### <a name="alert-suspicious-process-injection-observed-source-microsoft-defender-for-endpoint-edr"></a>Waarschuwing: verdacht verdacht proces injectie (Bron: Microsoft Defender voor eindpunt EDR)
...
#### <a name="alert-unexpected-behavior-observed-by-a-process-run-with-no-command-line-arguments-source-microsoft-defender-for-endpoint-edr"></a>Waarschuwing: het onverwachte gedrag van een proces wordt uitgevoerd met geen opdrachtregelargumenten (Bron: Microsoft Defender voor eindpunt EDR)
...
#### <a name="alert-user-and-ip-address-reconnaissance-smb-source-microsoft-defender-for-identity"></a>Waarschuwing: gebruikers-en IP-adres Reconnaissance (SMB) (Bron: Microsoft Defender for Identity)
