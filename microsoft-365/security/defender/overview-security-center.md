...
---
# <a name="the-unified-microsoft-365-security-center-overview"></a>Het overzicht van Microsoft 365 beveiligingscentrum
...
Het verbeterde **Microsoft 365 beveiligingscentrum** () combineert beveiliging, detectie, onderzoek en antwoord op e-mail, samenwerking, identiteit [https://security.microsoft.com](https://security.microsoft.com) *en*  *apparaatbedreigingen* in een centrale portal. 
...
Zie incidenten in het Microsoft 365 [beveiligingscentrum voor meer informatie.](incidents-overview.md)
...
![Machtigingen & pagina Rollen met eindpunten & groepen, rollen en apparaatgroepen.](../../media/converged-roles-5.png)
 ...
 Access the Microsoft 365 security center is configured with Azure Active Directory global roles or using custom roles. Zie Gebruikerstoegang toewijzen aan [Microsoft Defender-beveiligingscentrum.](/microsoft-365/security/defender-endpoint/assign-portal-access) Zie Machtigingen in Microsoft 365 compliancecentrum en Microsoft 365 beveiligingscentrum voor Defender [voor Office 365.](../office-365-security/permissions-microsoft-365-compliance-security.md)

- Meer informatie over het beheren [van toegang tot](m365d-permissions.md) Microsoft 365 Defender
- Meer informatie over het maken [van aangepaste rollen](custom-roles.md) in Microsoft 365 beveiligingscentrum
...
Het Microsoft 365-beveiligingscentrum bevat een leerhub die officiële richtlijnen opsneert van bronnen zoals de Microsoft-beveiligingsblog, de Microsoft-beveiligingscommunity op YouTube en de officiële documentatie op docs.microsoft.com.
...
> [!TIP]
> Er zijn veel andere leermogelijkheden in [Microsoft Learn.](https://docs.microsoft.com/e/learn/) U vindt certificeringstraining zoals [Cursus MS-500T02-A: Implementatie van](https://docs.microsoft.com/learn/certifications/courses/ms-500t02)Microsoft 365 Threat Protection .
...
3. U hebt twee opties:
    1. Schuif omlaag naar het tekstvak Hoe kunnen we de naleving verbeteren of uw gebruikers beter beschermen *in Office 365?* en plakken in *Microsoft 365 beveiligingscentrum.* U kunt in de resultaten zoeken naar een idee zoals dat van u en het idee up-vote of de knop gebruiken voor **Een nieuw idee posten.**
    1. Als u zeker weet dat dit probleem al is gerapporteerd en het profiel wilt verhogen met een stem (of stemmen), gebruikt u het vak *Feedback* geven aan de rechterkant van UserVoice. Zoek naar *Microsoft 365 beveiligingscentrum,* zoek het probleem en gebruik de **stemknop** om de status te verhogen.
...
Blijf de functies en mogelijkheden in het Microsoft 365 verkennen:
