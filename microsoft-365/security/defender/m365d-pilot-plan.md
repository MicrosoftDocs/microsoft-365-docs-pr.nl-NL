...
>[!NOTE]
>Als u nog niet over de volledige licenties hebt, kunt u proeflicenties krijgen om [Microsoft 365 Defender](m365d-evaluation.md?ocid=cx-docs-MTPtriallab) te evalueren: plannen, voorbereiden, instellen, configureren en uitvoeren van uw pilotproject. Uw belanghebbenden spelen een grote rol bij het vergemakkelijken van het proces van begin tot einde.
...
|![Voorbereidingsfase](../../media/mtp/prep.png) <br>[Voorbereidingsfase](prepare-m365d-eval.md) | Uw Microsoft 365 Defender-testomgeving voorbereiden
|:-------|:-----|
