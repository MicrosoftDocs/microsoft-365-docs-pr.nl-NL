...
In de onderstaande tabel vindt u de wijzigingen in het navigatieverkeer tussen & compliancecentrum en Microsoft 365 Defender.

<br>

****

|[Beveiligings- en compliancecentrum](https://protection.office.com)|[Microsoft 365 Defender](https://security.microsoft.com)|[Microsoft 365-compliancecentrum](https://compliance.microsoft.com/homepage)|[Exchange-beheercentrum](https://admin.exchange.microsoft.com)|
|---|---|---|---|
...
[Microsoft 365 Defender](./overview-security-center.md) bij <https://security.microsoft.com> combineert beveiligingsmogelijkheden van bestaande Microsoft-beveiligingsportalen, waaronder het Beveiligings- & Compliancecentrum. Dit verbeterde centrum helpt beveiligingsteams hun organisatie doeltreffender en efficiënter beschermen tegen bedreigingen.

Als u bekend bent met het & Compliance Center (protection.office.com), worden in dit artikel enkele wijzigingen en verbeteringen in Microsoft 365 Defender.
...
Traceer en onderzoek dreigingen op e-mails van gebruikers, traceer campagnes en meer. Als u het Beveiligings- en compliancecentrum & gebruikt, is dit bekend.
...
> Voor Defender voor Office 365 gebruikers kunt  u DKIM-toetsen nu beheren en draaien via Microsoft 365 Defender: of naar Beleidsregels & regels Bedreigingsbeleidsregels sectie <https://security.microsoft.com/threatpolicy>  \>  \> \>  \> **DKIM**.
>
...
Ook is er een koppeling opgenomen naar het **Beveiligings- & compliancecentrum ter** vergelijking. De laatste snelkoppeling is naar de pagina **Nieuw**, die recente updates beschrijft.

## <a name="related-information"></a>Gerelateerde informatie

- [Beveiligings- & compliancecentrum omleiden naar Microsoft 365 Defender](microsoft-365-security-mdo-redirection.md)
