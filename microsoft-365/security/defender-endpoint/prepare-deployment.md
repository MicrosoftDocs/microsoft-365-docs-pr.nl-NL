...
Microsoft raadt [gebruikers](https://docs.microsoft.com/azure/active-directory/active-directory-privileged-identity-management-configure) aan Privileged Identity Management te gebruiken om uw rollen te beheren voor extra controle, controle en toegangscontrole voor gebruikers met adreslijstmachtigingen.
...
![Fase 2: Instellen](images/setup.png) <br>[Fase 2: Installatie](production-deployment.md) | Microsoft Defender instellen voor endpoint-implementatie
