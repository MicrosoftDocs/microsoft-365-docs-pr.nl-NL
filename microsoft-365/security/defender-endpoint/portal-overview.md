...
:---|:---
![PICTOGRAM ATP-logo](images/atp-logo-icon.png)| Microsoft Defender voor endpoint-logo
![Pictogram Waarschuwing](images/alert-icon.png)| Waarschuwing: een indicatie van een activiteit die is gerelateerd aan geavanceerde aanvallen.
![Pictogram Detectie](images/detection-icon.png)| Detectie: een indicatie van een detectie van malwaredreigingen.
![Pictogram Actieve bedreiging](images/active-threat-icon.png)| Actieve bedreiging: bedreigingen die actief worden uitgevoerd op het moment van detectie.
![Pictogram herstelt1](images/remediated-icon.png)| Gesaneerd: bedreiging verwijderd van het apparaat.
...
![Pictogram Waargenomen gebeurtenissen in bestand](images/atp-file-observed-icon.png)| Bestandsgebeurtenissen
![Pictogram Registergebeurtenissen](images/atp-registry-event-icon.png)| Registergebeurtenissen
![Pictogram DLL-gebeurtenissen module laden](images/atp-module-load-icon.png)| DLL-gebeurtenissen laden
![Pictogram Andere gebeurtenissen](images/atp-Other-events-icon.png)| Andere gebeurtenissen
![Pictogram voor wijziging van Access-token](images/atp-access-token-modification-icon.png)| Wijziging van Access-token
![Pictogram Voor het maken van bestanden](images/atp-file-creation-icon.png)| Bestandscreatie
![Pictogram Ondertekenaar](images/atp-signer-icon.png)| Ondertekenaar
![Pictogram Bestandspad](images/atp-File-path-icon.png)| Bestandspad
![Pictogram Opdrachtregel](images/atp-command-line-icon.png)| Opdrachtregel
![Pictogram Niet-ondertekend bestand](images/atp-unsigned-file-icon.png)| Niet-ondertekend bestand
![Pictogram Processtructuur](images/atp-process-tree.png)| Processtructuur
![Pictogram Geheugentoewijzing](images/atp-memory-allocation-icon.png)| Geheugentoewijzing
![Pictogram Voor procesinjectie](images/atp-process-injection.png)| Procesinjectie
![Pictogram PowerShell-opdracht uitvoeren](images/atp-powershell-command-run-icon.png)| Powershell-opdracht uitvoeren
![Pictogram Communitycentrum](images/atp-community-center.png) | Communitycentrum
![Pictogram Meldingen](images/atp-notifications.png) | Meldingen
![Geen bedreigingen gevonden](images/no-threats-found.png) | Geautomatiseerd onderzoek: er zijn geen bedreigingen gevonden
![Pictogram Mislukt](images/failed.png) | Geautomatiseerd onderzoek - mislukt
![Pictogram Gedeeltelijk herstelt](images/partially-investigated.png) | Geautomatiseerd onderzoek - gedeeltelijk onderzocht
![Beëindigd door systeem](images/terminated-by-system.png) | Geautomatiseerd onderzoek - beëindigd per systeem
![Pictogram In behandeling](images/pending.png) | Geautomatiseerd onderzoek - in behandeling
![Pictogram Uitvoeren](images/running.png) | Geautomatiseerd onderzoek - uitgevoerd
![Pictogram herstelt2](images/remediated.png) | Geautomatiseerd onderzoek - gesaneerd
![Pictogram gedeeltelijk onderzocht](images/partially_remediated.png) | Geautomatiseerd onderzoek - gedeeltelijk gesaneerd
![Pictogram Bedreigingsinzichten](images/tvm_bug_icon.png) | Threat & Vulnerability Management - threat insights
![Pictogram Mogelijke actieve waarschuwing](images/tvm_alert_icon.png) | Threat & Vulnerability Management - mogelijke actieve waarschuwing
![Pictogram Aanbevelingen](images/tvm_insight_icon.png) | Threat & Vulnerability Management - recommendation insights
