...
---
# <a name="troubleshoot-subscription-and-portal-access-issues"></a>Problemen met abonnement en portaltoegang oplossen
...
Als u een foutbericht ontvangt, Microsoft Defender-beveiligingscentrum een gedetailleerde uitleg over het probleem en worden relevante koppelingen verstrekt.

## <a name="no-subscriptions-found"></a>Geen abonnementen gevonden

Als u tijdens het openen van  Microsoft Defender-beveiligingscentrum het bericht Geen abonnementen hebt gevonden, betekent dit dat de Azure Active Directory (Azure AD) die wordt gebruikt om zich aan te melden bij de gebruiker bij de portal, geen Microsoft Defender voor Eindpunt-licentie heeft.
...
- De licentie is aangeschaft, maar niet ingericht voor dit Azure AD-exemplaar.
    ...
    - Het kan zijn dat u de licentie per ongeluk hebt ingericht op een ander Microsoft Azure AD dan de licentie die voor verificatie in de service wordt gebruikt.
...
Als u tijdens het openen Microsoft Defender-beveiligingscentrum uw **abonnement** is verlopen, is uw onlineserviceabonnement verlopen. Microsoft Defender for Endpoint-abonnement heeft, net als elk ander onlineserviceabonnement, een vervaldatum. 
...
Zie Gebruikerstoegang toewijzen [**aan de portal voor meer informatie.**](/windows/threat-protection/windows-defender-atp/assign-portal-access-windows-defender-advanced-threat-protection)
