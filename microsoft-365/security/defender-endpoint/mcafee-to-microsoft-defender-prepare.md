...
Welkom bij de fase Voorbereiden van migratie van **[McAfee Endpoint Security (McAfee) naar Defender for Endpoint](mcafee-to-microsoft-defender-migration.md#the-migration-process)**. 
...
- [Technisch artikel van het McAfee Knowledge Center: Windows-beveiliging center meldt af en toe onjuist dat Endpoint-beveiliging is uitgeschakeld wanneer deze wordt uitgevoerd op Windows 10](https://kc.mcafee.com/corporate/index?page=content&id=KB91830) 

- [McAfee Knowledge Center Technical Article: Windows-beveiliging Center reports Endpoint Security is disabled when Endpoint Security is running](https://kc.mcafee.com/corporate/index?page=content&id=KB91428)
...
**Gefeliciteerd!** U hebt de fase **Voorbereiden** van de [migratie van McAfee naar Defender voor Eindpunt voltooid!](mcafee-to-microsoft-defender-migration.md#the-migration-process)

- [Ga verder met het instellen van Defender voor Eindpunt](mcafee-to-microsoft-defender-setup.md).
