...
---
# <a name="access-the-microsoft-defender-for-endpoint-apis"></a>Toegang tot de API's van Microsoft Defender voor eindpunten 
...
- **Toepassingscontext: (Aanbevolen)** <br>
  ...
  5. Het token gebruiken om toegang te krijgen tot De ATP-API van Microsoft Defender
...
- **Gebruikerscontext:** <br>
  ...
  4. Het token gebruiken om toegang te krijgen tot De ATP-API van Microsoft Defender
