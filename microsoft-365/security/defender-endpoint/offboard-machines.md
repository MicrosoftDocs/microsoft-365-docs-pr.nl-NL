...
> Bovendien worden apparaten die niet actief zijn in de afgelopen 30 dagen, niet meegegegevens verwerkt [](tvm-exposure-score.md) die de Threat and Vulnerability Management blootstellingsscore van uw organisatie en Microsoft Secure Score voor apparaten weerspiegelen. <br>
...
- [Niet-offboard-Windows apparaten](configure-endpoints-non-windows.md#offboard-non-windows-devices)
