...
Het volgende geleidelijke uitrolmodel wordt gevolgd voor maandelijkse Defender-updates:
...
U kunt ook een computer toewijzen aan een kanaal om de cadans te definiëren waarin het dagelijks definitie-updates ontvangt. In tegenstelling tot het maandelijkse proces is er geen bètakanaal en vindt deze geleidelijke releasecyclus meerdere keren per dag plaats.
