...
>[!IMPORTANT]
> - Deze antwoordacties zijn alleen beschikbaar voor apparaten in Windows 10, versie 1703 of hoger. 
...
| Processen| Bevat een . CSV-bestand met de lopende processen, waarmee u de huidige processen kunt identificeren die op het apparaat worden uitgevoerd. Dit kan handig zijn bij het identificeren van een verdacht proces en de status ervan.                                                                                                                                                                                                       |
| Geplande taken| Bevat een . CSV-bestand met de geplande taken, die kunnen worden gebruikt om routines te identificeren die automatisch worden uitgevoerd op een gekozen apparaat om te zoeken naar verdachte code die is ingesteld om automatisch te worden uitgevoerd.                                                                                                                                                                                                      |
...
| Services| Bevat een . CSV-bestand met services en hun staten.                                                                                      |
...
| Systeemgegevens| Bevat een SystemInformation.txt met systeemgegevens, zoals versie van het besturingssysteem en netwerkkaarten.                                                                                     |
...
## <a name="run-microsoft-defender-antivirus-scan-on-devices"></a>Microsoft Defender Antivirus scan uitvoeren op apparaten
...
>- Een Microsoft Defender Antivirus -scan (Microsoft Defender AV) kan naast andere antivirusoplossingen worden uitgevoerd, ongeacht of Microsoft Defender AV de actieve antivirusoplossing is of niet. Microsoft Defender AV kan in de passieve modus staan. Zie Compatibiliteit met Microsoft Defender Antivirus voor meer [informatie.](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-antivirus/microsoft-defender-antivirus-compatibility.md)
...
> - Deze actie moet voldoen aan de codeintegriteitsbeleidsindelingen en -ondertekeningsvereisten voor Windows Defender Application Control. Zie Code [integrity policy formats and signing (Code integrity policy formats and signing) voor meer informatie.](https://docs.microsoft.com/windows/device-security/device-guard/requirements-and-deployment-planning-guidelines-for-device-guard#code-integrity-policy-formats-and-signing)
...
>[!IMPORTANT]
>- Volledige isolatie is beschikbaar voor apparaten in Windows 10, versie 1703.
>- Selectieve isolatie is beschikbaar voor apparaten in Windows 10, versie 1709 of hoger.
...
In Windows 10, versie 1709 of hoger hebt u extra controle over het isolatieniveau van het netwerk. U kunt er ook voor kiezen om Outlook, Microsoft Teams en Skype voor Bedrijven-connectiviteit in te stellen (ook wel 'Selectief isolement' genoemd).
...
>[!NOTE]
>Het apparaat blijft verbonden met de Defender for Endpoint-service, zelfs als het is geïsoleerd van het netwerk. Als u ervoor hebt gekozen outlook- en Skype voor Bedrijven-communicatie in te stellen, kunt u communiceren met de gebruiker terwijl het apparaat is geïsoleerd.
