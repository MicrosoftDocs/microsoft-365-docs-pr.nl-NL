...
---
# <a name="schedule-an-update-of-the-microsoft-defender-for-endpoint-linux"></a>Een update van het Microsoft Defender for Endpoint (Linux) plannen

Zie Updates implementeren voor Microsoft Defender voor Endpoint voor Linux als u een update wilt uitvoeren op Microsoft Defender [voor Endpoint voor Linux.](https://docs.microsoft.com/microsoft-365/security/defender-endpoint/linux-updates)
