...
Een van de volgende machtigingen is vereist om deze API te bellen. Zie Microsoft Defender ATP API's gebruiken voor meer informatie, inclusief het kiezen van [machtigingen.](apis-intro.md)
