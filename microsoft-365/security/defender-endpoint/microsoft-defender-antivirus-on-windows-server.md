...
|De **AUOptions-registersleutel**     |Met de volgende twee waarden Windows Update automatisch beveiligingsinformatieupdates downloaden en installeren: <br/>- **4**  -  **Updates automatisch installeren.** Deze waarde resulteert in het automatisch installeren van alle updates, Windows Defender beveiligingsinformatieupdates. <br/>- **3**  -  **Download updates, maar laat me kiezen of ik ze wil installeren.**  Met deze waarde Windows Defender automatisch beveiligingsinformatie-updates downloaden en installeren, maar andere updates worden niet automatisch geïnstalleerd.         |
...
### <a name="set-microsoft-defender-antivirus-to-passive-mode-using-powershell"></a>Instellen Microsoft Defender Antivirus passieve modus met PowerShell

Als u Windows Server, versie 1803 of Windows Server 2019 gebruikt, kunt u Microsoft Defender Antivirus instellen op passieve modus met de volgende PowerShell-cmdlet:

`CMDLET NEEDED`

### <a name="set-microsoft-defender-antivirus-to-passive-mode-using-group-policy"></a>De Microsoft Defender Antivirus op passieve modus instellen met groepsbeleid
