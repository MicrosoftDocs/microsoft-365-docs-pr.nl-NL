...
**Welkom bij de installatiefase van [de migratie van Symantec naar Defender for Endpoint.](symantec-to-microsoft-defender-endpoint-migration.md#the-migration-process)** Deze fase bevat de volgende stappen:
...
3. [Voeg Microsoft Defender voor Eindpunt toe aan de uitsluitingslijst voor Symantec.](#add-microsoft-defender-for-endpoint-to-the-exclusion-list-for-symantec)

4. [Voeg Symantec toe aan de uitsluitingslijst voor Microsoft Defender Antivirus.](#add-symantec-to-the-exclusion-list-for-microsoft-defender-antivirus)
...
- DisableAntiSpyware instellen op onwaar op Windows Server (alleen indien nodig)

- Opnieuw Microsoft Defender Antivirus op Windows Server

- De Microsoft Defender Antivirus op passieve modus instellen op Windows Server

### <a name="set-disableantispyware-to-false-on-windows-server"></a>DisableAntiSpyware instellen op onwaar op Windows Server

De registersleutel DisableAntiSpyware is in het verleden gebruikt om Microsoft Defender Antivirus uit te schakelen en een ander antivirusproduct, Symantec, te implementeren. Over het algemeen moet u deze registersleutel niet op uw Windows apparaten en eindpunten hebben. Als u echter wel hebt geconfigureerd, kunt u als volgende de waarde instellen `DisableAntiSpyware` op onwaar:
...
|[Geavanceerd groepsbeleidsbeheer](/microsoft-desktop-optimization-pack/agpm/) <br/>of<br/>[Groepsbeleidsbeheerconsole](/windows/security/threat-protection/microsoft-defender-antivirus/use-group-policy-microsoft-defender-antivirus)  |1. Ga naar `Computer configuration > Administrative templates > Windows components > Microsoft Defender Antivirus` . <p>2. Zoek naar een beleid met de naam **Uitschakelen Microsoft Defender Antivirus.**<p>3. Kies **Beleidsinstelling bewerken** en zorg ervoor dat beleid is uitgeschakeld. Hiermee kunt u Microsoft Defender Antivirus. <p>**OPMERKING:** Mogelijk ziet *u* Windows Defender Antivirus in plaats van *Microsoft Defender Antivirus* in sommige versies van Windows. |
...
**Gefeliciteerd!** U hebt de installatiefase van de migratie van Symantec naar [Defender voor Eindpunt voltooid!](symantec-to-microsoft-defender-endpoint-migration.md#the-migration-process)
- [Doorgaan naar fase 3: Onboard to Defender for Endpoint](symantec-to-microsoft-defender-atp-onboard.md)
