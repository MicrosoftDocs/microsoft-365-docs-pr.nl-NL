...
### <a name="blocking-urls-with-microsoft-defender-smartscreen"></a>URL's blokkeren met Microsoft Defender SmartScreen
...
De mogelijk ongewenste beveiligingsfunctie voor toepassingen (PUA) in Microsoft Defender Antivirus kan PUA's detecteren en blokkeren op eindpunten in uw netwerk.
...
## <a name="view-pua-events"></a>PUA-gebeurtenissen weergeven
