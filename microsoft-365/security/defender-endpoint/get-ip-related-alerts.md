...
---
# <a name="get-ip-related-alerts-api"></a>IP-gerelateerde waarschuwingen-API krijgen
...
Hiermee wordt een verzameling waarschuwingen opgehaald die betrekking hebben op een bepaald IP-adres.
...
Als dit is gelukt en IP bestaat- [](alerts.md) 200 OK met een lijst met waarschuwingsentiteiten in de body. Als IP niet bestaat- 404 Niet gevonden.
