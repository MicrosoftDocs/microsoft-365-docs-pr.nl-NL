...
---
# <a name="get-alert-related-machine-information-api"></a>Api voor waarschuwingsgerelateerde computergegevens
...
Hiermee wordt [apparaat opgehaald](machine.md) dat is gerelateerd aan een specifieke waarschuwing.
...
:---|:---|:---
Toepassing |   Machine.Read.All |  'Alle computergegevens lezen'
...
Als dit is gelukt en een waarschuwing en een apparaat aanwezig zijn, is dit 200 OK. Als een waarschuwing niet is gevonden of het apparaat niet is gevonden- 404 Niet gevonden.
