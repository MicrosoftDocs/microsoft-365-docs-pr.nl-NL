...
[Beoordelingsmethoden en -eigenschappen per apparaat exporteren](get-assessment-methods-properties.md) | Voer API-oproepen uit om kwetsbaarheidsbeoordelingen per apparaat te verzamelen, zoals: veilige configuratiebeoordeling exporteren, beoordeling van de softwarevoorraad exporteren, beoordeling van beveiligingsproblemen met software exporteren en evaluatie van \- delta-exportsoftwareproblemen.
