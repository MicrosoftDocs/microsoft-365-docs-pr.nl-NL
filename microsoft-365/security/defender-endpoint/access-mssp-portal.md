...
---
# <a name="access-the-microsoft-defender-security-center-mssp-customer-portal"></a>Toegang tot de MICROSOFT Defender Security Center MSSP-klantportal
...
MsSP-klanten hebben standaard toegang tot hun Microsoft Defender Security Center-tenant via de volgende URL: `https://securitycenter.windows.com` .
