...
---
# <a name="get-file-information-api"></a>Api voor bestandsgegevens downloaden
...
Haalt een bestand [op id](files.md) Sha1 of Sha256 op
...
:---|:---|:---
Toepassing |   File.Read.All | 'Alle bestandsprofielen lezen'
Gedelegeerd (werk- of schoolaccount) | File.Read.All |    'Alle bestandsprofielen lezen'
...
Als dit is gelukt en het bestand bestaat: 200 OK met [de bestandsentiteit](files.md) in de body. Als bestand niet bestaat- 404 Niet gevonden.
