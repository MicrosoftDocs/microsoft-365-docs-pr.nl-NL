...
Zie OData V4-query's als u niet bekend bent met [OData-query's](https://www.odata.org/documentation/)
...
Alle waarschuwingen voor het laatst bijgewerkt na 2019-11-22 00:00:00:
...
Haal alle apparaten op met 'High' 'RiskScore':
...
Top 100 apparaten met 'HealthStatus' is niet gelijk aan 'Actief':
...
Haal alle apparaten op die het laatst zijn gezien na 2018-10-20:
...
Alle antivirusscans die de gebruiker Analyst@examples.onmicrosoft.com gemaakt met Microsoft Defender voor eindpunt:
...
Krijg het aantal geopende waarschuwingen voor een specifiek apparaat:
...
Alle apparaten met 'computerDnsName' krijgen, beginnend met 'mymachine':
