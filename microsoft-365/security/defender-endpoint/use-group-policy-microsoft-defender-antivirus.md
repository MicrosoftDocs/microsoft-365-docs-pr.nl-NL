...
U kunt [groepsbeleid gebruiken om](/windows/win32/srvnodes/group-policy) Microsoft Defender Antivirus op uw eindpunten te configureren en te beheren.

In het algemeen kunt u de volgende procedure gebruiken om de beleidsinstellingen van de Microsoft Defender Antivirus-groep te configureren of te wijzigen:
...
4. Vouw de boom uit naar **Windows-onderdelen**  >  **Microsoft Defender Antivirus.**
...
|:---|:---|:---|
| Clientinterface | Gebruikersinterface zonder hoofd inschakelen | [Voorkomen dat gebruikers de gebruikersinterface van Microsoft Defender Antivirus kunnen zien of gebruiken](prevent-end-user-interaction-microsoft-defender-antivirus.md) |
...
| Quarantaine | Het verwijderen van items configureren uit de map Quarantaine | [Herstel configureren voor Antivirusscans van Microsoft Defender](configure-remediation-microsoft-defender-antivirus.md) |
...
| Realtime beveiliging | De maximale grootte definiëren van gedownloade bestanden en bijlagen die moeten worden gescand | [Microsoft Defender Antivirus always-on beveiliging en monitoring inschakelen en configureren](configure-real-time-protection-microsoft-defender-antivirus.md) |
| Realtime beveiliging | Bestands- en programmaactiviteit op uw computer controleren | [Microsoft Defender Antivirus always-on beveiliging en monitoring inschakelen en configureren](configure-real-time-protection-microsoft-defender-antivirus.md) |
| Realtime beveiliging | Alle gedownloade bestanden en bijlagen scannen | [Microsoft Defender Antivirus always-on beveiliging en monitoring inschakelen en configureren](configure-real-time-protection-microsoft-defender-antivirus.md) |
| Realtime beveiliging | Realtime beveiliging uitschakelen | [Microsoft Defender Antivirus always-on beveiliging en monitoring inschakelen en configureren](configure-real-time-protection-microsoft-defender-antivirus.md) |
| Realtime beveiliging | Gedragscontrole in- en uit- | [Microsoft Defender Antivirus always-on beveiliging en monitoring inschakelen en configureren](configure-real-time-protection-microsoft-defender-antivirus.md) |
| Realtime beveiliging | Processcans inschakelen wanneer realtimebeveiliging is ingeschakeld | [Microsoft Defender Antivirus always-on beveiliging en monitoring inschakelen en configureren](configure-real-time-protection-microsoft-defender-antivirus.md) |
| Realtime beveiliging | Onbewerkte schrijfmeldingen voor volume in- en uit- | [Microsoft Defender Antivirus always-on beveiliging en monitoring inschakelen en configureren](configure-real-time-protection-microsoft-defender-antivirus.md) |
| Realtime beveiliging | Monitoring configureren voor inkomende en uitgaande bestands- en programmaactiviteit | [Microsoft Defender Antivirus always-on beveiliging en monitoring inschakelen en configureren](configure-real-time-protection-microsoft-defender-antivirus.md) |
...
| Herstellen | Geef de dag van de week op om een geplande volledige scan uit te voeren om herstel te voltooien | [Geplande Microsoft Defender Antivirus-scans configureren](scheduled-catch-up-scans-microsoft-defender-antivirus.md) |
...
| Scannen | Een systeemherstelpunt maken | [Herstel configureren voor Antivirusscans van Microsoft Defender](configure-remediation-microsoft-defender-antivirus.md) |
| Scannen | Het verwijderen van items uit de map scangeschiedenis in- | [Herstel configureren voor Antivirusscans van Microsoft Defender](configure-remediation-microsoft-defender-antivirus.md) |
| Scannen | Heuristiek in- en uit- | [Microsoft Defender Antivirus always-on beveiliging en monitoring inschakelen en configureren](configure-real-time-protection-microsoft-defender-antivirus.md) |
...
| Bedreigingen | Waarschuwingsniveaus opgeven waarop standaardactie niet moet worden ondernomen wanneer deze wordt gedetecteerd | [Herstel configureren voor Antivirusscans van Microsoft Defender](configure-remediation-microsoft-defender-antivirus.md) |
| Bedreigingen | Geef bedreigingen op waarop standaardactie niet moet worden ondernomen wanneer deze worden gedetecteerd | [Herstel configureren voor Antivirusscans van Microsoft Defender](configure-remediation-microsoft-defender-antivirus.md) |
