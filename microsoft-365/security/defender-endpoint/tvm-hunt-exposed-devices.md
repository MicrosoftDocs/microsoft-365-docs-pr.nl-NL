...
---
# <a name="hunt-for-exposed-devices---threat-and-vulnerability-management"></a>Zoeken naar blootgestelde apparaten - Threat and Vulnerability Management
...
- [DeviceTvmSecureConfigurationAssessment - Bedreigings-](advanced-hunting-devicetvmsecureconfigurationassessment-table.md) en vulnerability management evaluatiegebeurtenissen, waarmee de status van verschillende beveiligingsconfiguraties op apparaten wordt aangegeven.
...
1. Ga naar **Geavanceerd zoeken** vanuit het linkernavigatiedeelvenster van de Microsoft Defender-beveiligingscentrum.
...
- [Gegevenstoegang configureren voor Threat and Vulnerability Management rollen](user-roles.md#create-roles-and-assign-the-role-to-an-azure-active-directory-group)
