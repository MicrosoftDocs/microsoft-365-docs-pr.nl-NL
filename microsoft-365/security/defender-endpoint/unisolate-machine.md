...
---
# <a name="release-device-from-isolation-api"></a>Apparaat los laten van isolement-API
...
De isolatie van een apparaat ongedaan maken.
...
- Zie Apparaat isoleren als u een apparaat [wilt isoleren.](isolate-machine.md)
