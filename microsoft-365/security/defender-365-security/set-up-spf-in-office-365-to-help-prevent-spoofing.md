...
Het doel van de e-mailverificatie van [DKIM](https://docs.microsoft.com/microsoft-365/security/defender-365-security/use-dkim-to-validate-outbound-email?view=o365-worldwide) is bewijzen dat er niet met de inhoud van het e-mailbericht is geknoeid.

Het doel van de e-mailverificatie van [DMARC](https://docs.microsoft.com/microsoft-365/security/defender-365-security/use-dmarc-to-validate-email?view=o365-worldwide) is ervoor te zorgen dat SPF- en DKIM-gegevens overeenkomen met het Van-adres.
