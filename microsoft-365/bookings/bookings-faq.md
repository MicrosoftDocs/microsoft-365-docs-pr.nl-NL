...
### <a name="is-bookings-customizable"></a>Is Bookings aanpasbaar?
...
### <a name="where-do-bookings-calendars-show-up-in-my-microsoft-365-tenant"></a>Waar worden Bookings-agenda's in mijn Microsoft 365-tenant gevonden?**
...
### <a name="if-i-create-a-calendar-and-someone-else-has-access-to-bookings-would-they-be-able-to-see-my-calendar"></a>Als ik een agenda maak en iemand anders toegang heeft tot Bookings, kunnen ze dan mijn agenda zien?
...
### <a name="can-email-notifications-be-sent-as-the-tenant-domain-name"></a>Kunnen e-mailmeldingen worden verzonden als de tenantdomeinnaam?
...
### <a name="how-can-bookings-appointments-show-up-on-a-persons-calendar"></a>Hoe kunnen bookings-afspraken in de agenda van een persoon worden gemaakt?
...
### <a name="what-triggers-service-provider-or-staff-and-customer-emails"></a>Wat triggers serviceprovider of personeel en e-mailberichten van klanten?
...
### <a name="can-i-book-classroom-style-appointments-that-are-1many-instead-of-11"></a>Kan ik afspraken in klasstijl boeken die 1:veel zijn in plaats van 1:1?
...
### <a name="can-calendars-remain-unpublished-not-public-facing-but-still-accessible-to-designated-users"></a>Kunnen agenda's niet worden gepubliceerd (niet openbaar), maar toch toegankelijk voor aangewezen gebruikers?
...
### <a name="can-bookings-calendars-be-cloned-or-duplicated-and-can-they-be-templatized-for-easy-scaling"></a>Kunnen Bookings-agenda's worden gekloond of gedupliceerd en kunnen ze worden templatized voor eenvoudige schaalbaarheid?
...
### <a name="is-it-possible-to-share-only-one-service-on-the-self-service-page-at-a-time"></a>Is het mogelijk om slechts één service tegelijk te delen op de pagina Selfservice?
...
### <a name="what-options-are-available-for-embedding-a-consent-form-or-disclosure-for-those-booking-an-appointment"></a>Welke opties zijn beschikbaar voor het insluiten van een toestemmingsformulier of openbaarmaking voor degenen die een afspraak boeken?
...
### <a name="what-changes-can-be-made-to-the-staff-selection-capability-on-the-self-service-booking-page"></a>Welke wijzigingen kunnen worden aangebracht in de selectiemogelijkheden voor personeel op de pagina Selfservice-reservering?
...
### <a name="can-bookings-support-many-concurrent-booking-requests-and-self-service-page-visits"></a>Kunnen Bookings veel gelijktijdige boekingsaanvragen en selfservicepaginabezoeken ondersteunen?
...
### <a name="how-are-staff-assigned-to-appointments-when-anyone-is-selected-or-when-customers-do-not-have-the-ability-to-choose-a-staff-member-for-the-appointment"></a>Hoe wordt personeel toegewezen aan afspraken wanneer 'Iedereen' is geselecteerd of wanneer klanten niet de mogelijkheid hebben om een personeelslid voor de afspraak te kiezen?
...
### <a name="how-can-users-opt-out-of-receiving-sms-messages-if-they-have-already-opted-in-previously"></a>Hoe kunnen gebruikers zich afmelden voor het ontvangen van sms-berichten als ze zich eerder al hebben voormeld?
...
1. Meld u aan bij Microsoft 365 en selecteer **Outlook** in het start startteken voor apps.
   ...
   > ![Afbeelding van Outlook in het start- en start start start-](../media/bookings-applauncher-outlook.png)
...
1. Selecteer in **de sectie** Personen in uw organisatie de vervolgkeuzekeuze naast **Mijn** organisatie en selecteer vervolgens Kan weergeven wanneer ik **bezet ben.**
   ...
   > [!div class="mx-imgBorder"]
   > ![Afbeelding van het scherm voor het delen van agenda's met Kan weergeven wanneer ik bezet ben ingeschakeld](../media/bookings-view-busy.png)
