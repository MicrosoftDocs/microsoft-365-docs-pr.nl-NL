...
| Nieuwe afspraaktypen maken | Ja | Ja |
| Onlineboekingen plannen | Ja | Ja |
| Zakelijke details bewerken | Ja | Ja |
| Personeel toevoegen met gastmachtigingen voor personen buiten uw organisatie | Ja | Nee |
| Persoonlijk of offline boekingen plannen | Ja | Nee |
| Groeps- of boekingen met meerdere klanten plannen | Ja | Nee |
| Een logo instellen voor uw bedrijf | Ja | Nee |
| Openingstijden instellen | Ja | Nee |
| Een selfserviceplanningspagina publiceren | Ja | Nee |
| Contactpersonen van klanten beheren | Ja | Nee |
| Time-off instellen voor personeel | Ja | Nee |
