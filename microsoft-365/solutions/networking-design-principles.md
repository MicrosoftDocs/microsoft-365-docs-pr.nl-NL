...
---
# <a name="networking-up-to-the-cloud--one-architects-viewpoint"></a>Netwerken up (to the Cloud): één standpunt van een architect
...
## <a name="its-not-the-network--its-how-youre-misusing-it"></a>Dat is niet het netwerk: dit is de manier waarop u (mis) met u werkt.

Het maakt niet uit hoe vaak het duurt, maar het is niet mogelijk dat de *creatieve* beveiligings teams en de netwerk teams u vragen om te zien hoe ze verbinding kunnen maken met de Microsoft-cloudservices. Er is altijd een aantal beveiligingsbeleid, compliance Standard, of betere manier waarop ze worden gebruikt zonder te worden getracht te deel te nemen aan een gesprek over wat ze willen doen, of *hoe* ze beter, eenvoudiger, rendabel en effectiever werken. 

Wanneer dit soort voor u is geëscaleerd, ben ik meestal bereid de uitdaging te nemen en ze door de hows en de whys te bezorgen en ze te laten weten waar ze zich bevinden. Maar als ik helemaal ben, moet ik dit delen, wat ze ook willen doen, wat ze ook willen doen, en ik ga terug naar mij laten weten dat het niet werkt wanneer ze uiteindelijk uitkomen. Dit kan ik soms doen, maar ik weet het *niet*. Wat ik doe, probeer eerst te uitleggen wat ik in dit bericht wil opnemen. Ongeacht uw rol, als uw organisatie Microsoft-cloudservices wil gebruiken, is er waarschijnlijk een deel van de typen in de volgende mogelijkheden.
...
- U **kunt ook, omdat u dit niet kunt doen,** of als u Dr. Ian Malcolm van de Jurassic Park-film wilt parafraseer. . . Ja, ja, maar uw beveiligingsteam was al eerder bezet met het feit of hij of zij niet stopt om te denken als ze dit zouden doen. "    
- **Beveiliging houdt geen ingewikkelde moeilijkheidsgraad** -u bent niet veilig, net omdat u meer geld besteedt, routeert via meer apparaten of op meer knoppen klikt.
- **Office 365 wordt geopend via internet** , maar dit is niet hetzelfde als Office 365 Internet. Dit is een SaaS-service die door Microsoft wordt beheerd en door u wordt beheerd. In tegenstelling tot websites die u bezoekt op internet, kunt u ook op een andere manier van het gordijn kijken en de besturingselementen toepassen die u aan uw beleidsregels en uw nalevings standaarden moet voldoen, mits u begrijpt dat u de doelstellingen kunt bereiken.
- **Chokepoints zijn slecht, gelokaliseerd breakouts zijn goed** — iedereen wil al zijn of haar Internet verkeer voor alle gebruikers op een centraal punt willen backhaul, zodat ze dit kunnen controleren en beleid kunnen afdwingen, maar vaak omdat dit een goed idee is van het inrichten van Internet toegang op al hun locaties, of alleen op de manier waarop ze dit doen. Maar deze chokepoints zijn echt... punten waar het verkeer geknepen is. Er is niets mis met het voorkomen dat uw gebruikers naar Instagram of streaming Cat-Video's browsen, maar u kunt geen bedrijfskritische bedrijfstoepassingen verkeer op dezelfde manier behandelen.
- Als u met echie op de proef **, echie, wat niets doet,** kunnen de beste DNS hamstrung door slecht DNS, ongeacht aanvragen voor servers in andere delen van de wereld of met behulp van de DNS-servers van uw internetprovider en van de DNS-servers van de internetprovider of andere openbare DNS-servers die de cache van DNS-omzettingsgegevens cacheen. 
- **Aangezien u dit niet doet, betekent dit niet dat u dit nu moet doen** – technologiewijzigingen doorlopend en Office 365 geen uitzondering. Het toepassen van beveiligingsmaatregelen die zijn ontwikkeld en geïmplementeerd voor on-premises Services of voor het beheren van websurfen, bieden niet dezelfde mate van beveiligings zekerheid en kunnen een significante negatieve impact op de prestaties hebben.
...
Wanneer u een TLS-verbinding of een 32 ervan afdwingt, moet u een VPN-verbinding tot stand brengen voordat ze naar de service worden toegevoegd. Het voegt latentie toe en vermindert de algehele doorvoer. In sommige VPN-oplossingen kan UDP zelfs UDP via TCP met een tunnel afdwingen met een zeer negatieve impact op streaming verkeer. En tenzij u TLS-inspectie uitvoert, is er geen enkele nadeel. Een zeer algemeen thema van klanten op dit moment, nu dat het grootste deel van hun werknemers extern is, is het belangrijk de bandbreedte en prestatie-effecten zien, zodat ze een VPN-verbinding tot stand brengen via een VPN, in plaats van gesplitste tunneling te configureren voor Access voor de [categorie Office 365-eindpunten](https://docs.microsoft.com/microsoft-365/enterprise/microsoft-365-network-connectivity-principles#new-office-365-endpoint-categories).
...
Als u het verdelen van tunneling toestaat maar ook een proxy voor algemeen webverkeer gebruikt, moet u ervoor zorgen dat uw PAC-bestand definieert wat er direct moet zijn en wat u kunt doen met de VPN-tunnel. Voorbeelden van PAC-bestanden [https://aka.ms/ipaddrs](https://aka.ms/ipaddrs) , zodat u deze eenvoudiger kunt beheren.
