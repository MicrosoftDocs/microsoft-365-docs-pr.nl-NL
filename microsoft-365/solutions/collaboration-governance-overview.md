...
Services zoals Microsoft 365 groepen, Teams en Yammer gebruikers machtigen en verminderen het risico op schaduw-IT door de hulpmiddelen te bieden die nodig zijn om samen te werken. Microsoft 365 beschikt over een uitgebreide set hulpprogramma's voor het implementeren van beheermogelijkheden die uw organisatie mogelijk nodig heeft. 

![Grafiek met opties voor samenwerkingsbeheer in Microsoft 365](../media/collaboration-governance-overview.png)

Met deze reeks artikelen krijgt u inzicht in de interactie tussen groepen, teams en SharePoint-instellingen, welke beheermogelijkheden beschikbaar zijn en hoe u een beheerplan maakt en implementeert voor de samenwerkingsfuncties in Microsoft 365.

### <a name="setting-up-secure-collaboration-with-microsoft-365"></a>Veilige samenwerking met Microsoft 365

Er zijn veel opties voor het implementeren van Microsoft 365 groepen en Teams voor veilige samenwerking in uw organisatie. We raden u aan deze [](setup-secure-collaboration-with-teams.md) beheerinhoud te gebruiken naast Veilige samenwerking met Microsoft 365 en bijbehorende artikelen instellen om de beste samenwerkingsoplossing voor uw organisatie te maken.
...
Microsoft 365 groepen kunt u een set personen kiezen met wie u wilt samenwerken en eenvoudig een verzameling resources instellen die deze personen kunnen delen. Als u leden toevoegt aan de groep, worden automatisch de benodigde machtigingen verleend aan alle activa die door de groep worden geleverd. Zowel Teams als Yammer groepen Microsoft 365 gebruiken om hun lidmaatschap te beheren.

Microsoft 365 groepen bevatten een suite met gekoppelde resources die gebruikers kunnen gebruiken voor communicatie en samenwerking. Groepen bevatten altijd een SharePoint site, Planner, Power BI werkruimte, een postvak en agenda en Stream. Afhankelijk van hoe u de groep maakt, kunt u desgewenst andere services toevoegen, zoals Teams, Yammer en Project.
...
|[Power BI Werkruimte](/power-bi/collaborate-share/service-new-workspaces)|Een ruimte voor gegevenssamenwerking met dashboards en rapporten|
...
Microsoft 365 Groepen omvatten diverse beheerbesturingselementen, waaronder een verloopbeleid, naamgevingsconventies en een beleid voor geblokkeerde woorden, om u te helpen groepen in uw organisatie te beheren. Omdat groepen het lidmaatschap en de toegang tot deze reeks resources bepalen, is het beheren van groepen een belangrijk onderdeel van het beheer van samenwerking in Microsoft 365.

## <a name="define-a-collaboration-strategy-for-your-organization"></a>Een samenwerkingsstrategie voor uw organisatie definiëren

Er zijn meerdere locaties om samen te werken en gesprekken te voeren binnen Microsoft 365. Als u weet waar gebruikers gesprekken kunnen starten, kunt u een strategie voor communicatie definiëren.

Er zijn drie belangrijke communicatiemethoden die worden ondersteund door Microsoft 365:

- Outlook: samenwerking via e-mail met een postvak IN en agenda van een gedeelde groep
...
![Diagram waarin wordt weergegeven wanneer u Teams, Yammer en Outlook](../media/inner-loop-outer-loop.png)

- Teams: op chat gebaseerde werkruimte (samenwerking met hoge snelheid) – inner loop
...
Als u bepaalt hoe u samenwerkingsfuncties wilt gebruiken in Microsoft 365, moet u rekening houden met deze communicatiemethoden en welke gebruikers waarschijnlijk in verschillende scenario's worden gebruikt.
...
- **Pas** u aan aan verschillende organisaties en verschillende typen inhoud en scenario's: houd rekening met de verschillende behoeften voor verschillende groepen of afdelingen en verschillende soorten inhoud, zoals intranetinhoud ten opzichte van de OneDrive inhoud van een gebruiker.
...
- **Beheerbeslissingen rechtstreeks insluiten in** de oplossingen die u maakt: veel beheerbeslissingen kunnen worden geïmplementeerd door functies in of uit te schakelen in Microsoft 365.
...
- **Versterken met training:** pas [](/office365/customlearning) oplossingen aan zoals Microsoft 365 leerpaden om ervoor te zorgen dat uw organisatiespecifieke verwachtingen worden versterkt met door Microsoft verstrekte training.

- **Hebt u een strategie** voor het communiceren van beheerbeleid en -richtlijnen in uw organisatie: maak een Microsoft 365 Adoption Center in een SharePoint communicatiesite om beleid en procedures te communiceren.
...
- Als uw organisatie veel gebruikmaakt van SharePoint of als u on-premises van SharePoint migreert, instrueert u uw gebruikers om SharePoint teamsites te maken voor samenwerking.
- Als uw organisatie een Teams heeft geïmplementeerd, geeft u uw gebruikers de opdracht een team te maken wanneer ze een samenwerkingsruimte nodig hebben.

Dit helpt verwarring te voorkomen als gebruikers niet bekend zijn met de relatie tussen groepen en hun gerelateerde services. Zie Voor meer informatie over hoe u met uw gebruikers over groepen kunt praten, zie [Uitleg Microsoft 365 Groepen aan uw gebruikers.](../admin/create-groups/explain-groups-knowledge-worker.md)
...
|Selfservicesite maken|Toestaan of voorkomen dat gebruikers hun eigen SharePoint maken.|Microsoft 365 E5 of E3|
...
2. Informatie over instellingen in services: instellingen in groepen [en SharePoint](groups-sharepoint-governance.md) met elkaar communiceren, net als instellingen in [groepen,](groups-sharepoint-teams-governance.md) SharePoint en Teams en [andere services.](groups-services-interactions.md) Zorg ervoor dat u deze interacties begrijpt terwijl u uw beheerstrategie plant.
...
4. Plan het beheer van compliance-instellingen: bekijk de beschikbare compliance-opties voor Microsoft 365 [groepen, Teams en SharePoint samenwerking.](groups-teams-compliance-governance.md)
...
|Training:|Fundamentele kennis van Microsoft 365 beveiligings- en compliancemogelijkheden|
|:---|:---|
|![Pictogram training voor beveiliging en naleving](../media/microsoft-365-security-and-compliance-capabilities.svg)|Meer informatie over de Microsoft 365 beveiligings- en complianceoplossingen en de mogelijkheden die beschikbaar zijn om ondernemingen te helpen hun bedrijf te beveiligen en te voldoen aan wettelijke vereisten. Als u niet bekend bent met basisconcepten voor cloud computing, raden we u aan [cloudconcepten - Principes van cloud computing - te gebruiken.](/learn/modules/principles-cloud-computing/index)<br><br>3 uur 11 min - Leerpad - 8 modules|
...
### <a name="microsoft-365-information-protection-and-compliance-capabilities"></a>Microsoft 365 mogelijkheden voor informatiebeveiliging en compliance

Microsoft 365 bevat een breed scala aan informatiebeveiligings- en compliancemogelijkheden. Samen met de productiviteitshulpprogramma's van Microsoft zijn deze mogelijkheden ontworpen om organisaties te helpen in realtime samen te werken terwijl ze zich houden aan strikte regelgevingskaders. 
...
- [Groepen Microsoft 365 omarmen](https://www.youtube.com/watch?v=dAamBF1gb7M)
