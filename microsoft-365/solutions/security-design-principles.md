...
U kunt deze drempel overzeilen door de verdedigingsstrategieën te verplaatsen naar door de cloud beheerde beveiliging, geautomatiseerd onderzoek en herstel, geautomatiseerde pentests, Defender voor Office 365 en incidentanalyse. Klanten die moderne oplossingen voor apparaatbeheer gebruiken, hebben geautomatiseerd beheer, gestandaardiseerde patching, antivirus, beleidshandhaving en toepassingsbeveiliging geïmplementeerd op alle apparaten (of het nu om een smartphone, pc, laptop of tablet gaat). Hierdoor hoeft u geen VPN-beleid, SCCM (Microsoft System Center Configuration Manager) en Active Directory-groepsbeleid te gebruiken. Dit, gecombineerd met beleid voor voorwaardelijke toegang, biedt krachtige controle en zichtbaarheid, evenals gestroomlijnde toegang tot resources, ongeacht waar hun gebruikers vandaan werken.
...
|[Microsoft 365 Security for Business Decisions Makers](../security/Microsoft-365-security-for-bdm.md)    | Wanneer u tijd hebt voor een uitgebreider plan, bevat dit artikel aanbevelingen die van toepassing zijn op Microsoft 365, die zijn geprioriteerd door attack surface. Het wordt zelfs geleverd met een spreadsheet die u kunt gebruiken om te sorteren op licenties en gebied (zoals identiteit, bedreigingsbeveiliging en monitoring).  |
