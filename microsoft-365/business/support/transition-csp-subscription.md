...
---
# <a name="transition-a-microsoft-365-business-csp-subscription"></a>Een abonnement Microsoft 365 business CSP overstappen
...
4. Selecteer op **de pagina** Nieuw abonnement de optie Kleine **bedrijven en** selecteer Microsoft 365 **bedrijven** in de lijst.
5. Voeg het aantal licenties toe en selecteer **Volgende: Controleren** om het abonnement te bekijken en selecteer **vervolgens Verzenden.**
    ...
    De **licenties worden weergegeven Microsoft 365** Business **Preview** en **Microsoft 365 Business.** Het preview-abonnement wordt vervolgens opgeschort.

6. Selecteer **Microsoft 365 Business Preview**.
7. Selecteer op **Microsoft 365 pagina Business Preview** de optie Opgeschort **om** het preview-abonnement op te schorten.
...
In de volgende tabel wordt de impact samengevat voor klanten die niet overstappen van een Microsoft 365 Business Preview-abonnement naar een Microsoft 365 Business-abonnement.
...
| **Service-effecten**                                                        |
| **Microsoft 365-beheercentrum** | Geen invloed op functionaliteit | Geen invloed op functionaliteit | Kan gebruikers toevoegen/verwijderen, abonnementen kopen.</br> U kunt geen licenties toewijzen/intrekken. | Het abonnement van de klant en alle gegevens worden verwijderd. Beheerder kan andere betaalde abonnementen beheren. |
...
| **Gebruikers toestaan om Cortana te openen** | Beheerder definieert beleid voor gebruikerstoegang tot Cortana | Gebruikersapparaten voor het in- of uitschakelen van Cortana |
