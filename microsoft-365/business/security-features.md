...
---
# <a name="microsoft-365-business-premium-security-and-compliance-features"></a>Microsoft 365 Business Premium beveiligings- en compliancefuncties
...
## <a name="microsoft-365-admin-center-security-features"></a>Microsoft 365 beveiligingsfuncties van het beheercentrum

U kunt veel van de Microsoft 365 Business Premium beveiligingsfuncties in het beheercentrum beheren, zodat u deze functies eenvoudiger kunt in- of uitschakelen. In het beheercentrum kunt u het volgende doen:
...
- [Stel Windows 10 apparaten opnieuw in op de fabrieksinstellingen.](reset-devices-to-factory-settings.md) 
    
    U kunt alle apparaten Windows 10 apparaten met apparaatbeveiligingsinstellingen opnieuw instellen.
...
- **[De volledige mogelijkheden van Intune in de Azure-portal](/mem/intune/fundamentals/what-is-intune)**
    ...
    Met toegang tot het Intune-beheercentrum in de Azure-portal kunt u aanvullende beveiligingsfuncties instellen, zoals het beheer van MacOS-apparaten, iPhone- en Android-apparaten, samen met geavanceerd apparaatbeheer voor Windows, die niet beschikbaar zijn via het Microsoft 365-beheercentrum.
...
Uw Microsoft 365 Business Premium bevat functies die u helpen nalevings- en regelgevingsstandaarden te handhaven.

- **[Meer informatie over preventie van gegevensverlies](../compliance/dlp-learn-about-dlp.md))** (DLP). 
