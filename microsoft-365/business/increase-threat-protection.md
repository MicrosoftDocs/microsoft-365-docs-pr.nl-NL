...
Als u een anti-phishingfilter wilt maken in Microsoft Defender voor Office 365, bekijkt u  [deze korte trainings video](https://support.microsoft.com/office/86c425e1-1686-430a-9151-f7176cce4f2c)of voert u de volgende stappen uit:
...
5. Geef in de volgende tabel de naam, de beschrijving en de instellingen voor het beleid op. Zie voor meer informatie het artikel [over anti phishingfilter in de opties voor Microsoft Defender voor Office 365](https://docs.microsoft.com/microsoft-365/security/office-365-security/set-up-anti-phishing-policies).
...
## <a name="protect-against-malicious-attachments-and-files-with-safe-attachments"></a>Beveiliging tegen kwaadaardige bijlagen en bestanden met veilige bijlagen
...
Voor het maken van een veilig bijlage beleid bekijkt u [deze korte video](https://support.microsoft.com/office/e7e68934-23dc-4b9c-b714-e82e27a8f8a5)of voert u de volgende stappen uit:
...
Zie [anti phishingfilter instellen in Microsoft Defender voor Office 365](https://docs.microsoft.com/microsoft-365/security/office-365-security/set-up-anti-phishing-policies)voor meer informatie.

## <a name="protect-against-phishing-attacks-with-safe-links"></a>Beveiliging tegen phishing-aanvallen met veilige koppelingen
...
Voor het instellen van veilige koppelingen bekijkt u [deze korte trainings video](https://support.microsoft.com/office/61492713-53c2-47da-a6e7-fa97479e97fa)of voert u de volgende stappen uit:
...
Zie voor meer informatie [veilige koppelingen](https://docs.microsoft.com/microsoft-365/security/office-365-security/atp-safe-links).
