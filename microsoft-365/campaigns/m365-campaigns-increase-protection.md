...
---
# <a name="increase-threat-protection-for-microsoft-365-subscription"></a>Bedreigingsbeveiliging voor een Microsoft 365 verhogen

In dit artikel kunt u de beveiliging in uw abonnement Microsoft 365 beschermen tegen phishing, malware en andere bedreigingen. Deze aanbevelingen zijn geschikt voor organisaties die meer behoefte hebben aan beveiliging, zoals politieke campagnes, advocatenkantoren en klinieken in de gezondheidszorg.
...
Uw Office 365 of Microsoft 365 bevat bescherming tegen malware, maar u kunt deze beveiliging vergroten door bijlagen te blokkeren met bestandstypen die vaak voor malware worden gebruikt. Malwarebeveiliging in e-mail tegen gaan:
...
1. Klik in Microsoft 365 beheercentrum op **Beheercentra** \> **Exchange.**
...
Als u een anti-phishingbeleid wilt maken in Defender Office 365, bekijkt u deze korte [trainingsvideo](https://support.office.com/article/86c425e1-1686-430a-9151-f7176cce4f2c)of volgt u de volgende stappen:
...
5. Geef de naam, beschrijving en instellingen voor uw beleid op zoals aanbevolen in de onderstaande grafiek. Zie Meer informatie over [anti-phishingbeleid in Microsoft Defender voor Office 365 opties.](../security/office-365-security/set-up-anti-phishing-policies.md)
...
Zie [Anti-phishingbeleid](../security/office-365-security/set-up-anti-phishing-policies.md)instellen in Defender voor meer Office 365.

## <a name="protect-against-malicious-attachments-files-and-links-with-defender-for-office-365"></a>Bescherm u tegen schadelijke bijlagen, bestanden en koppelingen met Defender voor Office 365
...
5. Kies **Beleid maken om** Safe bijlagen in te Safe koppelingen.

### <a name="set-up-safe-attachments-in-the-security--compliance-center"></a>Bijlagen Safe instellen in het beveiligings- & compliancecentrum
...
Als u een Safe bijlagebeleid wilt maken, bekijkt u [deze korte video](https://support.office.com/article/e7e68934-23dc-4b9c-b714-e82e27a8f8a5)of volgt u de volgende stappen:
...
### <a name="set-up-safe-links-in-the-security--compliance-center"></a>Koppelingen Safe instellen in het beveiligings- & compliancecentrum
...
Als u Safe koppelingen wilt instellen, bekijkt u [deze korte trainingsvideo](https://support.office.com/article/61492713-53c2-47da-a6e7-fa97479e97fa)of volgt u de volgende stappen:
...
1. Klik op Safe pagina Koppelingen onder Beleidsregels die van toepassing zijn op de hele **organisatie,** **+** op om een nieuw beleid te maken.
...
Zie Koppelingen in [Defender voor Safe voor meer Office 365.](../security/office-365-security/safe-links.md)
...
U moet de rol Auditlogboeken hebben toegewezen in Exchange Online om de zoekfunctie voor auditlogboeken in of uit te schakelen in uw Microsoft 365 abonnement. Deze rol is standaard toegewezen aan de rollengroepen Compliancebeheer en Organisatiebeheer op de pagina Machtigingen in het Exchange beheercentrum. Globale beheerders in Microsoft 365 zijn standaard lid van deze groep.
...
2. Kies op Microsoft 365 **pagina Beveiliging** de optie  Meer **resources** en open vervolgens op Office 365 kaart **& compliancecentrum.**
...
(standaardverloop van anonieme koppeling wijzigen in 14 dagen, standaardtype voor delen wijzigen in 'Specifieke personen') De instellingen voor delen voor OneDrive en SharePoint:

1. Ga naar het beheercentrum bij <https://admin.microsoft.com> en kies SharePoint onder **Beheercentra** in de linkernavigatie. 
2. Ga in SharePoint beheercentrum naar **Beleid** \> **delen.**
...
1. Ga naar het beheercentrum op <https://admin.microsoft.com> en kies **Instellingen** \> **Org Instellingen.**
2. Kies **agenda** op de pagina Services en kies of personen in uw organisatie hun agenda's kunnen delen met personen buiten Office 365 of Exchange of met anderen.
...
Als uw gebruikers hun agenda's [](https://support.office.com/article/7ecef8ae-139c-40d9-bae2-a23977ee58d5) mogen delen, bekijkt u deze instructies voor het delen van Outlook op internet.
